...
public class BroadleafTrunkPlacer extends TrunkPlacer {
    ...
    public static final MapCodec<BroadleafTrunkPlacer> CODEC = RecordCodecBuilder.mapCodec(instance ->
            trunkPlacerParts(instance).apply(instance, BroadleafTrunkPlacer::new));

    public BroadleafTrunkPlacer(int baseHeight, int heightRandA, int heightRandB) {
        super(baseHeight, heightRandA, heightRandB);
    }

    @Override
    protected TrunkPlacerType<?> type() {
        return TreePlacers.GOT_BROADLEAF_TRUNK_PLACER.get();
    }
