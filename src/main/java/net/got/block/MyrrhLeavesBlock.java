...
public class MyrrhLeavesBlock extends LeavesBlock {
	public static final MapCodec<MyrrhLeavesBlock> CODEC = simpleCodec(MyrrhLeavesBlock::new);

	@Override
	public MapCodec<MyrrhLeavesBlock> codec() { return CODEC; }

    public MyrrhLeavesBlock(Properties p) { super(0.1f, p.sound(SoundType.GRASS).strength(0.2f).noOcclusion().pushReaction(PushReaction.DESTROY).isRedstoneConductor((a,b,c)->false).ignitedByLava().isSuffocating((a,b,c)->false).isViewBlocking((a,b,c)->false)); }
