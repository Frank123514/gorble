...
public class BlackthornLeavesBlock extends LeavesBlock {
	public static final MapCodec<BlackthornLeavesBlock> CODEC = simpleCodec(BlackthornLeavesBlock::new);

	@Override
	public MapCodec<BlackthornLeavesBlock> codec() { return CODEC; }

	public BlackthornLeavesBlock(Properties properties) {
