...
public class PruneLeavesBlock extends LeavesBlock {
	public static final MapCodec<PruneLeavesBlock> CODEC = simpleCodec(PruneLeavesBlock::new);

	@Override
	public MapCodec<PruneLeavesBlock> codec() { return CODEC; }

	public PruneLeavesBlock(Properties properties) {
