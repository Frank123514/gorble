...
public class BlackCottonwoodPlanksBlock extends Block {
    public BlackCottonwoodPlanksBlock(Properties p) { super(p.sound(SoundType.WOOD).strength(2f,3f).ignitedByLava()); }
