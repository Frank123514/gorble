...
public class SandbeggarLeavesBlock extends LeavesBlock {
	public static final MapCodec<SandbeggarLeavesBlock> CODEC = simpleCodec(SandbeggarLeavesBlock::new);

	@Override
	public MapCodec<SandbeggarLeavesBlock> codec() { return CODEC; }

	public SandbeggarLeavesBlock(Properties properties) {
