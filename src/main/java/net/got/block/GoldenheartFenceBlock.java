...
public class GoldenheartFenceBlock extends FenceBlock {
    public GoldenheartFenceBlock(Properties p) { super(p.sound(SoundType.WOOD).strength(2f,3f).ignitedByLava().forceSolidOn()); }
