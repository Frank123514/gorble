...
public class MyrrhStairsBlock extends StairBlock {
    public MyrrhStairsBlock(Properties p) { super(Blocks.AIR.defaultBlockState(),p.sound(SoundType.WOOD).strength(2f,3f).ignitedByLava()); }
