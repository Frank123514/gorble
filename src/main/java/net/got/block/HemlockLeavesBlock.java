...
public class HemlockLeavesBlock extends LeavesBlock {
	public static final MapCodec<HemlockLeavesBlock> CODEC = simpleCodec(HemlockLeavesBlock::new);

	@Override
	public MapCodec<HemlockLeavesBlock> codec() { return CODEC; }

	public HemlockLeavesBlock(Properties properties) {
