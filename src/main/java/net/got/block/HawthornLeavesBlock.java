...
public class HawthornLeavesBlock extends LeavesBlock {
	public static final MapCodec<HawthornLeavesBlock> CODEC = simpleCodec(HawthornLeavesBlock::new);

	@Override
	public MapCodec<HawthornLeavesBlock> codec() { return CODEC; }
