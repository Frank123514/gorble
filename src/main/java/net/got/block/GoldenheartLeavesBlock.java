...
public class GoldenheartLeavesBlock extends LeavesBlock {
	public static final MapCodec<GoldenheartLeavesBlock> CODEC = simpleCodec(GoldenheartLeavesBlock::new);

	@Override
	public MapCodec<GoldenheartLeavesBlock> codec() { return CODEC; }

    public GoldenheartLeavesBlock(Properties p) { super(0.1f, p.sound(SoundType.GRASS).strength(0.2f).noOcclusion().pushReaction(PushReaction.DESTROY).isRedstoneConductor((a,b,c)->false).ignitedByLava().isSuffocating((a,b,c)->false).isViewBlocking((a,b,c)->false)); }
