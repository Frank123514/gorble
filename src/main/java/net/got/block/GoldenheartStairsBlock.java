...
public class GoldenheartStairsBlock extends StairBlock {
    public GoldenheartStairsBlock(Properties p) { super(Blocks.AIR.defaultBlockState(),p.sound(SoundType.WOOD).strength(2f,3f).ignitedByLava()); }
    @Override public float getExplosionResistance() { return 3f; }
