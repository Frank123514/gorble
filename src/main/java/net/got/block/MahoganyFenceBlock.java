...
public class MahoganyFenceBlock extends FenceBlock {
    public MahoganyFenceBlock(Properties p) { super(p.sound(SoundType.WOOD).strength(2f,3f).ignitedByLava().forceSolidOn()); }
