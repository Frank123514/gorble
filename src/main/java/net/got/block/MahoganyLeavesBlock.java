...
public class MahoganyLeavesBlock extends LeavesBlock {
	public static final MapCodec<MahoganyLeavesBlock> CODEC = simpleCodec(MahoganyLeavesBlock::new);

	@Override
	public MapCodec<MahoganyLeavesBlock> codec() { return CODEC; }

    public MahoganyLeavesBlock(Properties p) { super(0.1f, p.sound(SoundType.GRASS).strength(0.2f).noOcclusion().pushReaction(PushReaction.DESTROY).isRedstoneConductor((a,b,c)->false).ignitedByLava().isSuffocating((a,b,c)->false).isViewBlocking((a,b,c)->false)); }
