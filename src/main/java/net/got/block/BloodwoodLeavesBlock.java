...
public class BloodwoodLeavesBlock extends LeavesBlock {
	public static final MapCodec<BloodwoodLeavesBlock> CODEC = simpleCodec(BloodwoodLeavesBlock::new);

	@Override
	public MapCodec<BloodwoodLeavesBlock> codec() { return CODEC; }

    public BloodwoodLeavesBlock(Properties properties) {
