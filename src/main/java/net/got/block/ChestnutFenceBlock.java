...
public class ChestnutFenceBlock extends FenceBlock {
    public ChestnutFenceBlock(Properties p) { super(p.sound(SoundType.WOOD).strength(2f,3f).ignitedByLava().forceSolidOn()); }
