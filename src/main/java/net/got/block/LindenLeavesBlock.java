...
public class LindenLeavesBlock extends LeavesBlock {
	public static final MapCodec<LindenLeavesBlock> CODEC = simpleCodec(LindenLeavesBlock::new);

	@Override
	public MapCodec<LindenLeavesBlock> codec() { return CODEC; }

    public LindenLeavesBlock(Properties p) { super(0.1f, p.sound(SoundType.GRASS).strength(0.2f).noOcclusion().pushReaction(PushReaction.DESTROY).isRedstoneConductor((a,b,c)->false).ignitedByLava().isSuffocating((a,b,c)->false).isViewBlocking((a,b,c)->false)); }
