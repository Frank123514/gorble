...
public class ChestnutStairsBlock extends StairBlock {
    public ChestnutStairsBlock(Properties p) { super(Blocks.AIR.defaultBlockState(),p.sound(SoundType.WOOD).strength(2f,3f).ignitedByLava()); }
