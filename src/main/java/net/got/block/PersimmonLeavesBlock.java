...
public class PersimmonLeavesBlock extends LeavesBlock {
	public static final MapCodec<PersimmonLeavesBlock> CODEC = simpleCodec(PersimmonLeavesBlock::new);

	@Override
	public MapCodec<PersimmonLeavesBlock> codec() { return CODEC; }

	public PersimmonLeavesBlock(Properties properties) {
