...
public class RedwoodLeavesBlock extends LeavesBlock {
	public static final MapCodec<RedwoodLeavesBlock> CODEC = simpleCodec(RedwoodLeavesBlock::new);

	@Override
	public MapCodec<RedwoodLeavesBlock> codec() { return CODEC; }

    public RedwoodLeavesBlock(Properties p) { super(0.1f, p.sound(SoundType.GRASS).strength(0.2f).noOcclusion().pushReaction(PushReaction.DESTROY).isRedstoneConductor((a,b,c)->false).ignitedByLava().isSuffocating((a,b,c)->false).isViewBlocking((a,b,c)->false)); }
