...
public class SandalwoodLeavesBlock extends LeavesBlock {
	public static final MapCodec<SandalwoodLeavesBlock> CODEC = simpleCodec(SandalwoodLeavesBlock::new);

	@Override
	public MapCodec<SandalwoodLeavesBlock> codec() { return CODEC; }

	public SandalwoodLeavesBlock(Properties properties) {
