...
public class IronwoodLeavesBlock extends LeavesBlock {
	public static final MapCodec<IronwoodLeavesBlock> CODEC = simpleCodec(IronwoodLeavesBlock::new);

	@Override
	public MapCodec<IronwoodLeavesBlock> codec() { return CODEC; }

	public IronwoodLeavesBlock(Properties properties) {
