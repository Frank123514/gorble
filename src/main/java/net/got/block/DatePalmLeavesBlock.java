...
public class DatePalmLeavesBlock extends LeavesBlock {
	public static final MapCodec<DatePalmLeavesBlock> CODEC = simpleCodec(DatePalmLeavesBlock::new);

	@Override
	public MapCodec<DatePalmLeavesBlock> codec() { return CODEC; }

	public DatePalmLeavesBlock(Properties properties) {
