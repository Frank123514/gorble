...
public class AppleFenceBlock extends FenceBlock {
    public AppleFenceBlock(Properties p) { super(p.sound(SoundType.WOOD).strength(2f,3f).ignitedByLava().forceSolidOn()); }
