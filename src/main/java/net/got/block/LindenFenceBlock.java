...
public class LindenFenceBlock extends FenceBlock {
    public LindenFenceBlock(Properties p) { super(p.sound(SoundType.WOOD).strength(2f,3f).ignitedByLava().forceSolidOn()); }
