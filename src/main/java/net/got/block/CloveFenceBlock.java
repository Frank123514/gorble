...
public class CloveFenceBlock extends FenceBlock {
    public CloveFenceBlock(Properties p) { super(p.sound(SoundType.WOOD).strength(2f,3f).ignitedByLava().forceSolidOn()); }
