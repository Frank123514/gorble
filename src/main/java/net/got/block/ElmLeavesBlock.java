...
public class ElmLeavesBlock extends LeavesBlock {
	public static final MapCodec<ElmLeavesBlock> CODEC = simpleCodec(ElmLeavesBlock::new);

	@Override
	public MapCodec<ElmLeavesBlock> codec() { return CODEC; }

    public ElmLeavesBlock(Properties p) { super(0.1f, p.sound(SoundType.GRASS).strength(0.2f).noOcclusion().pushReaction(PushReaction.DESTROY).isRedstoneConductor((a,b,c)->false).ignitedByLava().isSuffocating((a,b,c)->false).isViewBlocking((a,b,c)->false)); }
