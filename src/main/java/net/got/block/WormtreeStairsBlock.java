...
public class WormtreeStairsBlock extends StairBlock {
    public WormtreeStairsBlock(Properties p) { super(Blocks.AIR.defaultBlockState(),p.sound(SoundType.WOOD).strength(2f,3f).ignitedByLava()); }
