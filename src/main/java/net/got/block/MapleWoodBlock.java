...
public class MapleWoodBlock extends Block {
    ...
    public MapleWoodBlock(Properties p) { super(p.sound(SoundType.WOOD).strength(2f).ignitedByLava()); this.registerDefaultState(this.stateDefinition.any().setValue(AXIS,Direction.Axis.Y)); }
