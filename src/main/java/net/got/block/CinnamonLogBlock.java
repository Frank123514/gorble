...
public class CinnamonLogBlock extends Block {
    public static final EnumProperty<Direction.Axis> AXIS = BlockStateProperties.AXIS;
    public CinnamonLogBlock(Properties p) { super(p.sound(SoundType.WOOD).strength(2f).ignitedByLava()); this.registerDefaultState(this.stateDefinition.any().setValue(AXIS,Direction.Axis.Y)); }
