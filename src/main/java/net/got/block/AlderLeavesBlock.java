...
public class AlderLeavesBlock extends LeavesBlock {
	public static final MapCodec<AlderLeavesBlock> CODEC = simpleCodec(AlderLeavesBlock::new);

	@Override
	public MapCodec<AlderLeavesBlock> codec() { return CODEC; }

	public AlderLeavesBlock(Properties properties) {
