...
public class SoldierPineLeavesBlock extends LeavesBlock {
	public static final MapCodec<SoldierPineLeavesBlock> CODEC = simpleCodec(SoldierPineLeavesBlock::new);

	@Override
	public MapCodec<SoldierPineLeavesBlock> codec() { return CODEC; }

	public SoldierPineLeavesBlock(Properties properties) {
