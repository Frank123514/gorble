...
public class CloveStairsBlock extends StairBlock {
    public CloveStairsBlock(Properties p) { super(Blocks.AIR.defaultBlockState(),p.sound(SoundType.WOOD).strength(3f,2f).ignitedByLava()); }
