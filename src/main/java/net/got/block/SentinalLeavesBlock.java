...
public class SentinalLeavesBlock extends LeavesBlock {
	public static final MapCodec<SentinalLeavesBlock> CODEC = simpleCodec(SentinalLeavesBlock::new);

	@Override
	public MapCodec<SentinalLeavesBlock> codec() { return CODEC; }

	public SentinalLeavesBlock(Properties properties) {
