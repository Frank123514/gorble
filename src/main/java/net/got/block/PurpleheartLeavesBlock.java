...
public class PurpleheartLeavesBlock extends LeavesBlock {
	public static final MapCodec<PurpleheartLeavesBlock> CODEC = simpleCodec(PurpleheartLeavesBlock::new);

	@Override
	public MapCodec<PurpleheartLeavesBlock> codec() { return CODEC; }

	public PurpleheartLeavesBlock(Properties properties) {
