...
public class AppleStairsBlock extends StairBlock {
    public AppleStairsBlock(Properties p) { super(Blocks.AIR.defaultBlockState(),p.sound(SoundType.WOOD).strength(2f,3f).ignitedByLava()); }
