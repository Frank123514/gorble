...
public class BlackCottonwoodSlabBlock extends SlabBlock {
    public BlackCottonwoodSlabBlock(Properties p) { super(p.sound(SoundType.WOOD).strength(2f,3f).ignitedByLava()); }
