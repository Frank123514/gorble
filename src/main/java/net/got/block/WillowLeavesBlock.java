...
public class WillowLeavesBlock extends LeavesBlock {
	...
	@Override
	public MapCodec<WillowLeavesBlock> codec() { return CODEC; }

    public WillowLeavesBlock(Properties p) { super(0.1f, p.sound(SoundType.GRASS).strength(0.2f).noOcclusion().pushReaction(PushReaction.DESTROY).isRedstoneConductor((a,b,c)->false).ignitedByLava().isSuffocating((a,b,c)->false).isViewBlocking((a,b,c)->false)); }
