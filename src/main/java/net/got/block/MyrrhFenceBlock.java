...
public class MyrrhFenceBlock extends FenceBlock {
    public MyrrhFenceBlock(Properties p) { super(p.sound(SoundType.WOOD).strength(2f,3f).ignitedByLava().forceSolidOn()); }
