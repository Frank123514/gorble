...
public class NutmegLeavesBlock extends LeavesBlock {
	public static final MapCodec<NutmegLeavesBlock> CODEC = simpleCodec(NutmegLeavesBlock::new);

	@Override
	public MapCodec<NutmegLeavesBlock> codec() { return CODEC; }

	public NutmegLeavesBlock(Properties properties) {
