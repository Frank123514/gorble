...
public class MahoganyStairsBlock extends StairBlock {
    public MahoganyStairsBlock(Properties p) { super(Blocks.AIR.defaultBlockState(),p.sound(SoundType.WOOD).strength(2f,3f).ignitedByLava()); }
