...
public class CinnamonLeavesBlock extends LeavesBlock {
	public static final MapCodec<CinnamonLeavesBlock> CODEC = simpleCodec(CinnamonLeavesBlock::new);

	@Override
	public MapCodec<CinnamonLeavesBlock> codec() { return CODEC; }

    public CinnamonLeavesBlock(Properties p) { super(0.1f, p.sound(SoundType.GRASS).strength(0.2f).noOcclusion().pushReaction(PushReaction.DESTROY).isRedstoneConductor((a,b,c)->false).ignitedByLava().isSuffocating((a,b,c)->false).isViewBlocking((a,b,c)->false)); }
