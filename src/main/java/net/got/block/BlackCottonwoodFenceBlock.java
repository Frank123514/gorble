...
public class BlackCottonwoodFenceBlock extends FenceBlock {
    public BlackCottonwoodFenceBlock(Properties p) { super(p.sound(SoundType.WOOD).strength(2f,3f).ignitedByLava().forceSolidOn()); }
