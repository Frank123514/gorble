...
public class AshLeavesBlock extends LeavesBlock {
	public static final MapCodec<AshLeavesBlock> CODEC = simpleCodec(AshLeavesBlock::new);

	@Override
	public MapCodec<AshLeavesBlock> codec() { return CODEC; }

	public AshLeavesBlock(Properties properties) {
