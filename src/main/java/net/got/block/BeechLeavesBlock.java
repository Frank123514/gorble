...
public class BeechLeavesBlock extends LeavesBlock {
	public static final MapCodec<BeechLeavesBlock> CODEC = simpleCodec(BeechLeavesBlock::new);

	@Override
	public MapCodec<BeechLeavesBlock> codec() { return CODEC; }

	public BeechLeavesBlock(Properties properties) {
