...
public class BlackCottonwoodLeavesBlock extends LeavesBlock {
	public static final MapCodec<BlackCottonwoodLeavesBlock> CODEC = simpleCodec(BlackCottonwoodLeavesBlock::new);

	@Override
	public MapCodec<BlackCottonwoodLeavesBlock> codec() { return CODEC; }

    public BlackCottonwoodLeavesBlock(Properties p) { super(0.1f, p.sound(SoundType.GRASS).strength(0.2f).noOcclusion().pushReaction(PushReaction.DESTROY).isRedstoneConductor((a,b,c)->false).ignitedByLava().isSuffocating((a,b,c)->false).isViewBlocking((a,b,c)->false)); }
