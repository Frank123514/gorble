...
public class AlmondLeavesBlock extends LeavesBlock {
	public static final MapCodec<AlmondLeavesBlock> CODEC = simpleCodec(AlmondLeavesBlock::new);

	@Override
	public MapCodec<AlmondLeavesBlock> codec() { return CODEC; }

	public AlmondLeavesBlock(Properties properties) {
