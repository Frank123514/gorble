...
public class NightwoodLeavesBlock extends LeavesBlock {
	public static final MapCodec<NightwoodLeavesBlock> CODEC = simpleCodec(NightwoodLeavesBlock::new);

	@Override
	public MapCodec<NightwoodLeavesBlock> codec() { return CODEC; }

	public NightwoodLeavesBlock(Properties properties) {
