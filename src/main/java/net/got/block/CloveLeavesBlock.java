...
public class CloveLeavesBlock extends LeavesBlock {
	public static final MapCodec<CloveLeavesBlock> CODEC = simpleCodec(CloveLeavesBlock::new);

	@Override
	public MapCodec<CloveLeavesBlock> codec() { return CODEC; }

    public CloveLeavesBlock(Properties p) { super(0.1f, p.sound(SoundType.GRASS).strength(0.2f).noOcclusion().pushReaction(PushReaction.DESTROY).isRedstoneConductor((a,b,c)->false).ignitedByLava().isSuffocating((a,b,c)->false).isViewBlocking((a,b,c)->false)); }
