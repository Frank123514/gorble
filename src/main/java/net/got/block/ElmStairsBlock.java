...
public class ElmStairsBlock extends StairBlock {
    public ElmStairsBlock(Properties p) { super(Blocks.AIR.defaultBlockState(),p.sound(SoundType.WOOD).strength(3f,2f).ignitedByLava()); }
