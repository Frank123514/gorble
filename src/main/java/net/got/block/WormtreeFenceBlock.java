...
public class WormtreeFenceBlock extends FenceBlock {
    public WormtreeFenceBlock(Properties p) { super(p.sound(SoundType.WOOD).strength(2f,3f).ignitedByLava().forceSolidOn()); }
