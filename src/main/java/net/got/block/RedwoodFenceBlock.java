...
public class RedwoodFenceBlock extends FenceBlock {
    public RedwoodFenceBlock(Properties p) { super(p.sound(SoundType.WOOD).strength(2f,3f).ignitedByLava().forceSolidOn()); }
