...
public class EbonyStairsBlock extends StairBlock {
    public EbonyStairsBlock(Properties p) { super(Blocks.AIR.defaultBlockState(),p.sound(SoundType.WOOD).strength(3f,2f).ignitedByLava()); }
