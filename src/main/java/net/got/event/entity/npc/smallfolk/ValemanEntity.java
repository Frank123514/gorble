...
public class ValemanEntity extends SmallfolkEntity {
    ...
    public static final Identifier[] MALE_TEXTURES   = textures("valeman", false, MALE_VARIANT_COUNT);
    
    public static final Identifier[] FEMALE_TEXTURES = textures("valeman", true,  FEMALE_VARIANT_COUNT);
    ...
    @Override
    protected NameGenerator getNameGenerator() { return NpcNames.VALEMAN; }
