...
public class ReachmanEntity extends SmallfolkEntity {
    ...
    public static final ResourceLocation[] MALE_TEXTURES   = textures("reachman", false, MALE_VARIANT_COUNT);
    /** Female texture variants — reachman/generated/female_01.png ... female_12.png */
    public static final ResourceLocation[] FEMALE_TEXTURES = textures("reachman", true,  FEMALE_VARIANT_COUNT);
