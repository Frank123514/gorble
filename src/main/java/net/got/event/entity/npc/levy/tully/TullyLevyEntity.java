package net.got.event.entity.npc.levy.tully;
...
public class TullyLevyEntity extends LevyEntity {

    private static final SpawnEquipment WEAPONS = SpawnEquipment.of(Items.IRON_SWORD, Items.STONE_AXE);
