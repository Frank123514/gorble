package net.got.event.entity.npc.levy.baratheon;
...
public class BaratheonLevyEntity extends LevyEntity {
    ...
    private static final SpawnEquipment WEAPONS = SpawnEquipment.of(Items.IRON_SWORD, Items.IRON_AXE);
    ...
    private static Identifier[] textures(boolean female) {
        ...
        for (int i = 0; i < arr.length; i++) {
            arr[i] = Identifier.fromNamespaceAndPath("got",
                    "textures/entity/npc/smallfolk/stormlorder/generated/" + prefix + "_" + String.format("%02d", i + 1) + ".png");
        }
        return arr;
    }
    ...
    @Override protected NameGenerator  getNameGenerator()  { return NpcNames.BARATHEON_LEVY; }
