...
public class GreyjoyLevyEntity extends LevyEntity {
    ...
    private static final SpawnEquipment WEAPONS = SpawnEquipment.of(Items.IRON_AXE, Items.STONE_AXE);
    ...
    @Override protected NameGenerator  getNameGenerator()  { return NpcNames.GREYJOY_LEVY; }
