...
public class NorthmanEntity extends SmallfolkEntity {
    ...
    public static final Identifier[] MALE_TEXTURES   = textures("northman", false, MALE_VARIANT_COUNT);
    /** Female texture variants — northman/generated/female_01.png ... female_12.png */
    public static final Identifier[] FEMALE_TEXTURES = textures("northman", true,  FEMALE_VARIANT_COUNT);
