...
public class WestermanEntity extends SmallfolkEntity {
    ...
    public static final Identifier[] MALE_TEXTURES   = textures("westerman", false, MALE_VARIANT_COUNT);
    /** Female texture variants — westerman/generated/female_01.png ... female_12.png */
    public static final Identifier[] FEMALE_TEXTURES = textures("westerman", true,  FEMALE_VARIANT_COUNT);
