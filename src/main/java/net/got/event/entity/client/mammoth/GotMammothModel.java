...
/**
 * Custom mammoth model for {@link net.got.event.entity.mammoth.GotMammothEntity},
 * updated from mammoth.bbmodel via Blockbench 5.1.4 (Minecraft 1.17+, Mojang mappings).
 *
