...
public final class GotMod {
    ...
    private void commonSetup(final FMLCommonSetupEvent event) {
        event.enqueueWork(() -> {
            ...
            ((FlowerPotBlock) Blocks.FLOWER_POT).addPlant(ResourceLocation.fromNamespaceAndPath("got", "bean"),           GotModBlocks.POTTED_BEAN);
            ((FlowerPotBlock) Blocks.FLOWER_POT).addPlant(ResourceLocation.fromNamespaceAndPath("got", "blackberry"),     GotModBlocks.POTTED_BLACKBERRY);
            ((FlowerPotBlock) Blocks.FLOWER_POT).addPlant(ResourceLocation.fromNamespaceAndPath("got", "blueberry"),      GotModBlocks.POTTED_BLUEBERRY);
            ...
            ((FlowerPotBlock) Blocks.FLOWER_POT).addPlant(ResourceLocation.fromNamespaceAndPath("got", "cabbage_plant"),  GotModBlocks.POTTED_CABBAGE_PLANT);
            ((FlowerPotBlock) Blocks.FLOWER_POT).addPlant(ResourceLocation.fromNamespaceAndPath("got", "cardamom"),       GotModBlocks.POTTED_CARDAMOM);
            ((FlowerPotBlock) Blocks.FLOWER_POT).addPlant(ResourceLocation.fromNamespaceAndPath("got", "chickpea"),       GotModBlocks.POTTED_CHICKPEA);
            ((FlowerPotBlock) Blocks.FLOWER_POT).addPlant(ResourceLocation.fromNamespaceAndPath("got", "corn"),           GotModBlocks.POTTED_CORN);
            ((FlowerPotBlock) Blocks.FLOWER_POT).addPlant(ResourceLocation.fromNamespaceAndPath("got", "cucumber"),       GotModBlocks.POTTED_CUCUMBER);
            ...
            ((FlowerPotBlock) Blocks.FLOWER_POT).addPlant(ResourceLocation.fromNamespaceAndPath("got", "hemp"),           GotModBlocks.POTTED_HEMP);
            ...
            ((FlowerPotBlock) Blocks.FLOWER_POT).addPlant(ResourceLocation.fromNamespaceAndPath("got", "licorice"),       GotModBlocks.POTTED_LICORICE);
            ...
            ((FlowerPotBlock) Blocks.FLOWER_POT).addPlant(ResourceLocation.fromNamespaceAndPath("got", "mustard_plant"),  GotModBlocks.POTTED_MUSTARD_PLANT);
            ((FlowerPotBlock) Blocks.FLOWER_POT).addPlant(ResourceLocation.fromNamespaceAndPath("got", "nettle"),         GotModBlocks.POTTED_NETTLE);
            ((FlowerPotBlock) Blocks.FLOWER_POT).addPlant(ResourceLocation.fromNamespaceAndPath("got", "pepper_plant"),   GotModBlocks.POTTED_PEPPER_PLANT);
            ...
            ((FlowerPotBlock) Blocks.FLOWER_POT).addPlant(ResourceLocation.fromNamespaceAndPath("got", "smokeberry"),     GotModBlocks.POTTED_SMOKEBERRY);
