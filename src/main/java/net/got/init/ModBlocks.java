...
import net.got.block.StrippedLogBlock;
...
import net.got.block.SeedCropBlock;
import net.got.block.ShortSeedCropBlock;
import net.got.block.ProduceCropBlock;
import net.got.block.BerryBushBlock;
...
public class ModBlocks {
    ...
    public static final DeferredBlock<Block> WEIRWOOD_FENCE_GATE = woodBlock("weirwood_fence_gate", p -> new GotFenceGateBlock(WoodTypes.WEIRWOOD, p));
    ...
    public static final DeferredBlock<Block> ASPEN_FENCE_GATE = woodBlock("aspen_fence_gate", p -> new GotFenceGateBlock(WoodTypes.ASPEN, p));
    ...
    public static final DeferredBlock<Block> ALDER_FENCE_GATE = woodBlock("alder_fence_gate", p -> new GotFenceGateBlock(WoodTypes.ALDER, p));
    ...
    public static final DeferredBlock<Block> PINE_FENCE_GATE = woodBlock("pine_fence_gate", p -> new GotFenceGateBlock(WoodTypes.PINE, p));
    ...
    public static final DeferredBlock<Block> FIR_FENCE_GATE = woodBlock("fir_fence_gate", p -> new GotFenceGateBlock(WoodTypes.FIR, p));
    ...
    public static final DeferredBlock<Block> SENTINAL_FENCE_GATE = woodBlock("sentinal_fence_gate", p -> new GotFenceGateBlock(WoodTypes.SENTINAL, p));
    ...
    public static final DeferredBlock<Block> IRONWOOD_FENCE_GATE = woodBlock("ironwood_fence_gate", p -> new GotFenceGateBlock(WoodTypes.IRONWOOD, p));
    ...
    public static final DeferredBlock<Block> BEECH_FENCE_GATE = woodBlock("beech_fence_gate", p -> new GotFenceGateBlock(WoodTypes.BEECH, p));
    ...
    public static final DeferredBlock<Block> SOLDIER_PINE_FENCE_GATE = woodBlock("soldier_pine_fence_gate", p -> new GotFenceGateBlock(WoodTypes.PINE, p));
    ...
    public static final DeferredBlock<Block> ASH_FENCE_GATE = woodBlock("ash_fence_gate", p -> new GotFenceGateBlock(WoodTypes.ASH, p));
    ...
    public static final DeferredBlock<Block> HAWTHORN_FENCE_GATE = woodBlock("hawthorn_fence_gate", p -> new GotFenceGateBlock(WoodTypes.HAWTHORN, p));
    ...
    public static final DeferredBlock<Block> BLACKBARK_FENCE_GATE     = woodBlock("blackbark_fence_gate",     p -> new GotFenceGateBlock(WoodTypes.BLACKBARK, p));
    ...
    public static final DeferredBlock<Block> BLOODWOOD_FENCE_GATE     = woodBlock("bloodwood_fence_gate",     p -> new GotFenceGateBlock(WoodTypes.BLOODWOOD, p));
    ...
    public static final DeferredBlock<Block> BLUE_MAHOE_FENCE_GATE     = woodBlock("blue_mahoe_fence_gate",     p -> new GotFenceGateBlock(WoodTypes.BLUE_MAHOE, p));
    ...
    public static final DeferredBlock<Block> COTTONWOOD_FENCE_GATE     = woodBlock("cottonwood_fence_gate",     p -> new GotFenceGateBlock(WoodTypes.COTTONWOOD, p));
    ...
    public static final DeferredBlock<Block> BLACK_COTTONWOOD_FENCE_GATE     = woodBlock("black_cottonwood_fence_gate",     p -> new GotFenceGateBlock(WoodTypes.COTTONWOOD, p));
    ...
    public static final DeferredBlock<Block> CINNAMON_FENCE_GATE     = woodBlock("cinnamon_fence_gate",     p -> new GotFenceGateBlock(WoodTypes.CINNAMON, p));
    ...
    public static final DeferredBlock<Block> CLOVE_FENCE_GATE     = woodBlock("clove_fence_gate",     p -> new GotFenceGateBlock(WoodTypes.CLOVE, p));
    ...
    public static final DeferredBlock<Block> EBONY_FENCE_GATE     = woodBlock("ebony_fence_gate",     p -> new GotFenceGateBlock(WoodTypes.EBONY, p));
    ...
    public static final DeferredBlock<Block> ELM_FENCE_GATE     = woodBlock("elm_fence_gate",     p -> new GotFenceGateBlock(WoodTypes.ELM, p));
    ...
    public static final DeferredBlock<Block> CEDAR_FENCE_GATE     = woodBlock("cedar_fence_gate",     p -> new GotFenceGateBlock(WoodTypes.CEDAR, p));
    ...
    public static final DeferredBlock<Block> WEIRWOOD_SIGN              = woodBlock("weirwood_sign",      p -> new GotStandingSignBlock(WoodTypes.WEIRWOOD, p, () -> ModBlockEntities.WEIRWOOD_SIGN.get()));
    public static final DeferredBlock<Block> WEIRWOOD_WALL_SIGN         = woodBlock("weirwood_wall_sign", p -> new GotWallSignBlock(WoodTypes.WEIRWOOD, p, () -> ModBlockEntities.WEIRWOOD_SIGN.get()));
    public static final DeferredBlock<Block> ASPEN_SIGN              = woodBlock("aspen_sign",      p -> new GotStandingSignBlock(WoodTypes.ASPEN, p, () -> ModBlockEntities.ASPEN_SIGN.get()));
    public static final DeferredBlock<Block> ASPEN_WALL_SIGN         = woodBlock("aspen_wall_sign", p -> new GotWallSignBlock(WoodTypes.ASPEN, p, () -> ModBlockEntities.ASPEN_SIGN.get()));
    public static final DeferredBlock<Block> ALDER_SIGN              = woodBlock("alder_sign",      p -> new GotStandingSignBlock(WoodTypes.ALDER, p, () -> ModBlockEntities.ALDER_SIGN.get()));
    public static final DeferredBlock<Block> ALDER_WALL_SIGN         = woodBlock("alder_wall_sign", p -> new GotWallSignBlock(WoodTypes.ALDER, p, () -> ModBlockEntities.ALDER_SIGN.get()));
    public static final DeferredBlock<Block> PINE_SIGN              = woodBlock("pine_sign",      p -> new GotStandingSignBlock(WoodTypes.PINE, p, () -> ModBlockEntities.PINE_SIGN.get()));
    public static final DeferredBlock<Block> PINE_WALL_SIGN         = woodBlock("pine_wall_sign", p -> new GotWallSignBlock(WoodTypes.PINE, p, () -> ModBlockEntities.PINE_SIGN.get()));
    public static final DeferredBlock<Block> FIR_SIGN              = woodBlock("fir_sign",      p -> new GotStandingSignBlock(WoodTypes.FIR, p, () -> ModBlockEntities.FIR_SIGN.get()));
    public static final DeferredBlock<Block> FIR_WALL_SIGN         = woodBlock("fir_wall_sign", p -> new GotWallSignBlock(WoodTypes.FIR, p, () -> ModBlockEntities.FIR_SIGN.get()));
    public static final DeferredBlock<Block> SENTINAL_SIGN              = woodBlock("sentinal_sign",      p -> new GotStandingSignBlock(WoodTypes.SENTINAL, p, () -> ModBlockEntities.SENTINAL_SIGN.get()));
    public static final DeferredBlock<Block> SENTINAL_WALL_SIGN         = woodBlock("sentinal_wall_sign", p -> new GotWallSignBlock(WoodTypes.SENTINAL, p, () -> ModBlockEntities.SENTINAL_SIGN.get()));
    public static final DeferredBlock<Block> IRONWOOD_SIGN              = woodBlock("ironwood_sign",      p -> new GotStandingSignBlock(WoodTypes.IRONWOOD, p, () -> ModBlockEntities.IRONWOOD_SIGN.get()));
    public static final DeferredBlock<Block> IRONWOOD_WALL_SIGN         = woodBlock("ironwood_wall_sign", p -> new GotWallSignBlock(WoodTypes.IRONWOOD, p, () -> ModBlockEntities.IRONWOOD_SIGN.get()));
    public static final DeferredBlock<Block> BEECH_SIGN              = woodBlock("beech_sign",      p -> new GotStandingSignBlock(WoodTypes.BEECH, p, () -> ModBlockEntities.BEECH_SIGN.get()));
    public static final DeferredBlock<Block> BEECH_WALL_SIGN         = woodBlock("beech_wall_sign", p -> new GotWallSignBlock(WoodTypes.BEECH, p, () -> ModBlockEntities.BEECH_SIGN.get()));
    public static final DeferredBlock<Block> SOLDIER_PINE_SIGN              = woodBlock("soldier_pine_sign",      p -> new GotStandingSignBlock(WoodTypes.SOLDIER_PINE, p, () -> ModBlockEntities.SOLDIER_PINE_SIGN.get()));
    public static final DeferredBlock<Block> SOLDIER_PINE_WALL_SIGN         = woodBlock("soldier_pine_wall_sign", p -> new GotWallSignBlock(WoodTypes.SOLDIER_PINE, p, () -> ModBlockEntities.SOLDIER_PINE_SIGN.get()));
    public static final DeferredBlock<Block> ASH_SIGN              = woodBlock("ash_sign",      p -> new GotStandingSignBlock(WoodTypes.ASH, p, () -> ModBlockEntities.ASH_SIGN.get()));
    public static final DeferredBlock<Block> ASH_WALL_SIGN         = woodBlock("ash_wall_sign", p -> new GotWallSignBlock(WoodTypes.ASH, p, () -> ModBlockEntities.ASH_SIGN.get()));
    public static final DeferredBlock<Block> HAWTHORN_SIGN              = woodBlock("hawthorn_sign",      p -> new GotStandingSignBlock(WoodTypes.HAWTHORN, p, () -> ModBlockEntities.HAWTHORN_SIGN.get()));
    public static final DeferredBlock<Block> HAWTHORN_WALL_SIGN         = woodBlock("hawthorn_wall_sign", p -> new GotWallSignBlock(WoodTypes.HAWTHORN, p, () -> ModBlockEntities.HAWTHORN_SIGN.get()));
    public static final DeferredBlock<Block> BLACKBARK_SIGN              = woodBlock("blackbark_sign",      p -> new GotStandingSignBlock(WoodTypes.BLACKBARK, p, () -> ModBlockEntities.BLACKBARK_SIGN.get()));
    public static final DeferredBlock<Block> BLACKBARK_WALL_SIGN         = woodBlock("blackbark_wall_sign", p -> new GotWallSignBlock(WoodTypes.BLACKBARK, p, () -> ModBlockEntities.BLACKBARK_SIGN.get()));
    public static final DeferredBlock<Block> BLOODWOOD_SIGN              = woodBlock("bloodwood_sign",      p -> new GotStandingSignBlock(WoodTypes.BLOODWOOD, p, () -> ModBlockEntities.BLOODWOOD_SIGN.get()));
    public static final DeferredBlock<Block> BLOODWOOD_WALL_SIGN         = woodBlock("bloodwood_wall_sign", p -> new GotWallSignBlock(WoodTypes.BLOODWOOD, p, () -> ModBlockEntities.BLOODWOOD_SIGN.get()));
    public static final DeferredBlock<Block> BLUE_MAHOE_SIGN              = woodBlock("blue_mahoe_sign",      p -> new GotStandingSignBlock(WoodTypes.BLUE_MAHOE, p, () -> ModBlockEntities.BLUE_MAHOE_SIGN.get()));
    public static final DeferredBlock<Block> BLUE_MAHOE_WALL_SIGN         = woodBlock("blue_mahoe_wall_sign", p -> new GotWallSignBlock(WoodTypes.BLUE_MAHOE, p, () -> ModBlockEntities.BLUE_MAHOE_SIGN.get()));
    public static final DeferredBlock<Block> COTTONWOOD_SIGN              = woodBlock("cottonwood_sign",      p -> new GotStandingSignBlock(WoodTypes.COTTONWOOD, p, () -> ModBlockEntities.COTTONWOOD_SIGN.get()));
    public static final DeferredBlock<Block> COTTONWOOD_WALL_SIGN         = woodBlock("cottonwood_wall_sign", p -> new GotWallSignBlock(WoodTypes.COTTONWOOD, p, () -> ModBlockEntities.COTTONWOOD_SIGN.get()));
    public static final DeferredBlock<Block> BLACK_COTTONWOOD_SIGN              = woodBlock("black_cottonwood_sign",      p -> new GotStandingSignBlock(WoodTypes.BLACK_COTTONWOOD, p, () -> ModBlockEntities.BLACK_COTTONWOOD_SIGN.get()));
    public static final DeferredBlock<Block> BLACK_COTTONWOOD_WALL_SIGN         = woodBlock("black_cottonwood_wall_sign", p -> new GotWallSignBlock(WoodTypes.BLACK_COTTONWOOD, p, () -> ModBlockEntities.BLACK_COTTONWOOD_SIGN.get()));
    public static final DeferredBlock<Block> CINNAMON_SIGN              = woodBlock("cinnamon_sign",      p -> new GotStandingSignBlock(WoodTypes.CINNAMON, p, () -> ModBlockEntities.CINNAMON_SIGN.get()));
    public static final DeferredBlock<Block> CINNAMON_WALL_SIGN         = woodBlock("cinnamon_wall_sign", p -> new GotWallSignBlock(WoodTypes.CINNAMON, p, () -> ModBlockEntities.CINNAMON_SIGN.get()));
    public static final DeferredBlock<Block> CLOVE_SIGN              = woodBlock("clove_sign",      p -> new GotStandingSignBlock(WoodTypes.CLOVE, p, () -> ModBlockEntities.CLOVE_SIGN.get()));
    public static final DeferredBlock<Block> CLOVE_WALL_SIGN         = woodBlock("clove_wall_sign", p -> new GotWallSignBlock(WoodTypes.CLOVE, p, () -> ModBlockEntities.CLOVE_SIGN.get()));
    public static final DeferredBlock<Block> EBONY_SIGN              = woodBlock("ebony_sign",      p -> new GotStandingSignBlock(WoodTypes.EBONY, p, () -> ModBlockEntities.EBONY_SIGN.get()));
    public static final DeferredBlock<Block> EBONY_WALL_SIGN         = woodBlock("ebony_wall_sign", p -> new GotWallSignBlock(WoodTypes.EBONY, p, () -> ModBlockEntities.EBONY_SIGN.get()));
    public static final DeferredBlock<Block> ELM_SIGN              = woodBlock("elm_sign",      p -> new GotStandingSignBlock(WoodTypes.ELM, p, () -> ModBlockEntities.ELM_SIGN.get()));
    public static final DeferredBlock<Block> ELM_WALL_SIGN         = woodBlock("elm_wall_sign", p -> new GotWallSignBlock(WoodTypes.ELM, p, () -> ModBlockEntities.ELM_SIGN.get()));
    public static final DeferredBlock<Block> CEDAR_SIGN              = woodBlock("cedar_sign",      p -> new GotStandingSignBlock(WoodTypes.CEDAR, p, () -> ModBlockEntities.CEDAR_SIGN.get()));
    public static final DeferredBlock<Block> CEDAR_WALL_SIGN         = woodBlock("cedar_wall_sign", p -> new GotWallSignBlock(WoodTypes.CEDAR, p, () -> ModBlockEntities.CEDAR_SIGN.get()));
    public static final DeferredBlock<Block> APPLE_SIGN              = woodBlock("apple_sign",      p -> new GotStandingSignBlock(WoodTypes.APPLE, p, () -> ModBlockEntities.APPLE_SIGN.get()));
    public static final DeferredBlock<Block> APPLE_WALL_SIGN         = woodBlock("apple_wall_sign", p -> new GotWallSignBlock(WoodTypes.APPLE, p, () -> ModBlockEntities.APPLE_SIGN.get()));
    public static final DeferredBlock<Block> GOLDENHEART_SIGN              = woodBlock("goldenheart_sign",      p -> new GotStandingSignBlock(WoodTypes.GOLDENHEART, p, () -> ModBlockEntities.GOLDENHEART_SIGN.get()));
    public static final DeferredBlock<Block> GOLDENHEART_WALL_SIGN         = woodBlock("goldenheart_wall_sign", p -> new GotWallSignBlock(WoodTypes.GOLDENHEART, p, () -> ModBlockEntities.GOLDENHEART_SIGN.get()));
    public static final DeferredBlock<Block> LINDEN_SIGN              = woodBlock("linden_sign",      p -> new GotStandingSignBlock(WoodTypes.LINDEN, p, () -> ModBlockEntities.LINDEN_SIGN.get()));
    public static final DeferredBlock<Block> LINDEN_WALL_SIGN         = woodBlock("linden_wall_sign", p -> new GotWallSignBlock(WoodTypes.LINDEN, p, () -> ModBlockEntities.LINDEN_SIGN.get()));
    public static final DeferredBlock<Block> MAHOGANY_SIGN              = woodBlock("mahogany_sign",      p -> new GotStandingSignBlock(WoodTypes.MAHOGANY, p, () -> ModBlockEntities.MAHOGANY_SIGN.get()));
    public static final DeferredBlock<Block> MAHOGANY_WALL_SIGN         = woodBlock("mahogany_wall_sign", p -> new GotWallSignBlock(WoodTypes.MAHOGANY, p, () -> ModBlockEntities.MAHOGANY_SIGN.get()));
    public static final DeferredBlock<Block> MAPLE_SIGN              = woodBlock("maple_sign",      p -> new GotStandingSignBlock(WoodTypes.MAPLE, p, () -> ModBlockEntities.MAPLE_SIGN.get()));
    public static final DeferredBlock<Block> MAPLE_WALL_SIGN         = woodBlock("maple_wall_sign", p -> new GotWallSignBlock(WoodTypes.MAPLE, p, () -> ModBlockEntities.MAPLE_SIGN.get()));
    public static final DeferredBlock<Block> MYRRH_SIGN              = woodBlock("myrrh_sign",      p -> new GotStandingSignBlock(WoodTypes.MYRRH, p, () -> ModBlockEntities.MYRRH_SIGN.get()));
    public static final DeferredBlock<Block> MYRRH_WALL_SIGN         = woodBlock("myrrh_wall_sign", p -> new GotWallSignBlock(WoodTypes.MYRRH, p, () -> ModBlockEntities.MYRRH_SIGN.get()));
    public static final DeferredBlock<Block> REDWOOD_SIGN              = woodBlock("redwood_sign",      p -> new GotStandingSignBlock(WoodTypes.REDWOOD, p, () -> ModBlockEntities.REDWOOD_SIGN.get()));
    public static final DeferredBlock<Block> REDWOOD_WALL_SIGN         = woodBlock("redwood_wall_sign", p -> new GotWallSignBlock(WoodTypes.REDWOOD, p, () -> ModBlockEntities.REDWOOD_SIGN.get()));
    public static final DeferredBlock<Block> CHESTNUT_SIGN              = woodBlock("chestnut_sign",      p -> new GotStandingSignBlock(WoodTypes.CHESTNUT, p, () -> ModBlockEntities.CHESTNUT_SIGN.get()));
    public static final DeferredBlock<Block> CHESTNUT_WALL_SIGN         = woodBlock("chestnut_wall_sign", p -> new GotWallSignBlock(WoodTypes.CHESTNUT, p, () -> ModBlockEntities.CHESTNUT_SIGN.get()));
    public static final DeferredBlock<Block> WILLOW_SIGN              = woodBlock("willow_sign",      p -> new GotStandingSignBlock(WoodTypes.WILLOW, p, () -> ModBlockEntities.WILLOW_SIGN.get()));
    public static final DeferredBlock<Block> WILLOW_WALL_SIGN         = woodBlock("willow_wall_sign", p -> new GotWallSignBlock(WoodTypes.WILLOW, p, () -> ModBlockEntities.WILLOW_SIGN.get()));
    public static final DeferredBlock<Block> WORMTREE_SIGN              = woodBlock("wormtree_sign",      p -> new GotStandingSignBlock(WoodTypes.WORMTREE, p, () -> ModBlockEntities.WORMTREE_SIGN.get()));
    public static final DeferredBlock<Block> WORMTREE_WALL_SIGN         = woodBlock("wormtree_wall_sign", p -> new GotWallSignBlock(WoodTypes.WORMTREE, p, () -> ModBlockEntities.WORMTREE_SIGN.get()));

    public static final DeferredBlock<Block> WEIRWOOD_HANGING_SIGN      = woodBlock("weirwood_hanging_sign",      p -> new CeilingHangingSignBlock(WoodTypes.WEIRWOOD, p));
    public static final DeferredBlock<Block> WEIRWOOD_WALL_HANGING_SIGN = woodBlock("weirwood_wall_hanging_sign", p -> new WallHangingSignBlock(WoodTypes.WEIRWOOD, p));
    public static final DeferredBlock<Block> ASPEN_HANGING_SIGN      = woodBlock("aspen_hanging_sign",      p -> new CeilingHangingSignBlock(WoodTypes.ASPEN, p));
    public static final DeferredBlock<Block> ASPEN_WALL_HANGING_SIGN = woodBlock("aspen_wall_hanging_sign", p -> new WallHangingSignBlock(WoodTypes.ASPEN, p));
    public static final DeferredBlock<Block> ALDER_HANGING_SIGN      = woodBlock("alder_hanging_sign",      p -> new CeilingHangingSignBlock(WoodTypes.ALDER, p));
    public static final DeferredBlock<Block> ALDER_WALL_HANGING_SIGN = woodBlock("alder_wall_hanging_sign", p -> new WallHangingSignBlock(WoodTypes.ALDER, p));
    public static final DeferredBlock<Block> PINE_HANGING_SIGN      = woodBlock("pine_hanging_sign",      p -> new CeilingHangingSignBlock(WoodTypes.PINE, p));
    public static final DeferredBlock<Block> PINE_WALL_HANGING_SIGN = woodBlock("pine_wall_hanging_sign", p -> new WallHangingSignBlock(WoodTypes.PINE, p));
    public static final DeferredBlock<Block> FIR_HANGING_SIGN      = woodBlock("fir_hanging_sign",      p -> new CeilingHangingSignBlock(WoodTypes.FIR, p));
    public static final DeferredBlock<Block> FIR_WALL_HANGING_SIGN = woodBlock("fir_wall_hanging_sign", p -> new WallHangingSignBlock(WoodTypes.FIR, p));
    public static final DeferredBlock<Block> SENTINAL_HANGING_SIGN      = woodBlock("sentinal_hanging_sign",      p -> new CeilingHangingSignBlock(WoodTypes.SENTINAL, p));
    public static final DeferredBlock<Block> SENTINAL_WALL_HANGING_SIGN = woodBlock("sentinal_wall_hanging_sign", p -> new WallHangingSignBlock(WoodTypes.SENTINAL, p));
    public static final DeferredBlock<Block> IRONWOOD_HANGING_SIGN      = woodBlock("ironwood_hanging_sign",      p -> new CeilingHangingSignBlock(WoodTypes.IRONWOOD, p));
    public static final DeferredBlock<Block> IRONWOOD_WALL_HANGING_SIGN = woodBlock("ironwood_wall_hanging_sign", p -> new WallHangingSignBlock(WoodTypes.IRONWOOD, p));
    public static final DeferredBlock<Block> BEECH_HANGING_SIGN      = woodBlock("beech_hanging_sign",      p -> new CeilingHangingSignBlock(WoodTypes.BEECH, p));
    public static final DeferredBlock<Block> BEECH_WALL_HANGING_SIGN = woodBlock("beech_wall_hanging_sign", p -> new WallHangingSignBlock(WoodTypes.BEECH, p));
    public static final DeferredBlock<Block> SOLDIER_PINE_HANGING_SIGN      = woodBlock("soldier_pine_hanging_sign",      p -> new CeilingHangingSignBlock(WoodTypes.SOLDIER_PINE, p));
    public static final DeferredBlock<Block> SOLDIER_PINE_WALL_HANGING_SIGN = woodBlock("soldier_pine_wall_hanging_sign", p -> new WallHangingSignBlock(WoodTypes.SOLDIER_PINE, p));
    public static final DeferredBlock<Block> ASH_HANGING_SIGN      = woodBlock("ash_hanging_sign",      p -> new CeilingHangingSignBlock(WoodTypes.ASH, p));
    public static final DeferredBlock<Block> ASH_WALL_HANGING_SIGN = woodBlock("ash_wall_hanging_sign", p -> new WallHangingSignBlock(WoodTypes.ASH, p));
    public static final DeferredBlock<Block> HAWTHORN_HANGING_SIGN      = woodBlock("hawthorn_hanging_sign",      p -> new CeilingHangingSignBlock(WoodTypes.HAWTHORN, p));
    public static final DeferredBlock<Block> HAWTHORN_WALL_HANGING_SIGN = woodBlock("hawthorn_wall_hanging_sign", p -> new WallHangingSignBlock(WoodTypes.HAWTHORN, p));
    public static final DeferredBlock<Block> BLACKBARK_HANGING_SIGN      = woodBlock("blackbark_hanging_sign",      p -> new CeilingHangingSignBlock(WoodTypes.BLACKBARK, p));
    public static final DeferredBlock<Block> BLACKBARK_WALL_HANGING_SIGN = woodBlock("blackbark_wall_hanging_sign", p -> new WallHangingSignBlock(WoodTypes.BLACKBARK, p));
    public static final DeferredBlock<Block> BLOODWOOD_HANGING_SIGN      = woodBlock("bloodwood_hanging_sign",      p -> new CeilingHangingSignBlock(WoodTypes.BLOODWOOD, p));
    public static final DeferredBlock<Block> BLOODWOOD_WALL_HANGING_SIGN = woodBlock("bloodwood_wall_hanging_sign", p -> new WallHangingSignBlock(WoodTypes.BLOODWOOD, p));
    public static final DeferredBlock<Block> BLUE_MAHOE_HANGING_SIGN      = woodBlock("blue_mahoe_hanging_sign",      p -> new CeilingHangingSignBlock(WoodTypes.BLUE_MAHOE, p));
    public static final DeferredBlock<Block> BLUE_MAHOE_WALL_HANGING_SIGN = woodBlock("blue_mahoe_wall_hanging_sign", p -> new WallHangingSignBlock(WoodTypes.BLUE_MAHOE, p));
    public static final DeferredBlock<Block> COTTONWOOD_HANGING_SIGN      = woodBlock("cottonwood_hanging_sign",      p -> new CeilingHangingSignBlock(WoodTypes.COTTONWOOD, p));
    public static final DeferredBlock<Block> COTTONWOOD_WALL_HANGING_SIGN = woodBlock("cottonwood_wall_hanging_sign", p -> new WallHangingSignBlock(WoodTypes.COTTONWOOD, p));
    public static final DeferredBlock<Block> BLACK_COTTONWOOD_HANGING_SIGN      = woodBlock("black_cottonwood_hanging_sign",      p -> new CeilingHangingSignBlock(WoodTypes.BLACK_COTTONWOOD, p));
    public static final DeferredBlock<Block> BLACK_COTTONWOOD_WALL_HANGING_SIGN = woodBlock("black_cottonwood_wall_hanging_sign", p -> new WallHangingSignBlock(WoodTypes.BLACK_COTTONWOOD, p));
    public static final DeferredBlock<Block> CINNAMON_HANGING_SIGN      = woodBlock("cinnamon_hanging_sign",      p -> new CeilingHangingSignBlock(WoodTypes.CINNAMON, p));
    public static final DeferredBlock<Block> CINNAMON_WALL_HANGING_SIGN = woodBlock("cinnamon_wall_hanging_sign", p -> new WallHangingSignBlock(WoodTypes.CINNAMON, p));
    public static final DeferredBlock<Block> CLOVE_HANGING_SIGN      = woodBlock("clove_hanging_sign",      p -> new CeilingHangingSignBlock(WoodTypes.CLOVE, p));
    public static final DeferredBlock<Block> CLOVE_WALL_HANGING_SIGN = woodBlock("clove_wall_hanging_sign", p -> new WallHangingSignBlock(WoodTypes.CLOVE, p));
    public static final DeferredBlock<Block> EBONY_HANGING_SIGN      = woodBlock("ebony_hanging_sign",      p -> new CeilingHangingSignBlock(WoodTypes.EBONY, p));
    public static final DeferredBlock<Block> EBONY_WALL_HANGING_SIGN = woodBlock("ebony_wall_hanging_sign", p -> new WallHangingSignBlock(WoodTypes.EBONY, p));
    public static final DeferredBlock<Block> ELM_HANGING_SIGN      = woodBlock("elm_hanging_sign",      p -> new CeilingHangingSignBlock(WoodTypes.ELM, p));
    public static final DeferredBlock<Block> ELM_WALL_HANGING_SIGN = woodBlock("elm_wall_hanging_sign", p -> new WallHangingSignBlock(WoodTypes.ELM, p));
    public static final DeferredBlock<Block> CEDAR_HANGING_SIGN      = woodBlock("cedar_hanging_sign",      p -> new CeilingHangingSignBlock(WoodTypes.CEDAR, p));
    public static final DeferredBlock<Block> CEDAR_WALL_HANGING_SIGN = woodBlock("cedar_wall_hanging_sign", p -> new WallHangingSignBlock(WoodTypes.CEDAR, p));
    public static final DeferredBlock<Block> APPLE_HANGING_SIGN      = woodBlock("apple_hanging_sign",      p -> new CeilingHangingSignBlock(WoodTypes.APPLE, p));
    public static final DeferredBlock<Block> APPLE_WALL_HANGING_SIGN = woodBlock("apple_wall_hanging_sign", p -> new WallHangingSignBlock(WoodTypes.APPLE, p));
    public static final DeferredBlock<Block> GOLDENHEART_HANGING_SIGN      = woodBlock("goldenheart_hanging_sign",      p -> new CeilingHangingSignBlock(WoodTypes.GOLDENHEART, p));
    public static final DeferredBlock<Block> GOLDENHEART_WALL_HANGING_SIGN = woodBlock("goldenheart_wall_hanging_sign", p -> new WallHangingSignBlock(WoodTypes.GOLDENHEART, p));
    public static final DeferredBlock<Block> LINDEN_HANGING_SIGN      = woodBlock("linden_hanging_sign",      p -> new CeilingHangingSignBlock(WoodTypes.LINDEN, p));
    public static final DeferredBlock<Block> LINDEN_WALL_HANGING_SIGN = woodBlock("linden_wall_hanging_sign", p -> new WallHangingSignBlock(WoodTypes.LINDEN, p));
    public static final DeferredBlock<Block> MAHOGANY_HANGING_SIGN      = woodBlock("mahogany_hanging_sign",      p -> new CeilingHangingSignBlock(WoodTypes.MAHOGANY, p));
    public static final DeferredBlock<Block> MAHOGANY_WALL_HANGING_SIGN = woodBlock("mahogany_wall_hanging_sign", p -> new WallHangingSignBlock(WoodTypes.MAHOGANY, p));
    public static final DeferredBlock<Block> MAPLE_HANGING_SIGN      = woodBlock("maple_hanging_sign",      p -> new CeilingHangingSignBlock(WoodTypes.MAPLE, p));
    public static final DeferredBlock<Block> MAPLE_WALL_HANGING_SIGN = woodBlock("maple_wall_hanging_sign", p -> new WallHangingSignBlock(WoodTypes.MAPLE, p));
    public static final DeferredBlock<Block> MYRRH_HANGING_SIGN      = woodBlock("myrrh_hanging_sign",      p -> new CeilingHangingSignBlock(WoodTypes.MYRRH, p));
    public static final DeferredBlock<Block> MYRRH_WALL_HANGING_SIGN = woodBlock("myrrh_wall_hanging_sign", p -> new WallHangingSignBlock(WoodTypes.MYRRH, p));
    public static final DeferredBlock<Block> REDWOOD_HANGING_SIGN      = woodBlock("redwood_hanging_sign",      p -> new CeilingHangingSignBlock(WoodTypes.REDWOOD, p));
    public static final DeferredBlock<Block> REDWOOD_WALL_HANGING_SIGN = woodBlock("redwood_wall_hanging_sign", p -> new WallHangingSignBlock(WoodTypes.REDWOOD, p));
    public static final DeferredBlock<Block> CHESTNUT_HANGING_SIGN      = woodBlock("chestnut_hanging_sign",      p -> new CeilingHangingSignBlock(WoodTypes.CHESTNUT, p));
    public static final DeferredBlock<Block> CHESTNUT_WALL_HANGING_SIGN = woodBlock("chestnut_wall_hanging_sign", p -> new WallHangingSignBlock(WoodTypes.CHESTNUT, p));
    public static final DeferredBlock<Block> WILLOW_HANGING_SIGN      = woodBlock("willow_hanging_sign",      p -> new CeilingHangingSignBlock(WoodTypes.WILLOW, p));
    public static final DeferredBlock<Block> WILLOW_WALL_HANGING_SIGN = woodBlock("willow_wall_hanging_sign", p -> new WallHangingSignBlock(WoodTypes.WILLOW, p));
    public static final DeferredBlock<Block> WORMTREE_HANGING_SIGN      = woodBlock("wormtree_hanging_sign",      p -> new CeilingHangingSignBlock(WoodTypes.WORMTREE, p));
    public static final DeferredBlock<Block> WORMTREE_WALL_HANGING_SIGN = woodBlock("wormtree_wall_hanging_sign", p -> new WallHangingSignBlock(WoodTypes.WORMTREE, p));
    ...
    public static final DeferredBlock<Block> STRIPPED_WEIRWOOD_LOG = logBlock("stripped_weirwood_log", StrippedLogBlock::new);
    public static final DeferredBlock<Block> STRIPPED_ASPEN_LOG = logBlock("stripped_aspen_log", StrippedLogBlock::new);
    public static final DeferredBlock<Block> STRIPPED_ALDER_LOG = logBlock("stripped_alder_log", StrippedLogBlock::new);
    public static final DeferredBlock<Block> STRIPPED_PINE_LOG = logBlock("stripped_pine_log", StrippedLogBlock::new);
    public static final DeferredBlock<Block> STRIPPED_FIR_LOG = logBlock("stripped_fir_log", StrippedLogBlock::new);
    public static final DeferredBlock<Block> STRIPPED_SENTINAL_LOG = logBlock("stripped_sentinal_log", StrippedLogBlock::new);
    public static final DeferredBlock<Block> STRIPPED_IRONWOOD_LOG = logBlock("stripped_ironwood_log", StrippedLogBlock::new);
    public static final DeferredBlock<Block> STRIPPED_BEECH_LOG = logBlock("stripped_beech_log", StrippedLogBlock::new);
    public static final DeferredBlock<Block> STRIPPED_SOLDIER_PINE_LOG = logBlock("stripped_soldier_pine_log", StrippedLogBlock::new);
    public static final DeferredBlock<Block> STRIPPED_ASH_LOG = logBlock("stripped_ash_log", StrippedLogBlock::new);
    public static final DeferredBlock<Block> STRIPPED_HAWTHORN_LOG = logBlock("stripped_hawthorn_log", StrippedLogBlock::new);
    public static final DeferredBlock<Block> STRIPPED_BLACKBARK_LOG = logBlock("stripped_blackbark_log", StrippedLogBlock::new);
    public static final DeferredBlock<Block> STRIPPED_BLOODWOOD_LOG = logBlock("stripped_bloodwood_log", StrippedLogBlock::new);
    public static final DeferredBlock<Block> STRIPPED_BLUE_MAHOE_LOG = logBlock("stripped_blue_mahoe_log", StrippedLogBlock::new);
    public static final DeferredBlock<Block> STRIPPED_COTTONWOOD_LOG = logBlock("stripped_cottonwood_log", StrippedLogBlock::new);
    public static final DeferredBlock<Block> STRIPPED_BLACK_COTTONWOOD_LOG = logBlock("stripped_black_cottonwood_log", StrippedLogBlock::new);
    public static final DeferredBlock<Block> STRIPPED_CINNAMON_LOG = logBlock("stripped_cinnamon_log", StrippedLogBlock::new);
    public static final DeferredBlock<Block> STRIPPED_CLOVE_LOG = logBlock("stripped_clove_log", StrippedLogBlock::new);
    public static final DeferredBlock<Block> STRIPPED_EBONY_LOG = logBlock("stripped_ebony_log", StrippedLogBlock::new);
    public static final DeferredBlock<Block> STRIPPED_ELM_LOG = logBlock("stripped_elm_log", StrippedLogBlock::new);
    public static final DeferredBlock<Block> STRIPPED_CEDAR_LOG = logBlock("stripped_cedar_log", StrippedLogBlock::new);
    public static final DeferredBlock<Block> STRIPPED_APPLE_LOG = logBlock("stripped_apple_log", StrippedLogBlock::new);
    public static final DeferredBlock<Block> STRIPPED_GOLDENHEART_LOG = logBlock("stripped_goldenheart_log", StrippedLogBlock::new);
    public static final DeferredBlock<Block> STRIPPED_LINDEN_LOG = logBlock("stripped_linden_log", StrippedLogBlock::new);
    public static final DeferredBlock<Block> STRIPPED_MAHOGANY_LOG = logBlock("stripped_mahogany_log", StrippedLogBlock::new);
    public static final DeferredBlock<Block> STRIPPED_MAPLE_LOG = logBlock("stripped_maple_log", StrippedLogBlock::new);
    public static final DeferredBlock<Block> STRIPPED_MYRRH_LOG = logBlock("stripped_myrrh_log", StrippedLogBlock::new);
    public static final DeferredBlock<Block> STRIPPED_REDWOOD_LOG = logBlock("stripped_redwood_log", StrippedLogBlock::new);
    public static final DeferredBlock<Block> STRIPPED_CHESTNUT_LOG = logBlock("stripped_chestnut_log", StrippedLogBlock::new);
    public static final DeferredBlock<Block> STRIPPED_WILLOW_LOG = logBlock("stripped_willow_log", StrippedLogBlock::new);
    public static final DeferredBlock<Block> STRIPPED_WORMTREE_LOG = logBlock("stripped_wormtree_log", StrippedLogBlock::new);

    public static final DeferredBlock<Block> STRIPPED_WEIRWOOD_WOOD         = logBlock("stripped_weirwood_wood",         StrippedLogBlock::new);
    public static final DeferredBlock<Block> STRIPPED_ASPEN_WOOD            = logBlock("stripped_aspen_wood",            StrippedLogBlock::new);
    public static final DeferredBlock<Block> STRIPPED_ALDER_WOOD            = logBlock("stripped_alder_wood",            StrippedLogBlock::new);
    public static final DeferredBlock<Block> STRIPPED_PINE_WOOD             = logBlock("stripped_pine_wood",             StrippedLogBlock::new);
    public static final DeferredBlock<Block> STRIPPED_FIR_WOOD              = logBlock("stripped_fir_wood",              StrippedLogBlock::new);
    public static final DeferredBlock<Block> STRIPPED_SENTINAL_WOOD         = logBlock("stripped_sentinal_wood",         StrippedLogBlock::new);
    public static final DeferredBlock<Block> STRIPPED_IRONWOOD_WOOD         = logBlock("stripped_ironwood_wood",         StrippedLogBlock::new);
    public static final DeferredBlock<Block> STRIPPED_BEECH_WOOD            = logBlock("stripped_beech_wood",            StrippedLogBlock::new);
    public static final DeferredBlock<Block> STRIPPED_SOLDIER_PINE_WOOD     = logBlock("stripped_soldier_pine_wood",     StrippedLogBlock::new);
    public static final DeferredBlock<Block> STRIPPED_ASH_WOOD              = logBlock("stripped_ash_wood",              StrippedLogBlock::new);
    public static final DeferredBlock<Block> STRIPPED_HAWTHORN_WOOD         = logBlock("stripped_hawthorn_wood",         StrippedLogBlock::new);
    public static final DeferredBlock<Block> STRIPPED_BLACKBARK_WOOD        = logBlock("stripped_blackbark_wood",        StrippedLogBlock::new);
    public static final DeferredBlock<Block> STRIPPED_BLOODWOOD_WOOD        = logBlock("stripped_bloodwood_wood",        StrippedLogBlock::new);
    public static final DeferredBlock<Block> STRIPPED_BLUE_MAHOE_WOOD       = logBlock("stripped_blue_mahoe_wood",       StrippedLogBlock::new);
    public static final DeferredBlock<Block> STRIPPED_COTTONWOOD_WOOD       = logBlock("stripped_cottonwood_wood",       StrippedLogBlock::new);
    public static final DeferredBlock<Block> STRIPPED_BLACK_COTTONWOOD_WOOD = logBlock("stripped_black_cottonwood_wood", StrippedLogBlock::new);
    public static final DeferredBlock<Block> STRIPPED_CINNAMON_WOOD         = logBlock("stripped_cinnamon_wood",         StrippedLogBlock::new);
    public static final DeferredBlock<Block> STRIPPED_CLOVE_WOOD            = logBlock("stripped_clove_wood",            StrippedLogBlock::new);
    public static final DeferredBlock<Block> STRIPPED_EBONY_WOOD            = logBlock("stripped_ebony_wood",            StrippedLogBlock::new);
    public static final DeferredBlock<Block> STRIPPED_ELM_WOOD              = logBlock("stripped_elm_wood",              StrippedLogBlock::new);
    public static final DeferredBlock<Block> STRIPPED_CEDAR_WOOD            = logBlock("stripped_cedar_wood",            StrippedLogBlock::new);
    public static final DeferredBlock<Block> STRIPPED_APPLE_WOOD            = logBlock("stripped_apple_wood",            StrippedLogBlock::new);
    public static final DeferredBlock<Block> STRIPPED_GOLDENHEART_WOOD      = logBlock("stripped_goldenheart_wood",      StrippedLogBlock::new);
    public static final DeferredBlock<Block> STRIPPED_LINDEN_WOOD           = logBlock("stripped_linden_wood",           StrippedLogBlock::new);
    public static final DeferredBlock<Block> STRIPPED_MAHOGANY_WOOD         = logBlock("stripped_mahogany_wood",         StrippedLogBlock::new);
    public static final DeferredBlock<Block> STRIPPED_MAPLE_WOOD            = logBlock("stripped_maple_wood",            StrippedLogBlock::new);
    public static final DeferredBlock<Block> STRIPPED_MYRRH_WOOD            = logBlock("stripped_myrrh_wood",            StrippedLogBlock::new);
    public static final DeferredBlock<Block> STRIPPED_REDWOOD_WOOD          = logBlock("stripped_redwood_wood",          StrippedLogBlock::new);
    public static final DeferredBlock<Block> STRIPPED_CHESTNUT_WOOD         = logBlock("stripped_chestnut_wood",         StrippedLogBlock::new);
    public static final DeferredBlock<Block> STRIPPED_WILLOW_WOOD           = logBlock("stripped_willow_wood",           StrippedLogBlock::new);
    public static final DeferredBlock<Block> STRIPPED_WORMTREE_WOOD         = logBlock("stripped_wormtree_wood",         StrippedLogBlock::new);
    ...
    public static final DeferredBlock<Block> WEIRWOOD_SAPLING = woodBlock("weirwood_sapling", p -> new GotSaplingBlock(TreeGrowers.WEIRWOOD, p));
    public static final DeferredBlock<Block> ASPEN_SAPLING = woodBlock("aspen_sapling", p -> new GotSaplingBlock(TreeGrowers.ASPEN, p));
    public static final DeferredBlock<Block> ALDER_SAPLING = woodBlock("alder_sapling", p -> new GotSaplingBlock(TreeGrowers.ALDER, p));
    public static final DeferredBlock<Block> PINE_SAPLING = woodBlock("pine_sapling", p -> new GotSaplingBlock(TreeGrowers.PINE, p));
    public static final DeferredBlock<Block> FIR_SAPLING = woodBlock("fir_sapling", p -> new GotSaplingBlock(TreeGrowers.FIR, p));
    public static final DeferredBlock<Block> SENTINAL_SAPLING = woodBlock("sentinal_sapling", p -> new GotSaplingBlock(TreeGrowers.SENTINAL, p));
    public static final DeferredBlock<Block> IRONWOOD_SAPLING = woodBlock("ironwood_sapling", p -> new GotSaplingBlock(TreeGrowers.IRONWOOD, p));
    public static final DeferredBlock<Block> BEECH_SAPLING = woodBlock("beech_sapling", p -> new GotSaplingBlock(TreeGrowers.BEECH, p));
    public static final DeferredBlock<Block> SOLDIER_PINE_SAPLING = woodBlock("soldier_pine_sapling", p -> new GotSaplingBlock(TreeGrowers.SOLDIER_PINE, p));
    public static final DeferredBlock<Block> ASH_SAPLING = woodBlock("ash_sapling", p -> new GotSaplingBlock(TreeGrowers.ASH, p));
    public static final DeferredBlock<Block> HAWTHORN_SAPLING = woodBlock("hawthorn_sapling", p -> new GotSaplingBlock(TreeGrowers.HAWTHORN, p));
    public static final DeferredBlock<Block> BLACKBARK_SAPLING = woodBlock("blackbark_sapling", p -> new GotSaplingBlock(TreeGrowers.BLACKBARK, p));
    public static final DeferredBlock<Block> BLOODWOOD_SAPLING = woodBlock("bloodwood_sapling", p -> new GotSaplingBlock(TreeGrowers.BLOODWOOD, p));
    public static final DeferredBlock<Block> BLUE_MAHOE_SAPLING = woodBlock("blue_mahoe_sapling", p -> new GotSaplingBlock(TreeGrowers.BLUE_MAHOE, p));
    public static final DeferredBlock<Block> COTTONWOOD_SAPLING = woodBlock("cottonwood_sapling", p -> new GotSaplingBlock(TreeGrowers.COTTONWOOD, p));
    public static final DeferredBlock<Block> BLACK_COTTONWOOD_SAPLING = woodBlock("black_cottonwood_sapling", p -> new GotSaplingBlock(TreeGrowers.BLACK_COTTONWOOD, p));
    public static final DeferredBlock<Block> CINNAMON_SAPLING = woodBlock("cinnamon_sapling", p -> new GotSaplingBlock(TreeGrowers.CINNAMON, p));
    public static final DeferredBlock<Block> CLOVE_SAPLING = woodBlock("clove_sapling", p -> new GotSaplingBlock(TreeGrowers.CLOVE, p));
    public static final DeferredBlock<Block> EBONY_SAPLING = woodBlock("ebony_sapling", p -> new GotSaplingBlock(TreeGrowers.EBONY, p));
    public static final DeferredBlock<Block> ELM_SAPLING = woodBlock("elm_sapling", p -> new GotSaplingBlock(TreeGrowers.ELM, p));
    public static final DeferredBlock<Block> CEDAR_SAPLING = woodBlock("cedar_sapling", p -> new GotSaplingBlock(TreeGrowers.CEDAR, p));
    public static final DeferredBlock<Block> APPLE_SAPLING = woodBlock("apple_sapling", p -> new GotSaplingBlock(TreeGrowers.APPLE, p));
    public static final DeferredBlock<Block> GOLDENHEART_SAPLING = woodBlock("goldenheart_sapling", p -> new GotSaplingBlock(TreeGrowers.GOLDENHEART, p));
    public static final DeferredBlock<Block> LINDEN_SAPLING = woodBlock("linden_sapling", p -> new GotSaplingBlock(TreeGrowers.LINDEN, p));
    public static final DeferredBlock<Block> MAHOGANY_SAPLING = woodBlock("mahogany_sapling", p -> new GotSaplingBlock(TreeGrowers.MAHOGANY, p));
    public static final DeferredBlock<Block> MAPLE_SAPLING = woodBlock("maple_sapling", p -> new GotSaplingBlock(TreeGrowers.MAPLE, p));
    public static final DeferredBlock<Block> MYRRH_SAPLING = woodBlock("myrrh_sapling", p -> new GotSaplingBlock(TreeGrowers.MYRRH, p));
    public static final DeferredBlock<Block> REDWOOD_SAPLING = woodBlock("redwood_sapling", p -> new GotSaplingBlock(TreeGrowers.REDWOOD, p));
    public static final DeferredBlock<Block> CHESTNUT_SAPLING = woodBlock("chestnut_sapling", p -> new GotSaplingBlock(TreeGrowers.CHESTNUT, p));
    public static final DeferredBlock<Block> WILLOW_SAPLING = woodBlock("willow_sapling", p -> new GotSaplingBlock(TreeGrowers.WILLOW, p));
    public static final DeferredBlock<Block> WORMTREE_SAPLING = woodBlock("wormtree_sapling", p -> new GotSaplingBlock(TreeGrowers.WORMTREE, p));
    ...
    public static final DeferredBlock<Block> SMOKEBERRY_BUSH   = berryBushBlock("smokeberry_bush",   () -> ModItems.SMOKEBERRIES.get());
    ...
    public static final DeferredBlock<Block> OAT_CROP      = seedCropBlock("oat_crop",      () -> ModItems.OAT_SEEDS.get());
    public static final DeferredBlock<Block> RYE_CROP      = seedCropBlock("rye_crop",      () -> ModItems.RYE_SEEDS.get());
    public static final DeferredBlock<Block> BARLEY_CROP   = seedCropBlock("barley_crop",   () -> ModItems.BARLEY_SEEDS.get());
    public static final DeferredBlock<Block> COTTON_CROP      = seedCropBlock("cotton_crop",      () -> ModItems.COTTON_SEEDS.get());
    public static final DeferredBlock<Block> PEPPERCORN_CROP  = seedCropBlock("peppercorn_crop",  () -> ModItems.PEPPERCORN_SEEDS.get());
    public static final DeferredBlock<Block> BEAN_CROP          = shortProduceCropBlock("bean_crop",     () -> ModItems.BEAN.get());

    public static final DeferredBlock<Block> CARDAMOM_CROP      = seedCropBlock("cardamom_crop",      () -> ModItems.CARDAMOM_SEEDS.get());
    public static final DeferredBlock<Block> CHICKPEA_CROP      = seedCropBlock("chickpea_crop",      () -> ModItems.CHICKPEA_SEEDS.get());
    public static final DeferredBlock<Block> CORN_CROP          = shortSeedCropBlock("corn_crop",     () -> ModItems.CORN_SEEDS.get());
    public static final DeferredBlock<Block> CUCUMBER_CROP      = shortSeedCropBlock("cucumber_crop",     () -> ModItems.CUCUMBER_SEEDS.get());
    public static final DeferredBlock<Block> HEMP_CROP          = seedCropBlock("hemp_crop",          () -> ModItems.HEMP_SEEDS.get());
    public static final DeferredBlock<Block> LICORICE_CROP      = seedCropBlock("licorice_crop",      () -> ModItems.LICORICE_SEEDS.get());
    public static final DeferredBlock<Block> MUSTARD_PLANT_CROP = seedCropBlock("mustard_plant_crop", () -> ModItems.MUSTARD_PLANT_SEEDS.get());
    public static final DeferredBlock<Block> PEPPER_PLANT_CROP  = seedCropBlock("pepper_plant_crop",  () -> ModItems.PEPPER_PLANT_SEEDS.get());

    public static final DeferredBlock<Block> PARSNIP_CROP = produceCropBlock("parsnip_crop", () -> ModItems.PARSNIP.get());
    public static final DeferredBlock<Block> ONION_CROP   = produceCropBlock("onion_crop",   () -> ModItems.ONION.get());
    public static final DeferredBlock<Block> TURNIP_CROP  = produceCropBlock("turnip_crop",  () -> ModItems.TURNIP.get());
    public static final DeferredBlock<Block> PEAS_CROP    = produceCropBlock("peas_crop",    () -> ModItems.PEAS.get());
    public static final DeferredBlock<Block> CABBAGE_CROP = shortSeedCropBlock("cabbage_crop", () -> ModItems.CABBAGE_PLANT_SEEDS.get());
    public static final DeferredBlock<Block> GARLIC_CROP      = produceCropBlock("garlic_crop",      () -> ModItems.GARLIC.get());
    public static final DeferredBlock<Block> NEEP_CROP        = produceCropBlock("neep_crop",        () -> ModItems.NEEP.get());
    public static final DeferredBlock<Block> HORSERADISH_CROP = produceCropBlock("horseradish_crop", () -> ModItems.HORSERADISH.get());
    public static final DeferredBlock<Block> LEEK_CROP        = produceCropBlock("leek_crop",        () -> ModItems.LEEK.get());

    public static final DeferredBlock<Block> BLACKBERRY_BUSH  = berryBushBlock("blackberry_bush",  () -> ModItems.BLACKBERRIES.get());
    public static final DeferredBlock<Block> BLUEBERRY_BUSH   = berryBushBlock("blueberry_bush",   () -> ModItems.BLUEBERRIES.get());
    public static final DeferredBlock<Block> RASPBERRY_BUSH   = berryBushBlock("raspberry_bush",   () -> ModItems.RASPBERRIES.get());
    public static final DeferredBlock<Block> STRAWBERRY_CROP   = REGISTRY.registerBlock("strawberry_crop",
            p -> new StrawberryCropBlock(p),
    ...
    public static final DeferredBlock<Block> GRASS_BLOCK_SLAB   = registerGrassBlock("grass_block_slab", p -> new GrassBlockSlabBlock(p, ModBlocks.DIRT_PATH_SLAB));
    public static final DeferredBlock<Block> GRASS_BLOCK_STAIRS = registerGrassBlock("grass_block_stairs", p -> new GrassBlockStairsBlock(p, ModBlocks.DIRT_PATH_STAIRS));
    ...
    public static final DeferredBlock<Block> APPLE_FENCE_GATE     = woodBlock("apple_fence_gate",     p -> new GotFenceGateBlock(WoodTypes.APPLE, p));
    ...
    public static final DeferredBlock<Block> GOLDENHEART_FENCE_GATE     = woodBlock("goldenheart_fence_gate",     p -> new GotFenceGateBlock(WoodTypes.GOLDENHEART, p));
    ...
    public static final DeferredBlock<Block> LINDEN_FENCE_GATE     = woodBlock("linden_fence_gate",     p -> new GotFenceGateBlock(WoodTypes.LINDEN, p));
    ...
    public static final DeferredBlock<Block> MAHOGANY_FENCE_GATE     = woodBlock("mahogany_fence_gate",     p -> new GotFenceGateBlock(WoodTypes.MAHOGANY, p));
    ...
    public static final DeferredBlock<Block> MAPLE_FENCE_GATE     = woodBlock("maple_fence_gate",     p -> new GotFenceGateBlock(WoodTypes.MAPLE, p));
    ...
    public static final DeferredBlock<Block> MYRRH_FENCE_GATE     = woodBlock("myrrh_fence_gate",     p -> new GotFenceGateBlock(WoodTypes.MYRRH, p));
    ...
    public static final DeferredBlock<Block> REDWOOD_FENCE_GATE     = woodBlock("redwood_fence_gate",     p -> new GotFenceGateBlock(WoodTypes.REDWOOD, p));
    ...
    public static final DeferredBlock<Block> CHESTNUT_FENCE_GATE     = woodBlock("chestnut_fence_gate",     p -> new GotFenceGateBlock(WoodTypes.CHESTNUT, p));
    ...
    public static final DeferredBlock<Block> WILLOW_FENCE_GATE     = woodBlock("willow_fence_gate",     p -> new GotFenceGateBlock(WoodTypes.WILLOW, p));
    ...
    public static final DeferredBlock<Block> WORMTREE_FENCE_GATE     = woodBlock("wormtree_fence_gate",     p -> new GotFenceGateBlock(WoodTypes.WORMTREE, p));
    ...
    private static DeferredBlock<Block> shortSeedCropBlock(String name, java.util.function.Supplier<Item> seed) {
        ...
        return REGISTRY.registerBlock(name,
                p -> new ShortSeedCropBlock(seed, p),
                BlockBehaviour.Properties.of()
                        .noCollision()
                        .randomTicks()
                        .instabreak()
    ...
    private static DeferredBlock<Block> produceCropBlock(String name, java.util.function.Supplier<Item> produce) {
        return REGISTRY.registerBlock(name,
                p -> new ProduceCropBlock(produce, p),
    ...
    private static DeferredBlock<Block> shortProduceCropBlock(String name, java.util.function.Supplier<Item> produce) {
        ...
        return REGISTRY.registerBlock(name,
                p -> new ShortProduceCropBlock(produce, p),
                BlockBehaviour.Properties.of()
                        .noCollision()
                        .randomTicks()
                        .instabreak()
    ...
    public static final DeferredBlock<Block> NIGHTWOOD_FENCE_GATE     = woodBlock("nightwood_fence_gate",     p -> new GotFenceGateBlock(WoodTypes.NIGHTWOOD, p));
    ...
    public static final DeferredBlock<Block> NIGHTWOOD_SIGN           = woodBlock("nightwood_sign",      p -> new GotStandingSignBlock(WoodTypes.NIGHTWOOD, p, () -> ModBlockEntities.NIGHTWOOD_SIGN.get()));
    public static final DeferredBlock<Block> NIGHTWOOD_WALL_SIGN      = woodBlock("nightwood_wall_sign", p -> new GotWallSignBlock(WoodTypes.NIGHTWOOD, p, () -> ModBlockEntities.NIGHTWOOD_SIGN.get()));
    public static final DeferredBlock<Block> NIGHTWOOD_HANGING_SIGN      = woodBlock("nightwood_hanging_sign",      p -> new CeilingHangingSignBlock(WoodTypes.NIGHTWOOD, p));
    public static final DeferredBlock<Block> NIGHTWOOD_WALL_HANGING_SIGN = woodBlock("nightwood_wall_hanging_sign", p -> new WallHangingSignBlock(WoodTypes.NIGHTWOOD, p));
    ...
    public static final DeferredBlock<Block> NIGHTWOOD_SAPLING        = woodBlock("nightwood_sapling",        p -> new GotSaplingBlock(TreeGrowers.NIGHTWOOD, p));
    public static final DeferredBlock<Block> STRIPPED_NIGHTWOOD_LOG   = logBlock("stripped_nightwood_log",   StrippedLogBlock::new);
    public static final DeferredBlock<Block> STRIPPED_NIGHTWOOD_WOOD  = logBlock("stripped_nightwood_wood",  StrippedLogBlock::new);
    ...
    public static final DeferredBlock<Block> PURPLEHEART_FENCE_GATE     = woodBlock("purpleheart_fence_gate",     p -> new GotFenceGateBlock(WoodTypes.PURPLEHEART, p));
    ...
    public static final DeferredBlock<Block> PURPLEHEART_SIGN           = woodBlock("purpleheart_sign",      p -> new GotStandingSignBlock(WoodTypes.PURPLEHEART, p, () -> ModBlockEntities.PURPLEHEART_SIGN.get()));
    public static final DeferredBlock<Block> PURPLEHEART_WALL_SIGN      = woodBlock("purpleheart_wall_sign", p -> new GotWallSignBlock(WoodTypes.PURPLEHEART, p, () -> ModBlockEntities.PURPLEHEART_SIGN.get()));
    public static final DeferredBlock<Block> PURPLEHEART_HANGING_SIGN      = woodBlock("purpleheart_hanging_sign",      p -> new CeilingHangingSignBlock(WoodTypes.PURPLEHEART, p));
    public static final DeferredBlock<Block> PURPLEHEART_WALL_HANGING_SIGN = woodBlock("purpleheart_wall_hanging_sign", p -> new WallHangingSignBlock(WoodTypes.PURPLEHEART, p));
    ...
    public static final DeferredBlock<Block> PURPLEHEART_SAPLING        = woodBlock("purpleheart_sapling",        p -> new GotSaplingBlock(TreeGrowers.PURPLEHEART, p));
    public static final DeferredBlock<Block> STRIPPED_PURPLEHEART_LOG   = logBlock("stripped_purpleheart_log",   StrippedLogBlock::new);
    public static final DeferredBlock<Block> STRIPPED_PURPLEHEART_WOOD  = logBlock("stripped_purpleheart_wood",  StrippedLogBlock::new);
    ...
    public static final DeferredBlock<Block> TIGERWOOD_FENCE_GATE     = woodBlock("tigerwood_fence_gate",     p -> new GotFenceGateBlock(WoodTypes.TIGERWOOD, p));
    ...
    public static final DeferredBlock<Block> TIGERWOOD_SIGN           = woodBlock("tigerwood_sign",      p -> new GotStandingSignBlock(WoodTypes.TIGERWOOD, p, () -> ModBlockEntities.TIGERWOOD_SIGN.get()));
    public static final DeferredBlock<Block> TIGERWOOD_WALL_SIGN      = woodBlock("tigerwood_wall_sign", p -> new GotWallSignBlock(WoodTypes.TIGERWOOD, p, () -> ModBlockEntities.TIGERWOOD_SIGN.get()));
    public static final DeferredBlock<Block> TIGERWOOD_HANGING_SIGN      = woodBlock("tigerwood_hanging_sign",      p -> new CeilingHangingSignBlock(WoodTypes.TIGERWOOD, p));
    public static final DeferredBlock<Block> TIGERWOOD_WALL_HANGING_SIGN = woodBlock("tigerwood_wall_hanging_sign", p -> new WallHangingSignBlock(WoodTypes.TIGERWOOD, p));
    ...
    public static final DeferredBlock<Block> TIGERWOOD_SAPLING        = woodBlock("tigerwood_sapling",        p -> new GotSaplingBlock(TreeGrowers.TIGERWOOD, p));
    public static final DeferredBlock<Block> STRIPPED_TIGERWOOD_LOG   = logBlock("stripped_tigerwood_log",   StrippedLogBlock::new);
    public static final DeferredBlock<Block> STRIPPED_TIGERWOOD_WOOD  = logBlock("stripped_tigerwood_wood",  StrippedLogBlock::new);
    ...
    public static final DeferredBlock<Block> SANDALWOOD_FENCE_GATE     = woodBlock("sandalwood_fence_gate",     p -> new GotFenceGateBlock(WoodTypes.SANDALWOOD, p));
    ...
    public static final DeferredBlock<Block> SANDALWOOD_SIGN           = woodBlock("sandalwood_sign",      p -> new GotStandingSignBlock(WoodTypes.SANDALWOOD, p, () -> ModBlockEntities.SANDALWOOD_SIGN.get()));
    public static final DeferredBlock<Block> SANDALWOOD_WALL_SIGN      = woodBlock("sandalwood_wall_sign", p -> new GotWallSignBlock(WoodTypes.SANDALWOOD, p, () -> ModBlockEntities.SANDALWOOD_SIGN.get()));
    public static final DeferredBlock<Block> SANDALWOOD_HANGING_SIGN      = woodBlock("sandalwood_hanging_sign",      p -> new CeilingHangingSignBlock(WoodTypes.SANDALWOOD, p));
    public static final DeferredBlock<Block> SANDALWOOD_WALL_HANGING_SIGN = woodBlock("sandalwood_wall_hanging_sign", p -> new WallHangingSignBlock(WoodTypes.SANDALWOOD, p));
    ...
    public static final DeferredBlock<Block> SANDALWOOD_SAPLING        = woodBlock("sandalwood_sapling",        p -> new GotSaplingBlock(TreeGrowers.SANDALWOOD, p));
    public static final DeferredBlock<Block> STRIPPED_SANDALWOOD_LOG   = logBlock("stripped_sandalwood_log",   StrippedLogBlock::new);
    public static final DeferredBlock<Block> STRIPPED_SANDALWOOD_WOOD  = logBlock("stripped_sandalwood_wood",  StrippedLogBlock::new);
    ...
    public static final DeferredBlock<Block> SANDBEGGAR_FENCE_GATE     = woodBlock("sandbeggar_fence_gate",     p -> new GotFenceGateBlock(WoodTypes.SANDBEGGAR, p));
    ...
    public static final DeferredBlock<Block> SANDBEGGAR_SIGN           = woodBlock("sandbeggar_sign",      p -> new GotStandingSignBlock(WoodTypes.SANDBEGGAR, p, () -> ModBlockEntities.SANDBEGGAR_SIGN.get()));
    public static final DeferredBlock<Block> SANDBEGGAR_WALL_SIGN      = woodBlock("sandbeggar_wall_sign", p -> new GotWallSignBlock(WoodTypes.SANDBEGGAR, p, () -> ModBlockEntities.SANDBEGGAR_SIGN.get()));
    public static final DeferredBlock<Block> SANDBEGGAR_HANGING_SIGN      = woodBlock("sandbeggar_hanging_sign",      p -> new CeilingHangingSignBlock(WoodTypes.SANDBEGGAR, p));
    public static final DeferredBlock<Block> SANDBEGGAR_WALL_HANGING_SIGN = woodBlock("sandbeggar_wall_hanging_sign", p -> new WallHangingSignBlock(WoodTypes.SANDBEGGAR, p));
    ...
    public static final DeferredBlock<Block> SANDBEGGAR_SAPLING        = woodBlock("sandbeggar_sapling",        p -> new GotSaplingBlock(TreeGrowers.SANDBEGGAR, p));
    public static final DeferredBlock<Block> STRIPPED_SANDBEGGAR_LOG   = logBlock("stripped_sandbeggar_log",   StrippedLogBlock::new);
    public static final DeferredBlock<Block> STRIPPED_SANDBEGGAR_WOOD  = logBlock("stripped_sandbeggar_wood",  StrippedLogBlock::new);
    ...
    public static final DeferredBlock<Block> APRICOT_FENCE_GATE     = woodBlock("apricot_fence_gate",     p -> new GotFenceGateBlock(WoodTypes.APRICOT, p));
    ...
    public static final DeferredBlock<Block> APRICOT_SIGN           = woodBlock("apricot_sign",      p -> new GotStandingSignBlock(WoodTypes.APRICOT, p, () -> ModBlockEntities.APRICOT_SIGN.get()));
    public static final DeferredBlock<Block> APRICOT_WALL_SIGN      = woodBlock("apricot_wall_sign", p -> new GotWallSignBlock(WoodTypes.APRICOT, p, () -> ModBlockEntities.APRICOT_SIGN.get()));
    public static final DeferredBlock<Block> APRICOT_HANGING_SIGN      = woodBlock("apricot_hanging_sign",      p -> new CeilingHangingSignBlock(WoodTypes.APRICOT, p));
    public static final DeferredBlock<Block> APRICOT_WALL_HANGING_SIGN = woodBlock("apricot_wall_hanging_sign", p -> new WallHangingSignBlock(WoodTypes.APRICOT, p));
    ...
    public static final DeferredBlock<Block> APRICOT_SAPLING        = woodBlock("apricot_sapling",        p -> new GotSaplingBlock(TreeGrowers.APRICOT, p));
    public static final DeferredBlock<Block> STRIPPED_APRICOT_LOG   = logBlock("stripped_apricot_log",   StrippedLogBlock::new);
    public static final DeferredBlock<Block> STRIPPED_APRICOT_WOOD  = logBlock("stripped_apricot_wood",  StrippedLogBlock::new);
    ...
    public static final DeferredBlock<Block> BLACKTHORN_FENCE_GATE     = woodBlock("blackthorn_fence_gate",     p -> new GotFenceGateBlock(WoodTypes.BLACKTHORN, p));
    ...
    public static final DeferredBlock<Block> BLACKTHORN_SIGN           = woodBlock("blackthorn_sign",      p -> new GotStandingSignBlock(WoodTypes.BLACKTHORN, p, () -> ModBlockEntities.BLACKTHORN_SIGN.get()));
    public static final DeferredBlock<Block> BLACKTHORN_WALL_SIGN      = woodBlock("blackthorn_wall_sign", p -> new GotWallSignBlock(WoodTypes.BLACKTHORN, p, () -> ModBlockEntities.BLACKTHORN_SIGN.get()));
    public static final DeferredBlock<Block> BLACKTHORN_HANGING_SIGN      = woodBlock("blackthorn_hanging_sign",      p -> new CeilingHangingSignBlock(WoodTypes.BLACKTHORN, p));
    public static final DeferredBlock<Block> BLACKTHORN_WALL_HANGING_SIGN = woodBlock("blackthorn_wall_hanging_sign", p -> new WallHangingSignBlock(WoodTypes.BLACKTHORN, p));
    ...
    public static final DeferredBlock<Block> BLACKTHORN_SAPLING        = woodBlock("blackthorn_sapling",        p -> new GotSaplingBlock(TreeGrowers.BLACKTHORN, p));
    public static final DeferredBlock<Block> STRIPPED_BLACKTHORN_LOG   = logBlock("stripped_blackthorn_log",   StrippedLogBlock::new);
    public static final DeferredBlock<Block> STRIPPED_BLACKTHORN_WOOD  = logBlock("stripped_blackthorn_wood",  StrippedLogBlock::new);
    ...
    public static final DeferredBlock<Block> RED_CHERRY_FENCE_GATE     = woodBlock("red_cherry_fence_gate",     p -> new GotFenceGateBlock(WoodTypes.RED_CHERRY, p));
    ...
    public static final DeferredBlock<Block> RED_CHERRY_SIGN           = woodBlock("red_cherry_sign",      p -> new GotStandingSignBlock(WoodTypes.RED_CHERRY, p, () -> ModBlockEntities.RED_CHERRY_SIGN.get()));
    public static final DeferredBlock<Block> RED_CHERRY_WALL_SIGN      = woodBlock("red_cherry_wall_sign", p -> new GotWallSignBlock(WoodTypes.RED_CHERRY, p, () -> ModBlockEntities.RED_CHERRY_SIGN.get()));
    public static final DeferredBlock<Block> RED_CHERRY_HANGING_SIGN      = woodBlock("red_cherry_hanging_sign",      p -> new CeilingHangingSignBlock(WoodTypes.RED_CHERRY, p));
    public static final DeferredBlock<Block> RED_CHERRY_WALL_HANGING_SIGN = woodBlock("red_cherry_wall_hanging_sign", p -> new WallHangingSignBlock(WoodTypes.RED_CHERRY, p));
    ...
    public static final DeferredBlock<Block> RED_CHERRY_SAPLING        = woodBlock("red_cherry_sapling",        p -> new GotSaplingBlock(TreeGrowers.RED_CHERRY, p));
    public static final DeferredBlock<Block> STRIPPED_RED_CHERRY_LOG   = logBlock("stripped_red_cherry_log",   StrippedLogBlock::new);
    public static final DeferredBlock<Block> STRIPPED_RED_CHERRY_WOOD  = logBlock("stripped_red_cherry_wood",  StrippedLogBlock::new);
    ...
    public static final DeferredBlock<Block> BLACK_CHERRY_FENCE_GATE     = woodBlock("black_cherry_fence_gate",     p -> new GotFenceGateBlock(WoodTypes.BLACK_CHERRY, p));
    ...
    public static final DeferredBlock<Block> BLACK_CHERRY_SIGN           = woodBlock("black_cherry_sign",      p -> new GotStandingSignBlock(WoodTypes.BLACK_CHERRY, p, () -> ModBlockEntities.BLACK_CHERRY_SIGN.get()));
    public static final DeferredBlock<Block> BLACK_CHERRY_WALL_SIGN      = woodBlock("black_cherry_wall_sign", p -> new GotWallSignBlock(WoodTypes.BLACK_CHERRY, p, () -> ModBlockEntities.BLACK_CHERRY_SIGN.get()));
    public static final DeferredBlock<Block> BLACK_CHERRY_HANGING_SIGN      = woodBlock("black_cherry_hanging_sign",      p -> new CeilingHangingSignBlock(WoodTypes.BLACK_CHERRY, p));
    public static final DeferredBlock<Block> BLACK_CHERRY_WALL_HANGING_SIGN = woodBlock("black_cherry_wall_hanging_sign", p -> new WallHangingSignBlock(WoodTypes.BLACK_CHERRY, p));
    ...
    public static final DeferredBlock<Block> BLACK_CHERRY_SAPLING        = woodBlock("black_cherry_sapling",        p -> new GotSaplingBlock(TreeGrowers.BLACK_CHERRY, p));
    public static final DeferredBlock<Block> STRIPPED_BLACK_CHERRY_LOG   = logBlock("stripped_black_cherry_log",   StrippedLogBlock::new);
    public static final DeferredBlock<Block> STRIPPED_BLACK_CHERRY_WOOD  = logBlock("stripped_black_cherry_wood",  StrippedLogBlock::new);
    ...
    public static final DeferredBlock<Block> WHITE_CHERRY_FENCE_GATE     = woodBlock("white_cherry_fence_gate",     p -> new GotFenceGateBlock(WoodTypes.WHITE_CHERRY, p));
    ...
    public static final DeferredBlock<Block> WHITE_CHERRY_SIGN           = woodBlock("white_cherry_sign",      p -> new GotStandingSignBlock(WoodTypes.WHITE_CHERRY, p, () -> ModBlockEntities.WHITE_CHERRY_SIGN.get()));
    public static final DeferredBlock<Block> WHITE_CHERRY_WALL_SIGN      = woodBlock("white_cherry_wall_sign", p -> new GotWallSignBlock(WoodTypes.WHITE_CHERRY, p, () -> ModBlockEntities.WHITE_CHERRY_SIGN.get()));
    public static final DeferredBlock<Block> WHITE_CHERRY_HANGING_SIGN      = woodBlock("white_cherry_hanging_sign",      p -> new CeilingHangingSignBlock(WoodTypes.WHITE_CHERRY, p));
    public static final DeferredBlock<Block> WHITE_CHERRY_WALL_HANGING_SIGN = woodBlock("white_cherry_wall_hanging_sign", p -> new WallHangingSignBlock(WoodTypes.WHITE_CHERRY, p));
    ...
    public static final DeferredBlock<Block> WHITE_CHERRY_SAPLING        = woodBlock("white_cherry_sapling",        p -> new GotSaplingBlock(TreeGrowers.WHITE_CHERRY, p));
    public static final DeferredBlock<Block> STRIPPED_WHITE_CHERRY_LOG   = logBlock("stripped_white_cherry_log",   StrippedLogBlock::new);
    public static final DeferredBlock<Block> STRIPPED_WHITE_CHERRY_WOOD  = logBlock("stripped_white_cherry_wood",  StrippedLogBlock::new);
    ...
    public static final DeferredBlock<Block> CRABAPPLE_FENCE_GATE     = woodBlock("crabapple_fence_gate",     p -> new GotFenceGateBlock(WoodTypes.CRABAPPLE, p));
    ...
    public static final DeferredBlock<Block> CRABAPPLE_SIGN           = woodBlock("crabapple_sign",      p -> new GotStandingSignBlock(WoodTypes.CRABAPPLE, p, () -> ModBlockEntities.CRABAPPLE_SIGN.get()));
    public static final DeferredBlock<Block> CRABAPPLE_WALL_SIGN      = woodBlock("crabapple_wall_sign", p -> new GotWallSignBlock(WoodTypes.CRABAPPLE, p, () -> ModBlockEntities.CRABAPPLE_SIGN.get()));
    public static final DeferredBlock<Block> CRABAPPLE_HANGING_SIGN      = woodBlock("crabapple_hanging_sign",      p -> new CeilingHangingSignBlock(WoodTypes.CRABAPPLE, p));
    public static final DeferredBlock<Block> CRABAPPLE_WALL_HANGING_SIGN = woodBlock("crabapple_wall_hanging_sign", p -> new WallHangingSignBlock(WoodTypes.CRABAPPLE, p));
    ...
    public static final DeferredBlock<Block> CRABAPPLE_SAPLING        = woodBlock("crabapple_sapling",        p -> new GotSaplingBlock(TreeGrowers.CRABAPPLE, p));
    public static final DeferredBlock<Block> STRIPPED_CRABAPPLE_LOG   = logBlock("stripped_crabapple_log",   StrippedLogBlock::new);
    public static final DeferredBlock<Block> STRIPPED_CRABAPPLE_WOOD  = logBlock("stripped_crabapple_wood",  StrippedLogBlock::new);
    ...
    public static final DeferredBlock<Block> DATE_PALM_FENCE_GATE     = woodBlock("date_palm_fence_gate",     p -> new GotFenceGateBlock(WoodTypes.DATE_PALM, p));
    ...
    public static final DeferredBlock<Block> DATE_PALM_SIGN           = woodBlock("date_palm_sign",      p -> new GotStandingSignBlock(WoodTypes.DATE_PALM, p, () -> ModBlockEntities.DATE_PALM_SIGN.get()));
    public static final DeferredBlock<Block> DATE_PALM_WALL_SIGN      = woodBlock("date_palm_wall_sign", p -> new GotWallSignBlock(WoodTypes.DATE_PALM, p, () -> ModBlockEntities.DATE_PALM_SIGN.get()));
    public static final DeferredBlock<Block> DATE_PALM_HANGING_SIGN      = woodBlock("date_palm_hanging_sign",      p -> new CeilingHangingSignBlock(WoodTypes.DATE_PALM, p));
    public static final DeferredBlock<Block> DATE_PALM_WALL_HANGING_SIGN = woodBlock("date_palm_wall_hanging_sign", p -> new WallHangingSignBlock(WoodTypes.DATE_PALM, p));
    ...
    public static final DeferredBlock<Block> DATE_PALM_SAPLING        = woodBlock("date_palm_sapling",        p -> new GotSaplingBlock(TreeGrowers.DATE_PALM, p));
    public static final DeferredBlock<Block> STRIPPED_DATE_PALM_LOG   = logBlock("stripped_date_palm_log",   StrippedLogBlock::new);
    public static final DeferredBlock<Block> STRIPPED_DATE_PALM_WOOD  = logBlock("stripped_date_palm_wood",  StrippedLogBlock::new);
    ...
    public static final DeferredBlock<Block> FIG_FENCE_GATE     = woodBlock("fig_fence_gate",     p -> new GotFenceGateBlock(WoodTypes.FIG, p));
    ...
    public static final DeferredBlock<Block> FIG_SIGN           = woodBlock("fig_sign",      p -> new GotStandingSignBlock(WoodTypes.FIG, p, () -> ModBlockEntities.FIG_SIGN.get()));
    public static final DeferredBlock<Block> FIG_WALL_SIGN      = woodBlock("fig_wall_sign", p -> new GotWallSignBlock(WoodTypes.FIG, p, () -> ModBlockEntities.FIG_SIGN.get()));
    public static final DeferredBlock<Block> FIG_HANGING_SIGN      = woodBlock("fig_hanging_sign",      p -> new CeilingHangingSignBlock(WoodTypes.FIG, p));
    public static final DeferredBlock<Block> FIG_WALL_HANGING_SIGN = woodBlock("fig_wall_hanging_sign", p -> new WallHangingSignBlock(WoodTypes.FIG, p));
    ...
    public static final DeferredBlock<Block> FIG_SAPLING        = woodBlock("fig_sapling",        p -> new GotSaplingBlock(TreeGrowers.FIG, p));
    public static final DeferredBlock<Block> STRIPPED_FIG_LOG   = logBlock("stripped_fig_log",   StrippedLogBlock::new);
    public static final DeferredBlock<Block> STRIPPED_FIG_WOOD  = logBlock("stripped_fig_wood",  StrippedLogBlock::new);
    ...
    public static final DeferredBlock<Block> LEMON_FENCE_GATE     = woodBlock("lemon_fence_gate",     p -> new GotFenceGateBlock(WoodTypes.LEMON, p));
    ...
    public static final DeferredBlock<Block> LEMON_SIGN           = woodBlock("lemon_sign",      p -> new GotStandingSignBlock(WoodTypes.LEMON, p, () -> ModBlockEntities.LEMON_SIGN.get()));
    public static final DeferredBlock<Block> LEMON_WALL_SIGN      = woodBlock("lemon_wall_sign", p -> new GotWallSignBlock(WoodTypes.LEMON, p, () -> ModBlockEntities.LEMON_SIGN.get()));
    public static final DeferredBlock<Block> LEMON_HANGING_SIGN      = woodBlock("lemon_hanging_sign",      p -> new CeilingHangingSignBlock(WoodTypes.LEMON, p));
    public static final DeferredBlock<Block> LEMON_WALL_HANGING_SIGN = woodBlock("lemon_wall_hanging_sign", p -> new WallHangingSignBlock(WoodTypes.LEMON, p));
    ...
    public static final DeferredBlock<Block> LEMON_SAPLING        = woodBlock("lemon_sapling",        p -> new GotSaplingBlock(TreeGrowers.LEMON, p));
    public static final DeferredBlock<Block> STRIPPED_LEMON_LOG   = logBlock("stripped_lemon_log",   StrippedLogBlock::new);
    public static final DeferredBlock<Block> STRIPPED_LEMON_WOOD  = logBlock("stripped_lemon_wood",  StrippedLogBlock::new);
    ...
    public static final DeferredBlock<Block> LIME_FENCE_GATE     = woodBlock("lime_fence_gate",     p -> new GotFenceGateBlock(WoodTypes.LIME, p));
    ...
    public static final DeferredBlock<Block> LIME_SIGN           = woodBlock("lime_sign",      p -> new GotStandingSignBlock(WoodTypes.LIME, p, () -> ModBlockEntities.LIME_SIGN.get()));
    public static final DeferredBlock<Block> LIME_WALL_SIGN      = woodBlock("lime_wall_sign", p -> new GotWallSignBlock(WoodTypes.LIME, p, () -> ModBlockEntities.LIME_SIGN.get()));
    public static final DeferredBlock<Block> LIME_HANGING_SIGN      = woodBlock("lime_hanging_sign",      p -> new CeilingHangingSignBlock(WoodTypes.LIME, p));
    public static final DeferredBlock<Block> LIME_WALL_HANGING_SIGN = woodBlock("lime_wall_hanging_sign", p -> new WallHangingSignBlock(WoodTypes.LIME, p));
    ...
    public static final DeferredBlock<Block> LIME_SAPLING        = woodBlock("lime_sapling",        p -> new GotSaplingBlock(TreeGrowers.LIME, p));
    public static final DeferredBlock<Block> STRIPPED_LIME_LOG   = logBlock("stripped_lime_log",   StrippedLogBlock::new);
    public static final DeferredBlock<Block> STRIPPED_LIME_WOOD  = logBlock("stripped_lime_wood",  StrippedLogBlock::new);
    ...
    public static final DeferredBlock<Block> OLIVE_FENCE_GATE     = woodBlock("olive_fence_gate",     p -> new GotFenceGateBlock(WoodTypes.OLIVE, p));
    ...
    public static final DeferredBlock<Block> OLIVE_SIGN           = woodBlock("olive_sign",      p -> new GotStandingSignBlock(WoodTypes.OLIVE, p, () -> ModBlockEntities.OLIVE_SIGN.get()));
    public static final DeferredBlock<Block> OLIVE_WALL_SIGN      = woodBlock("olive_wall_sign", p -> new GotWallSignBlock(WoodTypes.OLIVE, p, () -> ModBlockEntities.OLIVE_SIGN.get()));
    public static final DeferredBlock<Block> OLIVE_HANGING_SIGN      = woodBlock("olive_hanging_sign",      p -> new CeilingHangingSignBlock(WoodTypes.OLIVE, p));
    public static final DeferredBlock<Block> OLIVE_WALL_HANGING_SIGN = woodBlock("olive_wall_hanging_sign", p -> new WallHangingSignBlock(WoodTypes.OLIVE, p));
    ...
    public static final DeferredBlock<Block> OLIVE_SAPLING        = woodBlock("olive_sapling",        p -> new GotSaplingBlock(TreeGrowers.OLIVE, p));
    public static final DeferredBlock<Block> STRIPPED_OLIVE_LOG   = logBlock("stripped_olive_log",   StrippedLogBlock::new);
    public static final DeferredBlock<Block> STRIPPED_OLIVE_WOOD  = logBlock("stripped_olive_wood",  StrippedLogBlock::new);
    ...
    public static final DeferredBlock<Block> ORANGE_FENCE_GATE     = woodBlock("orange_fence_gate",     p -> new GotFenceGateBlock(WoodTypes.ORANGE, p));
    ...
    public static final DeferredBlock<Block> ORANGE_SIGN           = woodBlock("orange_sign",      p -> new GotStandingSignBlock(WoodTypes.ORANGE, p, () -> ModBlockEntities.ORANGE_SIGN.get()));
    public static final DeferredBlock<Block> ORANGE_WALL_SIGN      = woodBlock("orange_wall_sign", p -> new GotWallSignBlock(WoodTypes.ORANGE, p, () -> ModBlockEntities.ORANGE_SIGN.get()));
    public static final DeferredBlock<Block> ORANGE_HANGING_SIGN      = woodBlock("orange_hanging_sign",      p -> new CeilingHangingSignBlock(WoodTypes.ORANGE, p));
    public static final DeferredBlock<Block> ORANGE_WALL_HANGING_SIGN = woodBlock("orange_wall_hanging_sign", p -> new WallHangingSignBlock(WoodTypes.ORANGE, p));
    ...
    public static final DeferredBlock<Block> ORANGE_SAPLING        = woodBlock("orange_sapling",        p -> new GotSaplingBlock(TreeGrowers.ORANGE, p));
    public static final DeferredBlock<Block> STRIPPED_ORANGE_LOG   = logBlock("stripped_orange_log",   StrippedLogBlock::new);
    public static final DeferredBlock<Block> STRIPPED_ORANGE_WOOD  = logBlock("stripped_orange_wood",  StrippedLogBlock::new);
    ...
    public static final DeferredBlock<Block> PEACH_FENCE_GATE     = woodBlock("peach_fence_gate",     p -> new GotFenceGateBlock(WoodTypes.PEACH, p));
    ...
    public static final DeferredBlock<Block> PEACH_SIGN           = woodBlock("peach_sign",      p -> new GotStandingSignBlock(WoodTypes.PEACH, p, () -> ModBlockEntities.PEACH_SIGN.get()));
    public static final DeferredBlock<Block> PEACH_WALL_SIGN      = woodBlock("peach_wall_sign", p -> new GotWallSignBlock(WoodTypes.PEACH, p, () -> ModBlockEntities.PEACH_SIGN.get()));
    public static final DeferredBlock<Block> PEACH_HANGING_SIGN      = woodBlock("peach_hanging_sign",      p -> new CeilingHangingSignBlock(WoodTypes.PEACH, p));
    public static final DeferredBlock<Block> PEACH_WALL_HANGING_SIGN = woodBlock("peach_wall_hanging_sign", p -> new WallHangingSignBlock(WoodTypes.PEACH, p));
    ...
    public static final DeferredBlock<Block> PEACH_SAPLING        = woodBlock("peach_sapling",        p -> new GotSaplingBlock(TreeGrowers.PEACH, p));
    public static final DeferredBlock<Block> STRIPPED_PEACH_LOG   = logBlock("stripped_peach_log",   StrippedLogBlock::new);
    public static final DeferredBlock<Block> STRIPPED_PEACH_WOOD  = logBlock("stripped_peach_wood",  StrippedLogBlock::new);
    ...
    public static final DeferredBlock<Block> PEAR_FENCE_GATE     = woodBlock("pear_fence_gate",     p -> new GotFenceGateBlock(WoodTypes.PEAR, p));
    ...
    public static final DeferredBlock<Block> PEAR_SIGN           = woodBlock("pear_sign",      p -> new GotStandingSignBlock(WoodTypes.PEAR, p, () -> ModBlockEntities.PEAR_SIGN.get()));
    public static final DeferredBlock<Block> PEAR_WALL_SIGN      = woodBlock("pear_wall_sign", p -> new GotWallSignBlock(WoodTypes.PEAR, p, () -> ModBlockEntities.PEAR_SIGN.get()));
    public static final DeferredBlock<Block> PEAR_HANGING_SIGN      = woodBlock("pear_hanging_sign",      p -> new CeilingHangingSignBlock(WoodTypes.PEAR, p));
    public static final DeferredBlock<Block> PEAR_WALL_HANGING_SIGN = woodBlock("pear_wall_hanging_sign", p -> new WallHangingSignBlock(WoodTypes.PEAR, p));
    ...
    public static final DeferredBlock<Block> PEAR_SAPLING        = woodBlock("pear_sapling",        p -> new GotSaplingBlock(TreeGrowers.PEAR, p));
    public static final DeferredBlock<Block> STRIPPED_PEAR_LOG   = logBlock("stripped_pear_log",   StrippedLogBlock::new);
    public static final DeferredBlock<Block> STRIPPED_PEAR_WOOD  = logBlock("stripped_pear_wood",  StrippedLogBlock::new);
    ...
    public static final DeferredBlock<Block> PERSIMMON_FENCE_GATE     = woodBlock("persimmon_fence_gate",     p -> new GotFenceGateBlock(WoodTypes.PERSIMMON, p));
    ...
    public static final DeferredBlock<Block> PERSIMMON_SIGN           = woodBlock("persimmon_sign",      p -> new GotStandingSignBlock(WoodTypes.PERSIMMON, p, () -> ModBlockEntities.PERSIMMON_SIGN.get()));
    public static final DeferredBlock<Block> PERSIMMON_WALL_SIGN      = woodBlock("persimmon_wall_sign", p -> new GotWallSignBlock(WoodTypes.PERSIMMON, p, () -> ModBlockEntities.PERSIMMON_SIGN.get()));
    public static final DeferredBlock<Block> PERSIMMON_HANGING_SIGN      = woodBlock("persimmon_hanging_sign",      p -> new CeilingHangingSignBlock(WoodTypes.PERSIMMON, p));
    public static final DeferredBlock<Block> PERSIMMON_WALL_HANGING_SIGN = woodBlock("persimmon_wall_hanging_sign", p -> new WallHangingSignBlock(WoodTypes.PERSIMMON, p));
    ...
    public static final DeferredBlock<Block> PERSIMMON_SAPLING        = woodBlock("persimmon_sapling",        p -> new GotSaplingBlock(TreeGrowers.PERSIMMON, p));
    public static final DeferredBlock<Block> STRIPPED_PERSIMMON_LOG   = logBlock("stripped_persimmon_log",   StrippedLogBlock::new);
    public static final DeferredBlock<Block> STRIPPED_PERSIMMON_WOOD  = logBlock("stripped_persimmon_wood",  StrippedLogBlock::new);
    ...
    public static final DeferredBlock<Block> PINK_IVORY_FENCE_GATE     = woodBlock("pink_ivory_fence_gate",     p -> new GotFenceGateBlock(WoodTypes.PINK_IVORY, p));
    ...
    public static final DeferredBlock<Block> PINK_IVORY_SIGN           = woodBlock("pink_ivory_sign",      p -> new GotStandingSignBlock(WoodTypes.PINK_IVORY, p, () -> ModBlockEntities.PINK_IVORY_SIGN.get()));
    public static final DeferredBlock<Block> PINK_IVORY_WALL_SIGN      = woodBlock("pink_ivory_wall_sign", p -> new GotWallSignBlock(WoodTypes.PINK_IVORY, p, () -> ModBlockEntities.PINK_IVORY_SIGN.get()));
    public static final DeferredBlock<Block> PINK_IVORY_HANGING_SIGN      = woodBlock("pink_ivory_hanging_sign",      p -> new CeilingHangingSignBlock(WoodTypes.PINK_IVORY, p));
    public static final DeferredBlock<Block> PINK_IVORY_WALL_HANGING_SIGN = woodBlock("pink_ivory_wall_hanging_sign", p -> new WallHangingSignBlock(WoodTypes.PINK_IVORY, p));
    ...
    public static final DeferredBlock<Block> PINK_IVORY_SAPLING        = woodBlock("pink_ivory_sapling",        p -> new GotSaplingBlock(TreeGrowers.PINK_IVORY, p));
    public static final DeferredBlock<Block> STRIPPED_PINK_IVORY_LOG   = logBlock("stripped_pink_ivory_log",   StrippedLogBlock::new);
    public static final DeferredBlock<Block> STRIPPED_PINK_IVORY_WOOD  = logBlock("stripped_pink_ivory_wood",  StrippedLogBlock::new);
    ...
    public static final DeferredBlock<Block> PLUM_FENCE_GATE     = woodBlock("plum_fence_gate",     p -> new GotFenceGateBlock(WoodTypes.PLUM, p));
    ...
    public static final DeferredBlock<Block> PLUM_SIGN           = woodBlock("plum_sign",      p -> new GotStandingSignBlock(WoodTypes.PLUM, p, () -> ModBlockEntities.PLUM_SIGN.get()));
    public static final DeferredBlock<Block> PLUM_WALL_SIGN      = woodBlock("plum_wall_sign", p -> new GotWallSignBlock(WoodTypes.PLUM, p, () -> ModBlockEntities.PLUM_SIGN.get()));
    public static final DeferredBlock<Block> PLUM_HANGING_SIGN      = woodBlock("plum_hanging_sign",      p -> new CeilingHangingSignBlock(WoodTypes.PLUM, p));
    public static final DeferredBlock<Block> PLUM_WALL_HANGING_SIGN = woodBlock("plum_wall_hanging_sign", p -> new WallHangingSignBlock(WoodTypes.PLUM, p));
    ...
    public static final DeferredBlock<Block> PLUM_SAPLING        = woodBlock("plum_sapling",        p -> new GotSaplingBlock(TreeGrowers.PLUM, p));
    public static final DeferredBlock<Block> STRIPPED_PLUM_LOG   = logBlock("stripped_plum_log",   StrippedLogBlock::new);
    public static final DeferredBlock<Block> STRIPPED_PLUM_WOOD  = logBlock("stripped_plum_wood",  StrippedLogBlock::new);
    ...
    public static final DeferredBlock<Block> POMEGRANATE_FENCE_GATE     = woodBlock("pomegranate_fence_gate",     p -> new GotFenceGateBlock(WoodTypes.POMEGRANATE, p));
    ...
    public static final DeferredBlock<Block> POMEGRANATE_SIGN           = woodBlock("pomegranate_sign",      p -> new GotStandingSignBlock(WoodTypes.POMEGRANATE, p, () -> ModBlockEntities.POMEGRANATE_SIGN.get()));
    public static final DeferredBlock<Block> POMEGRANATE_WALL_SIGN      = woodBlock("pomegranate_wall_sign", p -> new GotWallSignBlock(WoodTypes.POMEGRANATE, p, () -> ModBlockEntities.POMEGRANATE_SIGN.get()));
    public static final DeferredBlock<Block> POMEGRANATE_HANGING_SIGN      = woodBlock("pomegranate_hanging_sign",      p -> new CeilingHangingSignBlock(WoodTypes.POMEGRANATE, p));
    public static final DeferredBlock<Block> POMEGRANATE_WALL_HANGING_SIGN = woodBlock("pomegranate_wall_hanging_sign", p -> new WallHangingSignBlock(WoodTypes.POMEGRANATE, p));
    ...
    public static final DeferredBlock<Block> POMEGRANATE_SAPLING        = woodBlock("pomegranate_sapling",        p -> new GotSaplingBlock(TreeGrowers.POMEGRANATE, p));
    public static final DeferredBlock<Block> STRIPPED_POMEGRANATE_LOG   = logBlock("stripped_pomegranate_log",   StrippedLogBlock::new);
    public static final DeferredBlock<Block> STRIPPED_POMEGRANATE_WOOD  = logBlock("stripped_pomegranate_wood",  StrippedLogBlock::new);
    ...
    public static final DeferredBlock<Block> PRUNE_FENCE_GATE     = woodBlock("prune_fence_gate",     p -> new GotFenceGateBlock(WoodTypes.PRUNE, p));
    ...
    public static final DeferredBlock<Block> PRUNE_SIGN           = woodBlock("prune_sign",      p -> new GotStandingSignBlock(WoodTypes.PRUNE, p, () -> ModBlockEntities.PRUNE_SIGN.get()));
    public static final DeferredBlock<Block> PRUNE_WALL_SIGN      = woodBlock("prune_wall_sign", p -> new GotWallSignBlock(WoodTypes.PRUNE, p, () -> ModBlockEntities.PRUNE_SIGN.get()));
    public static final DeferredBlock<Block> PRUNE_HANGING_SIGN      = woodBlock("prune_hanging_sign",      p -> new CeilingHangingSignBlock(WoodTypes.PRUNE, p));
    public static final DeferredBlock<Block> PRUNE_WALL_HANGING_SIGN = woodBlock("prune_wall_hanging_sign", p -> new WallHangingSignBlock(WoodTypes.PRUNE, p));
    ...
    public static final DeferredBlock<Block> PRUNE_SAPLING        = woodBlock("prune_sapling",        p -> new GotSaplingBlock(TreeGrowers.PRUNE, p));
    public static final DeferredBlock<Block> STRIPPED_PRUNE_LOG   = logBlock("stripped_prune_log",   StrippedLogBlock::new);
    public static final DeferredBlock<Block> STRIPPED_PRUNE_WOOD  = logBlock("stripped_prune_wood",  StrippedLogBlock::new);
    ...
    public static final DeferredBlock<Block> ALMOND_FENCE_GATE     = woodBlock("almond_fence_gate",     p -> new GotFenceGateBlock(WoodTypes.ALMOND, p));
    ...
    public static final DeferredBlock<Block> ALMOND_SIGN           = woodBlock("almond_sign",      p -> new GotStandingSignBlock(WoodTypes.ALMOND, p, () -> ModBlockEntities.ALMOND_SIGN.get()));
    public static final DeferredBlock<Block> ALMOND_WALL_SIGN      = woodBlock("almond_wall_sign", p -> new GotWallSignBlock(WoodTypes.ALMOND, p, () -> ModBlockEntities.ALMOND_SIGN.get()));
    public static final DeferredBlock<Block> ALMOND_HANGING_SIGN      = woodBlock("almond_hanging_sign",      p -> new CeilingHangingSignBlock(WoodTypes.ALMOND, p));
    public static final DeferredBlock<Block> ALMOND_WALL_HANGING_SIGN = woodBlock("almond_wall_hanging_sign", p -> new WallHangingSignBlock(WoodTypes.ALMOND, p));
    ...
    public static final DeferredBlock<Block> ALMOND_SAPLING        = woodBlock("almond_sapling",        p -> new GotSaplingBlock(TreeGrowers.ALMOND, p));
    public static final DeferredBlock<Block> STRIPPED_ALMOND_LOG   = logBlock("stripped_almond_log",   StrippedLogBlock::new);
    public static final DeferredBlock<Block> STRIPPED_ALMOND_WOOD  = logBlock("stripped_almond_wood",  StrippedLogBlock::new);
    ...
    public static final DeferredBlock<Block> NUTMEG_FENCE_GATE     = woodBlock("nutmeg_fence_gate",     p -> new GotFenceGateBlock(WoodTypes.NUTMEG, p));
    ...
    public static final DeferredBlock<Block> NUTMEG_SIGN           = woodBlock("nutmeg_sign",      p -> new GotStandingSignBlock(WoodTypes.NUTMEG, p, () -> ModBlockEntities.NUTMEG_SIGN.get()));
    public static final DeferredBlock<Block> NUTMEG_WALL_SIGN      = woodBlock("nutmeg_wall_sign", p -> new GotWallSignBlock(WoodTypes.NUTMEG, p, () -> ModBlockEntities.NUTMEG_SIGN.get()));
    public static final DeferredBlock<Block> NUTMEG_HANGING_SIGN      = woodBlock("nutmeg_hanging_sign",      p -> new CeilingHangingSignBlock(WoodTypes.NUTMEG, p));
    public static final DeferredBlock<Block> NUTMEG_WALL_HANGING_SIGN = woodBlock("nutmeg_wall_hanging_sign", p -> new WallHangingSignBlock(WoodTypes.NUTMEG, p));
    ...
    public static final DeferredBlock<Block> NUTMEG_SAPLING        = woodBlock("nutmeg_sapling",        p -> new GotSaplingBlock(TreeGrowers.NUTMEG, p));
    public static final DeferredBlock<Block> STRIPPED_NUTMEG_LOG   = logBlock("stripped_nutmeg_log",   StrippedLogBlock::new);
    public static final DeferredBlock<Block> STRIPPED_NUTMEG_WOOD  = logBlock("stripped_nutmeg_wood",  StrippedLogBlock::new);
    ...
    public static final DeferredBlock<Block> HEMLOCK_FENCE_GATE     = woodBlock("hemlock_fence_gate",     p -> new GotFenceGateBlock(WoodTypes.HEMLOCK, p));
    ...
    public static final DeferredBlock<Block> HEMLOCK_SIGN           = woodBlock("hemlock_sign",      p -> new GotStandingSignBlock(WoodTypes.HEMLOCK, p, () -> ModBlockEntities.HEMLOCK_SIGN.get()));
    public static final DeferredBlock<Block> HEMLOCK_WALL_SIGN      = woodBlock("hemlock_wall_sign", p -> new GotWallSignBlock(WoodTypes.HEMLOCK, p, () -> ModBlockEntities.HEMLOCK_SIGN.get()));
    public static final DeferredBlock<Block> HEMLOCK_HANGING_SIGN      = woodBlock("hemlock_hanging_sign",      p -> new CeilingHangingSignBlock(WoodTypes.HEMLOCK, p));
    public static final DeferredBlock<Block> HEMLOCK_WALL_HANGING_SIGN = woodBlock("hemlock_wall_hanging_sign", p -> new WallHangingSignBlock(WoodTypes.HEMLOCK, p));
    ...
    public static final DeferredBlock<Block> HEMLOCK_SAPLING        = woodBlock("hemlock_sapling",        p -> new GotSaplingBlock(TreeGrowers.HEMLOCK, p));
    public static final DeferredBlock<Block> STRIPPED_HEMLOCK_LOG   = logBlock("stripped_hemlock_log",   StrippedLogBlock::new);
    public static final DeferredBlock<Block> STRIPPED_HEMLOCK_WOOD  = logBlock("stripped_hemlock_wood",  StrippedLogBlock::new);
    ...
    public static final DeferredBlock<Block> ACACIA_ROOFING_VERTICAL_SLAB = verticalSlab("acacia_roofing_vertical_slab", ModBlocks.ACACIA_ROOFING_SLAB);
    public static final DeferredBlock<Block> ACACIA_WOOD_VERTICAL_SLAB = verticalSlab("acacia_wood_vertical_slab", ModBlocks.ACACIA_WOOD_SLAB);
    public static final DeferredBlock<Block> ALDER_ROOFING_VERTICAL_SLAB = verticalSlab("alder_roofing_vertical_slab", ModBlocks.ALDER_ROOFING_SLAB);
    public static final DeferredBlock<Block> ALDER_VERTICAL_SLAB = verticalSlab("alder_vertical_slab", ModBlocks.ALDER_SLAB);
    public static final DeferredBlock<Block> ALDER_WOOD_VERTICAL_SLAB = verticalSlab("alder_wood_vertical_slab", ModBlocks.ALDER_WOOD_SLAB);
    public static final DeferredBlock<Block> ALMOND_ROOFING_VERTICAL_SLAB = verticalSlab("almond_roofing_vertical_slab", ModBlocks.ALMOND_ROOFING_SLAB);
    public static final DeferredBlock<Block> ALMOND_VERTICAL_SLAB = verticalSlab("almond_vertical_slab", ModBlocks.ALMOND_SLAB);
    public static final DeferredBlock<Block> ALMOND_WOOD_VERTICAL_SLAB = verticalSlab("almond_wood_vertical_slab", ModBlocks.ALMOND_WOOD_SLAB);
    public static final DeferredBlock<Block> APPLE_ROOFING_VERTICAL_SLAB = verticalSlab("apple_roofing_vertical_slab", ModBlocks.APPLE_ROOFING_SLAB);
    public static final DeferredBlock<Block> APPLE_VERTICAL_SLAB = verticalSlab("apple_vertical_slab", ModBlocks.APPLE_SLAB);
    public static final DeferredBlock<Block> APPLE_WOOD_VERTICAL_SLAB = verticalSlab("apple_wood_vertical_slab", ModBlocks.APPLE_WOOD_SLAB);
    public static final DeferredBlock<Block> APRICOT_ROOFING_VERTICAL_SLAB = verticalSlab("apricot_roofing_vertical_slab", ModBlocks.APRICOT_ROOFING_SLAB);
    public static final DeferredBlock<Block> APRICOT_VERTICAL_SLAB = verticalSlab("apricot_vertical_slab", ModBlocks.APRICOT_SLAB);
    public static final DeferredBlock<Block> APRICOT_WOOD_VERTICAL_SLAB = verticalSlab("apricot_wood_vertical_slab", ModBlocks.APRICOT_WOOD_SLAB);
    public static final DeferredBlock<Block> ASH_ROOFING_VERTICAL_SLAB = verticalSlab("ash_roofing_vertical_slab", ModBlocks.ASH_ROOFING_SLAB);
    public static final DeferredBlock<Block> ASH_VERTICAL_SLAB = verticalSlab("ash_vertical_slab", ModBlocks.ASH_SLAB);
    public static final DeferredBlock<Block> ASH_WOOD_VERTICAL_SLAB = verticalSlab("ash_wood_vertical_slab", ModBlocks.ASH_WOOD_SLAB);
    public static final DeferredBlock<Block> ASPEN_ROOFING_VERTICAL_SLAB = verticalSlab("aspen_roofing_vertical_slab", ModBlocks.ASPEN_ROOFING_SLAB);
    public static final DeferredBlock<Block> ASPEN_VERTICAL_SLAB = verticalSlab("aspen_vertical_slab", ModBlocks.ASPEN_SLAB);
    public static final DeferredBlock<Block> ASPEN_WOOD_VERTICAL_SLAB = verticalSlab("aspen_wood_vertical_slab", ModBlocks.ASPEN_WOOD_SLAB);
    public static final DeferredBlock<Block> BAMBOO_ROOFING_VERTICAL_SLAB = verticalSlab("bamboo_roofing_vertical_slab", ModBlocks.BAMBOO_ROOFING_SLAB);
    public static final DeferredBlock<Block> BASALT_BRICK_VERTICAL_SLAB = verticalSlab("basalt_brick_vertical_slab", ModBlocks.BASALT_BRICK_SLAB);
    public static final DeferredBlock<Block> BASALT_COBBLESTONE_VERTICAL_SLAB = verticalSlab("basalt_cobblestone_vertical_slab", ModBlocks.BASALT_COBBLESTONE_SLAB);
    public static final DeferredBlock<Block> BASALT_ROCK_VERTICAL_SLAB = verticalSlab("basalt_rock_vertical_slab", ModBlocks.BASALT_ROCK_SLAB);
    public static final DeferredBlock<Block> BEECH_ROOFING_VERTICAL_SLAB = verticalSlab("beech_roofing_vertical_slab", ModBlocks.BEECH_ROOFING_SLAB);
    public static final DeferredBlock<Block> BEECH_VERTICAL_SLAB = verticalSlab("beech_vertical_slab", ModBlocks.BEECH_SLAB);
    public static final DeferredBlock<Block> BEECH_WOOD_VERTICAL_SLAB = verticalSlab("beech_wood_vertical_slab", ModBlocks.BEECH_WOOD_SLAB);
    public static final DeferredBlock<Block> BIRCH_ROOFING_VERTICAL_SLAB = verticalSlab("birch_roofing_vertical_slab", ModBlocks.BIRCH_ROOFING_SLAB);
    public static final DeferredBlock<Block> BIRCH_WOOD_VERTICAL_SLAB = verticalSlab("birch_wood_vertical_slab", ModBlocks.BIRCH_WOOD_SLAB);
    public static final DeferredBlock<Block> BLACK_CHERRY_ROOFING_VERTICAL_SLAB = verticalSlab("black_cherry_roofing_vertical_slab", ModBlocks.BLACK_CHERRY_ROOFING_SLAB);
    public static final DeferredBlock<Block> BLACK_CHERRY_VERTICAL_SLAB = verticalSlab("black_cherry_vertical_slab", ModBlocks.BLACK_CHERRY_SLAB);
    public static final DeferredBlock<Block> BLACK_CHERRY_WOOD_VERTICAL_SLAB = verticalSlab("black_cherry_wood_vertical_slab", ModBlocks.BLACK_CHERRY_WOOD_SLAB);
    public static final DeferredBlock<Block> BLACK_COTTONWOOD_ROOFING_VERTICAL_SLAB = verticalSlab("black_cottonwood_roofing_vertical_slab", ModBlocks.BLACK_COTTONWOOD_ROOFING_SLAB);
    public static final DeferredBlock<Block> BLACK_COTTONWOOD_VERTICAL_SLAB = verticalSlab("black_cottonwood_vertical_slab", ModBlocks.BLACK_COTTONWOOD_SLAB);
    public static final DeferredBlock<Block> BLACK_COTTONWOOD_WOOD_VERTICAL_SLAB = verticalSlab("black_cottonwood_wood_vertical_slab", ModBlocks.BLACK_COTTONWOOD_WOOD_SLAB);
    public static final DeferredBlock<Block> BLACK_WOOL_VERTICAL_SLAB = verticalSlab("black_wool_vertical_slab", ModBlocks.BLACK_WOOL_SLAB);
    public static final DeferredBlock<Block> BLACKBARK_ROOFING_VERTICAL_SLAB = verticalSlab("blackbark_roofing_vertical_slab", ModBlocks.BLACKBARK_ROOFING_SLAB);
    public static final DeferredBlock<Block> BLACKBARK_VERTICAL_SLAB = verticalSlab("blackbark_vertical_slab", ModBlocks.BLACKBARK_SLAB);
    public static final DeferredBlock<Block> BLACKBARK_WOOD_VERTICAL_SLAB = verticalSlab("blackbark_wood_vertical_slab", ModBlocks.BLACKBARK_WOOD_SLAB);
    public static final DeferredBlock<Block> BLACKTHORN_ROOFING_VERTICAL_SLAB = verticalSlab("blackthorn_roofing_vertical_slab", ModBlocks.BLACKTHORN_ROOFING_SLAB);
    public static final DeferredBlock<Block> BLACKTHORN_VERTICAL_SLAB = verticalSlab("blackthorn_vertical_slab", ModBlocks.BLACKTHORN_SLAB);
    public static final DeferredBlock<Block> BLACKTHORN_WOOD_VERTICAL_SLAB = verticalSlab("blackthorn_wood_vertical_slab", ModBlocks.BLACKTHORN_WOOD_SLAB);
    public static final DeferredBlock<Block> BLOODWOOD_ROOFING_VERTICAL_SLAB = verticalSlab("bloodwood_roofing_vertical_slab", ModBlocks.BLOODWOOD_ROOFING_SLAB);
    public static final DeferredBlock<Block> BLOODWOOD_VERTICAL_SLAB = verticalSlab("bloodwood_vertical_slab", ModBlocks.BLOODWOOD_SLAB);
    public static final DeferredBlock<Block> BLOODWOOD_WOOD_VERTICAL_SLAB = verticalSlab("bloodwood_wood_vertical_slab", ModBlocks.BLOODWOOD_WOOD_SLAB);
    public static final DeferredBlock<Block> BLUE_MAHOE_ROOFING_VERTICAL_SLAB = verticalSlab("blue_mahoe_roofing_vertical_slab", ModBlocks.BLUE_MAHOE_ROOFING_SLAB);
    public static final DeferredBlock<Block> BLUE_MAHOE_VERTICAL_SLAB = verticalSlab("blue_mahoe_vertical_slab", ModBlocks.BLUE_MAHOE_SLAB);
    public static final DeferredBlock<Block> BLUE_MAHOE_WOOD_VERTICAL_SLAB = verticalSlab("blue_mahoe_wood_vertical_slab", ModBlocks.BLUE_MAHOE_WOOD_SLAB);
    public static final DeferredBlock<Block> BLUE_WOOL_VERTICAL_SLAB = verticalSlab("blue_wool_vertical_slab", ModBlocks.BLUE_WOOL_SLAB);
    public static final DeferredBlock<Block> BROWN_WOOL_VERTICAL_SLAB = verticalSlab("brown_wool_vertical_slab", ModBlocks.BROWN_WOOL_SLAB);
    public static final DeferredBlock<Block> CEDAR_ROOFING_VERTICAL_SLAB = verticalSlab("cedar_roofing_vertical_slab", ModBlocks.CEDAR_ROOFING_SLAB);
    public static final DeferredBlock<Block> CEDAR_VERTICAL_SLAB = verticalSlab("cedar_vertical_slab", ModBlocks.CEDAR_SLAB);
    public static final DeferredBlock<Block> CEDAR_WOOD_VERTICAL_SLAB = verticalSlab("cedar_wood_vertical_slab", ModBlocks.CEDAR_WOOD_SLAB);
    public static final DeferredBlock<Block> CHERRY_ROOFING_VERTICAL_SLAB = verticalSlab("cherry_roofing_vertical_slab", ModBlocks.CHERRY_ROOFING_SLAB);
    public static final DeferredBlock<Block> CHERRY_WOOD_VERTICAL_SLAB = verticalSlab("cherry_wood_vertical_slab", ModBlocks.CHERRY_WOOD_SLAB);
    public static final DeferredBlock<Block> CHESTNUT_ROOFING_VERTICAL_SLAB = verticalSlab("chestnut_roofing_vertical_slab", ModBlocks.CHESTNUT_ROOFING_SLAB);
    public static final DeferredBlock<Block> CHESTNUT_VERTICAL_SLAB = verticalSlab("chestnut_vertical_slab", ModBlocks.CHESTNUT_SLAB);
    public static final DeferredBlock<Block> CHESTNUT_WOOD_VERTICAL_SLAB = verticalSlab("chestnut_wood_vertical_slab", ModBlocks.CHESTNUT_WOOD_SLAB);
    public static final DeferredBlock<Block> CINNAMON_ROOFING_VERTICAL_SLAB = verticalSlab("cinnamon_roofing_vertical_slab", ModBlocks.CINNAMON_ROOFING_SLAB);
    public static final DeferredBlock<Block> CINNAMON_VERTICAL_SLAB = verticalSlab("cinnamon_vertical_slab", ModBlocks.CINNAMON_SLAB);
    public static final DeferredBlock<Block> CINNAMON_WOOD_VERTICAL_SLAB = verticalSlab("cinnamon_wood_vertical_slab", ModBlocks.CINNAMON_WOOD_SLAB);
    public static final DeferredBlock<Block> CLOVE_ROOFING_VERTICAL_SLAB = verticalSlab("clove_roofing_vertical_slab", ModBlocks.CLOVE_ROOFING_SLAB);
    public static final DeferredBlock<Block> CLOVE_VERTICAL_SLAB = verticalSlab("clove_vertical_slab", ModBlocks.CLOVE_SLAB);
    public static final DeferredBlock<Block> CLOVE_WOOD_VERTICAL_SLAB = verticalSlab("clove_wood_vertical_slab", ModBlocks.CLOVE_WOOD_SLAB);
    public static final DeferredBlock<Block> COARSE_DIRT_VERTICAL_SLAB = verticalSlab("coarse_dirt_vertical_slab", ModBlocks.COARSE_DIRT_SLAB);
    public static final DeferredBlock<Block> COTTONWOOD_ROOFING_VERTICAL_SLAB = verticalSlab("cottonwood_roofing_vertical_slab", ModBlocks.COTTONWOOD_ROOFING_SLAB);
    public static final DeferredBlock<Block> COTTONWOOD_VERTICAL_SLAB = verticalSlab("cottonwood_vertical_slab", ModBlocks.COTTONWOOD_SLAB);
    public static final DeferredBlock<Block> COTTONWOOD_WOOD_VERTICAL_SLAB = verticalSlab("cottonwood_wood_vertical_slab", ModBlocks.COTTONWOOD_WOOD_SLAB);
    public static final DeferredBlock<Block> CRABAPPLE_ROOFING_VERTICAL_SLAB = verticalSlab("crabapple_roofing_vertical_slab", ModBlocks.CRABAPPLE_ROOFING_SLAB);
    public static final DeferredBlock<Block> CRABAPPLE_VERTICAL_SLAB = verticalSlab("crabapple_vertical_slab", ModBlocks.CRABAPPLE_SLAB);
    public static final DeferredBlock<Block> CRABAPPLE_WOOD_VERTICAL_SLAB = verticalSlab("crabapple_wood_vertical_slab", ModBlocks.CRABAPPLE_WOOD_SLAB);
    public static final DeferredBlock<Block> CRACKED_BASALT_BRICK_VERTICAL_SLAB = verticalSlab("cracked_basalt_brick_vertical_slab", ModBlocks.CRACKED_BASALT_BRICK_SLAB);
    public static final DeferredBlock<Block> CRACKED_FLINT_BRICK_VERTICAL_SLAB = verticalSlab("cracked_flint_brick_vertical_slab", ModBlocks.CRACKED_FLINT_BRICK_SLAB);
    public static final DeferredBlock<Block> CRACKED_FUSED_BLACK_BRICK_VERTICAL_SLAB = verticalSlab("cracked_fused_black_brick_vertical_slab", ModBlocks.CRACKED_FUSED_BLACK_BRICK_SLAB);
    public static final DeferredBlock<Block> CRACKED_GREY_GRANITE_BRICK_VERTICAL_SLAB = verticalSlab("cracked_grey_granite_brick_vertical_slab", ModBlocks.CRACKED_GREY_GRANITE_BRICK_SLAB);
    public static final DeferredBlock<Block> CRACKED_LIMESTONE_BRICK_VERTICAL_SLAB = verticalSlab("cracked_limestone_brick_vertical_slab", ModBlocks.CRACKED_LIMESTONE_BRICK_SLAB);
    public static final DeferredBlock<Block> CRACKED_MARBLE_BRICK_VERTICAL_SLAB = verticalSlab("cracked_marble_brick_vertical_slab", ModBlocks.CRACKED_MARBLE_BRICK_SLAB);
    public static final DeferredBlock<Block> CRACKED_OILY_BLACK_BRICK_VERTICAL_SLAB = verticalSlab("cracked_oily_black_brick_vertical_slab", ModBlocks.CRACKED_OILY_BLACK_BRICK_SLAB);
    public static final DeferredBlock<Block> CRACKED_RED_SANDSTONE_BRICK_VERTICAL_SLAB = verticalSlab("cracked_red_sandstone_brick_vertical_slab", ModBlocks.CRACKED_RED_SANDSTONE_BRICK_SLAB);
    public static final DeferredBlock<Block> CRACKED_SANDSTONE_BRICK_VERTICAL_SLAB = verticalSlab("cracked_sandstone_brick_vertical_slab", ModBlocks.CRACKED_SANDSTONE_BRICK_SLAB);
    public static final DeferredBlock<Block> CRACKED_SLATE_BRICK_VERTICAL_SLAB = verticalSlab("cracked_slate_brick_vertical_slab", ModBlocks.CRACKED_SLATE_BRICK_SLAB);
    ...
    public static final DeferredBlock<Block> DIRT_PATH_VERTICAL_SLAB = verticalSlab("dirt_path_vertical_slab", ModBlocks.DIRT_PATH_SLAB);
    public static final DeferredBlock<Block> DIRT_VERTICAL_SLAB = verticalSlab("dirt_vertical_slab", ModBlocks.DIRT_SLAB);
    public static final DeferredBlock<Block> EBONY_ROOFING_VERTICAL_SLAB = verticalSlab("ebony_roofing_vertical_slab", ModBlocks.EBONY_ROOFING_SLAB);
    public static final DeferredBlock<Block> EBONY_VERTICAL_SLAB = verticalSlab("ebony_vertical_slab", ModBlocks.EBONY_SLAB);
    public static final DeferredBlock<Block> EBONY_WOOD_VERTICAL_SLAB = verticalSlab("ebony_wood_vertical_slab", ModBlocks.EBONY_WOOD_SLAB);
    public static final DeferredBlock<Block> ELM_ROOFING_VERTICAL_SLAB = verticalSlab("elm_roofing_vertical_slab", ModBlocks.ELM_ROOFING_SLAB);
    public static final DeferredBlock<Block> ELM_VERTICAL_SLAB = verticalSlab("elm_vertical_slab", ModBlocks.ELM_SLAB);
    public static final DeferredBlock<Block> ELM_WOOD_VERTICAL_SLAB = verticalSlab("elm_wood_vertical_slab", ModBlocks.ELM_WOOD_SLAB);
    public static final DeferredBlock<Block> FIELDSTONE_VERTICAL_SLAB = verticalSlab("fieldstone_vertical_slab", ModBlocks.FIELDSTONE_SLAB);
    public static final DeferredBlock<Block> FIG_ROOFING_VERTICAL_SLAB = verticalSlab("fig_roofing_vertical_slab", ModBlocks.FIG_ROOFING_SLAB);
    public static final DeferredBlock<Block> FIG_VERTICAL_SLAB = verticalSlab("fig_vertical_slab", ModBlocks.FIG_SLAB);
    public static final DeferredBlock<Block> FIG_WOOD_VERTICAL_SLAB = verticalSlab("fig_wood_vertical_slab", ModBlocks.FIG_WOOD_SLAB);
    public static final DeferredBlock<Block> FIR_ROOFING_VERTICAL_SLAB = verticalSlab("fir_roofing_vertical_slab", ModBlocks.FIR_ROOFING_SLAB);
    public static final DeferredBlock<Block> FIR_VERTICAL_SLAB = verticalSlab("fir_vertical_slab", ModBlocks.FIR_SLAB);
    public static final DeferredBlock<Block> FIR_WOOD_VERTICAL_SLAB = verticalSlab("fir_wood_vertical_slab", ModBlocks.FIR_WOOD_SLAB);
    public static final DeferredBlock<Block> FLINT_BRICK_VERTICAL_SLAB = verticalSlab("flint_brick_vertical_slab", ModBlocks.FLINT_BRICK_SLAB);
    public static final DeferredBlock<Block> FLINT_ROCK_VERTICAL_SLAB = verticalSlab("flint_rock_vertical_slab", ModBlocks.FLINT_ROCK_SLAB);
    public static final DeferredBlock<Block> FUSED_BLACK_BRICK_VERTICAL_SLAB = verticalSlab("fused_black_brick_vertical_slab", ModBlocks.FUSED_BLACK_BRICK_SLAB);
    public static final DeferredBlock<Block> FUSED_BLACK_COBBLESTONE_VERTICAL_SLAB = verticalSlab("fused_black_cobblestone_vertical_slab", ModBlocks.FUSED_BLACK_COBBLESTONE_SLAB);
    public static final DeferredBlock<Block> FUSED_BLACK_ROCK_VERTICAL_SLAB = verticalSlab("fused_black_rock_vertical_slab", ModBlocks.FUSED_BLACK_ROCK_SLAB);
    public static final DeferredBlock<Block> GOLDENHEART_ROOFING_VERTICAL_SLAB = verticalSlab("goldenheart_roofing_vertical_slab", ModBlocks.GOLDENHEART_ROOFING_SLAB);
    public static final DeferredBlock<Block> GOLDENHEART_VERTICAL_SLAB = verticalSlab("goldenheart_vertical_slab", ModBlocks.GOLDENHEART_SLAB);
    public static final DeferredBlock<Block> GOLDENHEART_WOOD_VERTICAL_SLAB = verticalSlab("goldenheart_wood_vertical_slab", ModBlocks.GOLDENHEART_WOOD_SLAB);
    public static final DeferredBlock<Block> GRASS_BLOCK_VERTICAL_SLAB = verticalSlab("grass_block_vertical_slab", ModBlocks.GRASS_BLOCK_SLAB);
    public static final DeferredBlock<Block> GRAY_WOOL_VERTICAL_SLAB = verticalSlab("gray_wool_vertical_slab", ModBlocks.GRAY_WOOL_SLAB);
    public static final DeferredBlock<Block> GREEN_WOOL_VERTICAL_SLAB = verticalSlab("green_wool_vertical_slab", ModBlocks.GREEN_WOOL_SLAB);
    public static final DeferredBlock<Block> GREY_GRANITE_BRICK_VERTICAL_SLAB = verticalSlab("grey_granite_brick_vertical_slab", ModBlocks.GREY_GRANITE_BRICK_SLAB);
    public static final DeferredBlock<Block> GREY_GRANITE_COBBLESTONE_VERTICAL_SLAB = verticalSlab("grey_granite_cobblestone_vertical_slab", ModBlocks.GREY_GRANITE_COBBLESTONE_SLAB);
    public static final DeferredBlock<Block> GREY_GRANITE_ROCK_VERTICAL_SLAB = verticalSlab("grey_granite_rock_vertical_slab", ModBlocks.GREY_GRANITE_ROCK_SLAB);
    public static final DeferredBlock<Block> HAWTHORN_ROOFING_VERTICAL_SLAB = verticalSlab("hawthorn_roofing_vertical_slab", ModBlocks.HAWTHORN_ROOFING_SLAB);
    public static final DeferredBlock<Block> HAWTHORN_VERTICAL_SLAB = verticalSlab("hawthorn_vertical_slab", ModBlocks.HAWTHORN_SLAB);
    public static final DeferredBlock<Block> HAWTHORN_WOOD_VERTICAL_SLAB = verticalSlab("hawthorn_wood_vertical_slab", ModBlocks.HAWTHORN_WOOD_SLAB);
    public static final DeferredBlock<Block> HEMLOCK_ROOFING_VERTICAL_SLAB = verticalSlab("hemlock_roofing_vertical_slab", ModBlocks.HEMLOCK_ROOFING_SLAB);
    public static final DeferredBlock<Block> HEMLOCK_VERTICAL_SLAB = verticalSlab("hemlock_vertical_slab", ModBlocks.HEMLOCK_SLAB);
    public static final DeferredBlock<Block> HEMLOCK_WOOD_VERTICAL_SLAB = verticalSlab("hemlock_wood_vertical_slab", ModBlocks.HEMLOCK_WOOD_SLAB);
    public static final DeferredBlock<Block> IRONWOOD_ROOFING_VERTICAL_SLAB = verticalSlab("ironwood_roofing_vertical_slab", ModBlocks.IRONWOOD_ROOFING_SLAB);
    public static final DeferredBlock<Block> IRONWOOD_VERTICAL_SLAB = verticalSlab("ironwood_vertical_slab", ModBlocks.IRONWOOD_SLAB);
    public static final DeferredBlock<Block> IRONWOOD_WOOD_VERTICAL_SLAB = verticalSlab("ironwood_wood_vertical_slab", ModBlocks.IRONWOOD_WOOD_SLAB);
    public static final DeferredBlock<Block> JUNGLE_ROOFING_VERTICAL_SLAB = verticalSlab("jungle_roofing_vertical_slab", ModBlocks.JUNGLE_ROOFING_SLAB);
    public static final DeferredBlock<Block> JUNGLE_WOOD_VERTICAL_SLAB = verticalSlab("jungle_wood_vertical_slab", ModBlocks.JUNGLE_WOOD_SLAB);
    public static final DeferredBlock<Block> LEMON_ROOFING_VERTICAL_SLAB = verticalSlab("lemon_roofing_vertical_slab", ModBlocks.LEMON_ROOFING_SLAB);
    public static final DeferredBlock<Block> LEMON_VERTICAL_SLAB = verticalSlab("lemon_vertical_slab", ModBlocks.LEMON_SLAB);
    ...
    public static final DeferredBlock<Block> LIME_WOOL_VERTICAL_SLAB = verticalSlab("lime_wool_vertical_slab", ModBlocks.LIME_WOOL_SLAB);
    public static final DeferredBlock<Block> LIMESTONE_BRICK_VERTICAL_SLAB = verticalSlab("limestone_brick_vertical_slab", ModBlocks.LIMESTONE_BRICK_SLAB);
    public static final DeferredBlock<Block> LIMESTONE_COBBLESTONE_VERTICAL_SLAB = verticalSlab("limestone_cobblestone_vertical_slab", ModBlocks.LIMESTONE_COBBLESTONE_SLAB);
    public static final DeferredBlock<Block> LIMESTONE_ROCK_VERTICAL_SLAB = verticalSlab("limestone_rock_vertical_slab", ModBlocks.LIMESTONE_ROCK_SLAB);
    public static final DeferredBlock<Block> LINDEN_ROOFING_VERTICAL_SLAB = verticalSlab("linden_roofing_vertical_slab", ModBlocks.LINDEN_ROOFING_SLAB);
    public static final DeferredBlock<Block> LINDEN_VERTICAL_SLAB = verticalSlab("linden_vertical_slab", ModBlocks.LINDEN_SLAB);
    public static final DeferredBlock<Block> LINDEN_WOOD_VERTICAL_SLAB = verticalSlab("linden_wood_vertical_slab", ModBlocks.LINDEN_WOOD_SLAB);
    public static final DeferredBlock<Block> MAGENTA_WOOL_VERTICAL_SLAB = verticalSlab("magenta_wool_vertical_slab", ModBlocks.MAGENTA_WOOL_SLAB);
    public static final DeferredBlock<Block> MAHOGANY_ROOFING_VERTICAL_SLAB = verticalSlab("mahogany_roofing_vertical_slab", ModBlocks.MAHOGANY_ROOFING_SLAB);
    public static final DeferredBlock<Block> MAHOGANY_VERTICAL_SLAB = verticalSlab("mahogany_vertical_slab", ModBlocks.MAHOGANY_SLAB);
    public static final DeferredBlock<Block> MAHOGANY_WOOD_VERTICAL_SLAB = verticalSlab("mahogany_wood_vertical_slab", ModBlocks.MAHOGANY_WOOD_SLAB);
    public static final DeferredBlock<Block> MANGROVE_ROOFING_VERTICAL_SLAB = verticalSlab("mangrove_roofing_vertical_slab", ModBlocks.MANGROVE_ROOFING_SLAB);
    public static final DeferredBlock<Block> MANGROVE_WOOD_VERTICAL_SLAB = verticalSlab("mangrove_wood_vertical_slab", ModBlocks.MANGROVE_WOOD_SLAB);
    public static final DeferredBlock<Block> MAPLE_ROOFING_VERTICAL_SLAB = verticalSlab("maple_roofing_vertical_slab", ModBlocks.MAPLE_ROOFING_SLAB);
    public static final DeferredBlock<Block> MAPLE_VERTICAL_SLAB = verticalSlab("maple_vertical_slab", ModBlocks.MAPLE_SLAB);
    public static final DeferredBlock<Block> MAPLE_WOOD_VERTICAL_SLAB = verticalSlab("maple_wood_vertical_slab", ModBlocks.MAPLE_WOOD_SLAB);
    public static final DeferredBlock<Block> MARBLE_BRICK_VERTICAL_SLAB = verticalSlab("marble_brick_vertical_slab", ModBlocks.MARBLE_BRICK_SLAB);
    public static final DeferredBlock<Block> MARBLE_COBBLESTONE_VERTICAL_SLAB = verticalSlab("marble_cobblestone_vertical_slab", ModBlocks.MARBLE_COBBLESTONE_SLAB);
    public static final DeferredBlock<Block> MARBLE_ROCK_VERTICAL_SLAB = verticalSlab("marble_rock_vertical_slab", ModBlocks.MARBLE_ROCK_SLAB);
    public static final DeferredBlock<Block> MOSSY_BASALT_BRICK_VERTICAL_SLAB = verticalSlab("mossy_basalt_brick_vertical_slab", ModBlocks.MOSSY_BASALT_BRICK_SLAB);
    public static final DeferredBlock<Block> MOSSY_BASALT_COBBLESTONE_VERTICAL_SLAB = verticalSlab("mossy_basalt_cobblestone_vertical_slab", ModBlocks.MOSSY_BASALT_COBBLESTONE_SLAB);
    public static final DeferredBlock<Block> MOSSY_FLINT_BRICK_VERTICAL_SLAB = verticalSlab("mossy_flint_brick_vertical_slab", ModBlocks.MOSSY_FLINT_BRICK_SLAB);
    public static final DeferredBlock<Block> MOSSY_FUSED_BLACK_BRICK_VERTICAL_SLAB = verticalSlab("mossy_fused_black_brick_vertical_slab", ModBlocks.MOSSY_FUSED_BLACK_BRICK_SLAB);
    public static final DeferredBlock<Block> MOSSY_FUSED_BLACK_COBBLESTONE_VERTICAL_SLAB = verticalSlab("mossy_fused_black_cobblestone_vertical_slab", ModBlocks.MOSSY_FUSED_BLACK_COBBLESTONE_SLAB);
    public static final DeferredBlock<Block> MOSSY_GREY_GRANITE_BRICK_VERTICAL_SLAB = verticalSlab("mossy_grey_granite_brick_vertical_slab", ModBlocks.MOSSY_GREY_GRANITE_BRICK_SLAB);
    public static final DeferredBlock<Block> MOSSY_GREY_GRANITE_COBBLESTONE_VERTICAL_SLAB = verticalSlab("mossy_grey_granite_cobblestone_vertical_slab", ModBlocks.MOSSY_GREY_GRANITE_COBBLESTONE_SLAB);
    public static final DeferredBlock<Block> MOSSY_LIMESTONE_BRICK_VERTICAL_SLAB = verticalSlab("mossy_limestone_brick_vertical_slab", ModBlocks.MOSSY_LIMESTONE_BRICK_SLAB);
    public static final DeferredBlock<Block> MOSSY_LIMESTONE_COBBLESTONE_VERTICAL_SLAB = verticalSlab("mossy_limestone_cobblestone_vertical_slab", ModBlocks.MOSSY_LIMESTONE_COBBLESTONE_SLAB);
    public static final DeferredBlock<Block> MOSSY_MARBLE_BRICK_VERTICAL_SLAB = verticalSlab("mossy_marble_brick_vertical_slab", ModBlocks.MOSSY_MARBLE_BRICK_SLAB);
    public static final DeferredBlock<Block> MOSSY_MARBLE_COBBLESTONE_VERTICAL_SLAB = verticalSlab("mossy_marble_cobblestone_vertical_slab", ModBlocks.MOSSY_MARBLE_COBBLESTONE_SLAB);
    public static final DeferredBlock<Block> MOSSY_OILY_BLACK_BRICK_VERTICAL_SLAB = verticalSlab("mossy_oily_black_brick_vertical_slab", ModBlocks.MOSSY_OILY_BLACK_BRICK_SLAB);
    public static final DeferredBlock<Block> MOSSY_OILY_BLACK_COBBLESTONE_VERTICAL_SLAB = verticalSlab("mossy_oily_black_cobblestone_vertical_slab", ModBlocks.MOSSY_OILY_BLACK_COBBLESTONE_SLAB);
    public static final DeferredBlock<Block> MOSSY_RED_SANDSTONE_BRICK_VERTICAL_SLAB = verticalSlab("mossy_red_sandstone_brick_vertical_slab", ModBlocks.MOSSY_RED_SANDSTONE_BRICK_SLAB);
    public static final DeferredBlock<Block> MOSSY_RED_SANDSTONE_COBBLESTONE_VERTICAL_SLAB = verticalSlab("mossy_red_sandstone_cobblestone_vertical_slab", ModBlocks.MOSSY_RED_SANDSTONE_COBBLESTONE_SLAB);
    public static final DeferredBlock<Block> MOSSY_SANDSTONE_BRICK_VERTICAL_SLAB = verticalSlab("mossy_sandstone_brick_vertical_slab", ModBlocks.MOSSY_SANDSTONE_BRICK_SLAB);
    public static final DeferredBlock<Block> MOSSY_SANDSTONE_COBBLESTONE_VERTICAL_SLAB = verticalSlab("mossy_sandstone_cobblestone_vertical_slab", ModBlocks.MOSSY_SANDSTONE_COBBLESTONE_SLAB);
    public static final DeferredBlock<Block> MOSSY_SLATE_BRICK_VERTICAL_SLAB = verticalSlab("mossy_slate_brick_vertical_slab", ModBlocks.MOSSY_SLATE_BRICK_SLAB);
    public static final DeferredBlock<Block> MOSSY_SLATE_COBBLESTONE_VERTICAL_SLAB = verticalSlab("mossy_slate_cobblestone_vertical_slab", ModBlocks.MOSSY_SLATE_COBBLESTONE_SLAB);
    public static final DeferredBlock<Block> MUD_VERTICAL_SLAB = verticalSlab("mud_vertical_slab", ModBlocks.MUD_SLAB);
    public static final DeferredBlock<Block> MYRRH_ROOFING_VERTICAL_SLAB = verticalSlab("myrrh_roofing_vertical_slab", ModBlocks.MYRRH_ROOFING_SLAB);
    public static final DeferredBlock<Block> MYRRH_VERTICAL_SLAB = verticalSlab("myrrh_vertical_slab", ModBlocks.MYRRH_SLAB);
    public static final DeferredBlock<Block> MYRRH_WOOD_VERTICAL_SLAB = verticalSlab("myrrh_wood_vertical_slab", ModBlocks.MYRRH_WOOD_SLAB);
    public static final DeferredBlock<Block> NIGHTWOOD_ROOFING_VERTICAL_SLAB = verticalSlab("nightwood_roofing_vertical_slab", ModBlocks.NIGHTWOOD_ROOFING_SLAB);
    public static final DeferredBlock<Block> NIGHTWOOD_VERTICAL_SLAB = verticalSlab("nightwood_vertical_slab", ModBlocks.NIGHTWOOD_SLAB);
    public static final DeferredBlock<Block> NIGHTWOOD_WOOD_VERTICAL_SLAB = verticalSlab("nightwood_wood_vertical_slab", ModBlocks.NIGHTWOOD_WOOD_SLAB);
    public static final DeferredBlock<Block> NUTMEG_ROOFING_VERTICAL_SLAB = verticalSlab("nutmeg_roofing_vertical_slab", ModBlocks.NUTMEG_ROOFING_SLAB);
    public static final DeferredBlock<Block> NUTMEG_VERTICAL_SLAB = verticalSlab("nutmeg_vertical_slab", ModBlocks.NUTMEG_SLAB);
    public static final DeferredBlock<Block> NUTMEG_WOOD_VERTICAL_SLAB = verticalSlab("nutmeg_wood_vertical_slab", ModBlocks.NUTMEG_WOOD_SLAB);
    public static final DeferredBlock<Block> OAK_ROOFING_VERTICAL_SLAB = verticalSlab("oak_roofing_vertical_slab", ModBlocks.OAK_ROOFING_SLAB);
    public static final DeferredBlock<Block> OAK_WOOD_VERTICAL_SLAB = verticalSlab("oak_wood_vertical_slab", ModBlocks.OAK_WOOD_SLAB);
    public static final DeferredBlock<Block> OILY_BLACK_BRICK_VERTICAL_SLAB = verticalSlab("oily_black_brick_vertical_slab", ModBlocks.OILY_BLACK_BRICK_SLAB);
    public static final DeferredBlock<Block> OILY_BLACK_COBBLESTONE_VERTICAL_SLAB = verticalSlab("oily_black_cobblestone_vertical_slab", ModBlocks.OILY_BLACK_COBBLESTONE_SLAB);
    public static final DeferredBlock<Block> OILY_BLACK_ROCK_VERTICAL_SLAB = verticalSlab("oily_black_rock_vertical_slab", ModBlocks.OILY_BLACK_ROCK_SLAB);
    public static final DeferredBlock<Block> OLIVE_ROOFING_VERTICAL_SLAB = verticalSlab("olive_roofing_vertical_slab", ModBlocks.OLIVE_ROOFING_SLAB);
    public static final DeferredBlock<Block> OLIVE_VERTICAL_SLAB = verticalSlab("olive_vertical_slab", ModBlocks.OLIVE_SLAB);
    public static final DeferredBlock<Block> OLIVE_WOOD_VERTICAL_SLAB = verticalSlab("olive_wood_vertical_slab", ModBlocks.OLIVE_WOOD_SLAB);
    public static final DeferredBlock<Block> ORANGE_ROOFING_VERTICAL_SLAB = verticalSlab("orange_roofing_vertical_slab", ModBlocks.ORANGE_ROOFING_SLAB);
    public static final DeferredBlock<Block> ORANGE_VERTICAL_SLAB = verticalSlab("orange_vertical_slab", ModBlocks.ORANGE_SLAB);
    public static final DeferredBlock<Block> ORANGE_WOOD_VERTICAL_SLAB = verticalSlab("orange_wood_vertical_slab", ModBlocks.ORANGE_WOOD_SLAB);
    public static final DeferredBlock<Block> ORANGE_WOOL_VERTICAL_SLAB = verticalSlab("orange_wool_vertical_slab", ModBlocks.ORANGE_WOOL_SLAB);
    public static final DeferredBlock<Block> PALE_OAK_WOOD_VERTICAL_SLAB = verticalSlab("pale_oak_wood_vertical_slab", ModBlocks.PALE_OAK_WOOD_SLAB);
    public static final DeferredBlock<Block> PEACH_ROOFING_VERTICAL_SLAB = verticalSlab("peach_roofing_vertical_slab", ModBlocks.PEACH_ROOFING_SLAB);
    public static final DeferredBlock<Block> PEACH_VERTICAL_SLAB = verticalSlab("peach_vertical_slab", ModBlocks.PEACH_SLAB);
    public static final DeferredBlock<Block> PEACH_WOOD_VERTICAL_SLAB = verticalSlab("peach_wood_vertical_slab", ModBlocks.PEACH_WOOD_SLAB);
    public static final DeferredBlock<Block> PEAR_ROOFING_VERTICAL_SLAB = verticalSlab("pear_roofing_vertical_slab", ModBlocks.PEAR_ROOFING_SLAB);
    public static final DeferredBlock<Block> PEAR_VERTICAL_SLAB = verticalSlab("pear_vertical_slab", ModBlocks.PEAR_SLAB);
    public static final DeferredBlock<Block> PEAR_WOOD_VERTICAL_SLAB = verticalSlab("pear_wood_vertical_slab", ModBlocks.PEAR_WOOD_SLAB);
    public static final DeferredBlock<Block> PERSIMMON_ROOFING_VERTICAL_SLAB = verticalSlab("persimmon_roofing_vertical_slab", ModBlocks.PERSIMMON_ROOFING_SLAB);
    public static final DeferredBlock<Block> PERSIMMON_VERTICAL_SLAB = verticalSlab("persimmon_vertical_slab", ModBlocks.PERSIMMON_SLAB);
    public static final DeferredBlock<Block> PERSIMMON_WOOD_VERTICAL_SLAB = verticalSlab("persimmon_wood_vertical_slab", ModBlocks.PERSIMMON_WOOD_SLAB);
    public static final DeferredBlock<Block> PINE_ROOFING_VERTICAL_SLAB = verticalSlab("pine_roofing_vertical_slab", ModBlocks.PINE_ROOFING_SLAB);
    public static final DeferredBlock<Block> PINE_VERTICAL_SLAB = verticalSlab("pine_vertical_slab", ModBlocks.PINE_SLAB);
    public static final DeferredBlock<Block> PINE_WOOD_VERTICAL_SLAB = verticalSlab("pine_wood_vertical_slab", ModBlocks.PINE_WOOD_SLAB);
    public static final DeferredBlock<Block> PINK_IVORY_ROOFING_VERTICAL_SLAB = verticalSlab("pink_ivory_roofing_vertical_slab", ModBlocks.PINK_IVORY_ROOFING_SLAB);
    public static final DeferredBlock<Block> PINK_IVORY_VERTICAL_SLAB = verticalSlab("pink_ivory_vertical_slab", ModBlocks.PINK_IVORY_SLAB);
    public static final DeferredBlock<Block> PINK_IVORY_WOOD_VERTICAL_SLAB = verticalSlab("pink_ivory_wood_vertical_slab", ModBlocks.PINK_IVORY_WOOD_SLAB);
    public static final DeferredBlock<Block> PINK_WOOL_VERTICAL_SLAB = verticalSlab("pink_wool_vertical_slab", ModBlocks.PINK_WOOL_SLAB);
    public static final DeferredBlock<Block> PLUM_ROOFING_VERTICAL_SLAB = verticalSlab("plum_roofing_vertical_slab", ModBlocks.PLUM_ROOFING_SLAB);
    public static final DeferredBlock<Block> PLUM_VERTICAL_SLAB = verticalSlab("plum_vertical_slab", ModBlocks.PLUM_SLAB);
    public static final DeferredBlock<Block> PLUM_WOOD_VERTICAL_SLAB = verticalSlab("plum_wood_vertical_slab", ModBlocks.PLUM_WOOD_SLAB);
    public static final DeferredBlock<Block> PODZOL_VERTICAL_SLAB = verticalSlab("podzol_vertical_slab", ModBlocks.PODZOL_SLAB);
    public static final DeferredBlock<Block> POMEGRANATE_ROOFING_VERTICAL_SLAB = verticalSlab("pomegranate_roofing_vertical_slab", ModBlocks.POMEGRANATE_ROOFING_SLAB);
    public static final DeferredBlock<Block> POMEGRANATE_VERTICAL_SLAB = verticalSlab("pomegranate_vertical_slab", ModBlocks.POMEGRANATE_SLAB);
    public static final DeferredBlock<Block> POMEGRANATE_WOOD_VERTICAL_SLAB = verticalSlab("pomegranate_wood_vertical_slab", ModBlocks.POMEGRANATE_WOOD_SLAB);
    public static final DeferredBlock<Block> PRUNE_ROOFING_VERTICAL_SLAB = verticalSlab("prune_roofing_vertical_slab", ModBlocks.PRUNE_ROOFING_SLAB);
    public static final DeferredBlock<Block> PRUNE_VERTICAL_SLAB = verticalSlab("prune_vertical_slab", ModBlocks.PRUNE_SLAB);
    public static final DeferredBlock<Block> PRUNE_WOOD_VERTICAL_SLAB = verticalSlab("prune_wood_vertical_slab", ModBlocks.PRUNE_WOOD_SLAB);
    public static final DeferredBlock<Block> PURPLE_WOOL_VERTICAL_SLAB = verticalSlab("purple_wool_vertical_slab", ModBlocks.PURPLE_WOOL_SLAB);
    public static final DeferredBlock<Block> PURPLEHEART_ROOFING_VERTICAL_SLAB = verticalSlab("purpleheart_roofing_vertical_slab", ModBlocks.PURPLEHEART_ROOFING_SLAB);
    public static final DeferredBlock<Block> PURPLEHEART_VERTICAL_SLAB = verticalSlab("purpleheart_vertical_slab", ModBlocks.PURPLEHEART_SLAB);
    public static final DeferredBlock<Block> PURPLEHEART_WOOD_VERTICAL_SLAB = verticalSlab("purpleheart_wood_vertical_slab", ModBlocks.PURPLEHEART_WOOD_SLAB);
    public static final DeferredBlock<Block> RED_CHERRY_ROOFING_VERTICAL_SLAB = verticalSlab("red_cherry_roofing_vertical_slab", ModBlocks.RED_CHERRY_ROOFING_SLAB);
    public static final DeferredBlock<Block> RED_CHERRY_VERTICAL_SLAB = verticalSlab("red_cherry_vertical_slab", ModBlocks.RED_CHERRY_SLAB);
    public static final DeferredBlock<Block> RED_CHERRY_WOOD_VERTICAL_SLAB = verticalSlab("red_cherry_wood_vertical_slab", ModBlocks.RED_CHERRY_WOOD_SLAB);
    public static final DeferredBlock<Block> RED_SANDSTONE_BRICK_VERTICAL_SLAB = verticalSlab("red_sandstone_brick_vertical_slab", ModBlocks.RED_SANDSTONE_BRICK_SLAB);
    public static final DeferredBlock<Block> RED_SANDSTONE_COBBLESTONE_VERTICAL_SLAB = verticalSlab("red_sandstone_cobblestone_vertical_slab", ModBlocks.RED_SANDSTONE_COBBLESTONE_SLAB);
    public static final DeferredBlock<Block> RED_WOOL_VERTICAL_SLAB = verticalSlab("red_wool_vertical_slab", ModBlocks.RED_WOOL_SLAB);
    public static final DeferredBlock<Block> REDWOOD_ROOFING_VERTICAL_SLAB = verticalSlab("redwood_roofing_vertical_slab", ModBlocks.REDWOOD_ROOFING_SLAB);
    public static final DeferredBlock<Block> REDWOOD_VERTICAL_SLAB = verticalSlab("redwood_vertical_slab", ModBlocks.REDWOOD_SLAB);
    public static final DeferredBlock<Block> REDWOOD_WOOD_VERTICAL_SLAB = verticalSlab("redwood_wood_vertical_slab", ModBlocks.REDWOOD_WOOD_SLAB);
    public static final DeferredBlock<Block> ROOTED_DIRT_VERTICAL_SLAB = verticalSlab("rooted_dirt_vertical_slab", ModBlocks.ROOTED_DIRT_SLAB);
    public static final DeferredBlock<Block> SANDALWOOD_ROOFING_VERTICAL_SLAB = verticalSlab("sandalwood_roofing_vertical_slab", ModBlocks.SANDALWOOD_ROOFING_SLAB);
    public static final DeferredBlock<Block> SANDALWOOD_VERTICAL_SLAB = verticalSlab("sandalwood_vertical_slab", ModBlocks.SANDALWOOD_SLAB);
    public static final DeferredBlock<Block> SANDALWOOD_WOOD_VERTICAL_SLAB = verticalSlab("sandalwood_wood_vertical_slab", ModBlocks.SANDALWOOD_WOOD_SLAB);
    public static final DeferredBlock<Block> SANDBEGGAR_ROOFING_VERTICAL_SLAB = verticalSlab("sandbeggar_roofing_vertical_slab", ModBlocks.SANDBEGGAR_ROOFING_SLAB);
    public static final DeferredBlock<Block> SANDBEGGAR_VERTICAL_SLAB = verticalSlab("sandbeggar_vertical_slab", ModBlocks.SANDBEGGAR_SLAB);
    public static final DeferredBlock<Block> SANDBEGGAR_WOOD_VERTICAL_SLAB = verticalSlab("sandbeggar_wood_vertical_slab", ModBlocks.SANDBEGGAR_WOOD_SLAB);
    public static final DeferredBlock<Block> SANDSTONE_BRICK_VERTICAL_SLAB = verticalSlab("sandstone_brick_vertical_slab", ModBlocks.SANDSTONE_BRICK_SLAB);
    public static final DeferredBlock<Block> SANDSTONE_COBBLESTONE_VERTICAL_SLAB = verticalSlab("sandstone_cobblestone_vertical_slab", ModBlocks.SANDSTONE_COBBLESTONE_SLAB);
    public static final DeferredBlock<Block> SENTINAL_ROOFING_VERTICAL_SLAB = verticalSlab("sentinal_roofing_vertical_slab", ModBlocks.SENTINAL_ROOFING_SLAB);
    public static final DeferredBlock<Block> SENTINAL_VERTICAL_SLAB = verticalSlab("sentinal_vertical_slab", ModBlocks.SENTINAL_SLAB);
    public static final DeferredBlock<Block> SENTINAL_WOOD_VERTICAL_SLAB = verticalSlab("sentinal_wood_vertical_slab", ModBlocks.SENTINAL_WOOD_SLAB);
    public static final DeferredBlock<Block> SLATE_BRICK_VERTICAL_SLAB = verticalSlab("slate_brick_vertical_slab", ModBlocks.SLATE_BRICK_SLAB);
    public static final DeferredBlock<Block> SLATE_COBBLESTONE_VERTICAL_SLAB = verticalSlab("slate_cobblestone_vertical_slab", ModBlocks.SLATE_COBBLESTONE_SLAB);
    public static final DeferredBlock<Block> SLATE_ROCK_VERTICAL_SLAB = verticalSlab("slate_rock_vertical_slab", ModBlocks.SLATE_ROCK_SLAB);
    public static final DeferredBlock<Block> SLATE_SHINGLES_VERTICAL_SLAB = verticalSlab("slate_shingles_vertical_slab", ModBlocks.SLATE_SHINGLES_SLAB);
    public static final DeferredBlock<Block> SMOOTH_BASALT_ROCK_VERTICAL_SLAB = verticalSlab("smooth_basalt_rock_vertical_slab", ModBlocks.SMOOTH_BASALT_ROCK_SLAB);
    public static final DeferredBlock<Block> SMOOTH_FUSED_BLACK_ROCK_VERTICAL_SLAB = verticalSlab("smooth_fused_black_rock_vertical_slab", ModBlocks.SMOOTH_FUSED_BLACK_ROCK_SLAB);
    public static final DeferredBlock<Block> SMOOTH_GREY_GRANITE_ROCK_VERTICAL_SLAB = verticalSlab("smooth_grey_granite_rock_vertical_slab", ModBlocks.SMOOTH_GREY_GRANITE_ROCK_SLAB);
    public static final DeferredBlock<Block> SMOOTH_LIMESTONE_ROCK_VERTICAL_SLAB = verticalSlab("smooth_limestone_rock_vertical_slab", ModBlocks.SMOOTH_LIMESTONE_ROCK_SLAB);
    public static final DeferredBlock<Block> SMOOTH_MARBLE_ROCK_VERTICAL_SLAB = verticalSlab("smooth_marble_rock_vertical_slab", ModBlocks.SMOOTH_MARBLE_ROCK_SLAB);
    public static final DeferredBlock<Block> SMOOTH_OILY_BLACK_ROCK_VERTICAL_SLAB = verticalSlab("smooth_oily_black_rock_vertical_slab", ModBlocks.SMOOTH_OILY_BLACK_ROCK_SLAB);
    public static final DeferredBlock<Block> SMOOTH_SLATE_ROCK_VERTICAL_SLAB = verticalSlab("smooth_slate_rock_vertical_slab", ModBlocks.SMOOTH_SLATE_ROCK_SLAB);
    public static final DeferredBlock<Block> SOLDIER_PINE_ROOFING_VERTICAL_SLAB = verticalSlab("soldier_pine_roofing_vertical_slab", ModBlocks.SOLDIER_PINE_ROOFING_SLAB);
    public static final DeferredBlock<Block> SOLDIER_PINE_VERTICAL_SLAB = verticalSlab("soldier_pine_vertical_slab", ModBlocks.SOLDIER_PINE_SLAB);
    public static final DeferredBlock<Block> SOLDIER_PINE_WOOD_VERTICAL_SLAB = verticalSlab("soldier_pine_wood_vertical_slab", ModBlocks.SOLDIER_PINE_WOOD_SLAB);
    public static final DeferredBlock<Block> SPRUCE_ROOFING_VERTICAL_SLAB = verticalSlab("spruce_roofing_vertical_slab", ModBlocks.SPRUCE_ROOFING_SLAB);
    public static final DeferredBlock<Block> SPRUCE_WOOD_VERTICAL_SLAB = verticalSlab("spruce_wood_vertical_slab", ModBlocks.SPRUCE_WOOD_SLAB);
    public static final DeferredBlock<Block> STRIPPED_ACACIA_WOOD_VERTICAL_SLAB = verticalSlab("stripped_acacia_wood_vertical_slab", ModBlocks.STRIPPED_ACACIA_WOOD_SLAB);
    public static final DeferredBlock<Block> STRIPPED_ALDER_WOOD_VERTICAL_SLAB = verticalSlab("stripped_alder_wood_vertical_slab", ModBlocks.STRIPPED_ALDER_WOOD_SLAB);
    public static final DeferredBlock<Block> STRIPPED_ALMOND_WOOD_VERTICAL_SLAB = verticalSlab("stripped_almond_wood_vertical_slab", ModBlocks.STRIPPED_ALMOND_WOOD_SLAB);
    public static final DeferredBlock<Block> STRIPPED_APPLE_WOOD_VERTICAL_SLAB = verticalSlab("stripped_apple_wood_vertical_slab", ModBlocks.STRIPPED_APPLE_WOOD_SLAB);
    public static final DeferredBlock<Block> STRIPPED_APRICOT_WOOD_VERTICAL_SLAB = verticalSlab("stripped_apricot_wood_vertical_slab", ModBlocks.STRIPPED_APRICOT_WOOD_SLAB);
    public static final DeferredBlock<Block> STRIPPED_ASH_WOOD_VERTICAL_SLAB = verticalSlab("stripped_ash_wood_vertical_slab", ModBlocks.STRIPPED_ASH_WOOD_SLAB);
    public static final DeferredBlock<Block> STRIPPED_ASPEN_WOOD_VERTICAL_SLAB = verticalSlab("stripped_aspen_wood_vertical_slab", ModBlocks.STRIPPED_ASPEN_WOOD_SLAB);
    public static final DeferredBlock<Block> STRIPPED_BEECH_WOOD_VERTICAL_SLAB = verticalSlab("stripped_beech_wood_vertical_slab", ModBlocks.STRIPPED_BEECH_WOOD_SLAB);
    public static final DeferredBlock<Block> STRIPPED_BIRCH_WOOD_VERTICAL_SLAB = verticalSlab("stripped_birch_wood_vertical_slab", ModBlocks.STRIPPED_BIRCH_WOOD_SLAB);
    public static final DeferredBlock<Block> STRIPPED_BLACK_CHERRY_WOOD_VERTICAL_SLAB = verticalSlab("stripped_black_cherry_wood_vertical_slab", ModBlocks.STRIPPED_BLACK_CHERRY_WOOD_SLAB);
    public static final DeferredBlock<Block> STRIPPED_BLACK_COTTONWOOD_WOOD_VERTICAL_SLAB = verticalSlab("stripped_black_cottonwood_wood_vertical_slab", ModBlocks.STRIPPED_BLACK_COTTONWOOD_WOOD_SLAB);
    public static final DeferredBlock<Block> STRIPPED_BLACKBARK_WOOD_VERTICAL_SLAB = verticalSlab("stripped_blackbark_wood_vertical_slab", ModBlocks.STRIPPED_BLACKBARK_WOOD_SLAB);
    public static final DeferredBlock<Block> STRIPPED_BLACKTHORN_WOOD_VERTICAL_SLAB = verticalSlab("stripped_blackthorn_wood_vertical_slab", ModBlocks.STRIPPED_BLACKTHORN_WOOD_SLAB);
    public static final DeferredBlock<Block> STRIPPED_BLOODWOOD_WOOD_VERTICAL_SLAB = verticalSlab("stripped_bloodwood_wood_vertical_slab", ModBlocks.STRIPPED_BLOODWOOD_WOOD_SLAB);
    public static final DeferredBlock<Block> STRIPPED_BLUE_MAHOE_WOOD_VERTICAL_SLAB = verticalSlab("stripped_blue_mahoe_wood_vertical_slab", ModBlocks.STRIPPED_BLUE_MAHOE_WOOD_SLAB);
    public static final DeferredBlock<Block> STRIPPED_CEDAR_WOOD_VERTICAL_SLAB = verticalSlab("stripped_cedar_wood_vertical_slab", ModBlocks.STRIPPED_CEDAR_WOOD_SLAB);
    public static final DeferredBlock<Block> STRIPPED_CHERRY_WOOD_VERTICAL_SLAB = verticalSlab("stripped_cherry_wood_vertical_slab", ModBlocks.STRIPPED_CHERRY_WOOD_SLAB);
    public static final DeferredBlock<Block> STRIPPED_CHESTNUT_WOOD_VERTICAL_SLAB = verticalSlab("stripped_chestnut_wood_vertical_slab", ModBlocks.STRIPPED_CHESTNUT_WOOD_SLAB);
    public static final DeferredBlock<Block> STRIPPED_CINNAMON_WOOD_VERTICAL_SLAB = verticalSlab("stripped_cinnamon_wood_vertical_slab", ModBlocks.STRIPPED_CINNAMON_WOOD_SLAB);
    public static final DeferredBlock<Block> STRIPPED_CLOVE_WOOD_VERTICAL_SLAB = verticalSlab("stripped_clove_wood_vertical_slab", ModBlocks.STRIPPED_CLOVE_WOOD_SLAB);
    public static final DeferredBlock<Block> STRIPPED_COTTONWOOD_WOOD_VERTICAL_SLAB = verticalSlab("stripped_cottonwood_wood_vertical_slab", ModBlocks.STRIPPED_COTTONWOOD_WOOD_SLAB);
    public static final DeferredBlock<Block> STRIPPED_CRABAPPLE_WOOD_VERTICAL_SLAB = verticalSlab("stripped_crabapple_wood_vertical_slab", ModBlocks.STRIPPED_CRABAPPLE_WOOD_SLAB);
    public static final DeferredBlock<Block> STRIPPED_DARK_OAK_WOOD_VERTICAL_SLAB = verticalSlab("stripped_dark_oak_wood_vertical_slab", ModBlocks.STRIPPED_DARK_OAK_WOOD_SLAB);
    public static final DeferredBlock<Block> STRIPPED_DATE_PALM_WOOD_VERTICAL_SLAB = verticalSlab("stripped_date_palm_wood_vertical_slab", ModBlocks.STRIPPED_DATE_PALM_WOOD_SLAB);
    public static final DeferredBlock<Block> STRIPPED_EBONY_WOOD_VERTICAL_SLAB = verticalSlab("stripped_ebony_wood_vertical_slab", ModBlocks.STRIPPED_EBONY_WOOD_SLAB);
    public static final DeferredBlock<Block> STRIPPED_ELM_WOOD_VERTICAL_SLAB = verticalSlab("stripped_elm_wood_vertical_slab", ModBlocks.STRIPPED_ELM_WOOD_SLAB);
    public static final DeferredBlock<Block> STRIPPED_FIG_WOOD_VERTICAL_SLAB = verticalSlab("stripped_fig_wood_vertical_slab", ModBlocks.STRIPPED_FIG_WOOD_SLAB);
    public static final DeferredBlock<Block> STRIPPED_FIR_WOOD_VERTICAL_SLAB = verticalSlab("stripped_fir_wood_vertical_slab", ModBlocks.STRIPPED_FIR_WOOD_SLAB);
    public static final DeferredBlock<Block> STRIPPED_GOLDENHEART_WOOD_VERTICAL_SLAB = verticalSlab("stripped_goldenheart_wood_vertical_slab", ModBlocks.STRIPPED_GOLDENHEART_WOOD_SLAB);
    public static final DeferredBlock<Block> STRIPPED_HAWTHORN_WOOD_VERTICAL_SLAB = verticalSlab("stripped_hawthorn_wood_vertical_slab", ModBlocks.STRIPPED_HAWTHORN_WOOD_SLAB);
    public static final DeferredBlock<Block> STRIPPED_HEMLOCK_WOOD_VERTICAL_SLAB = verticalSlab("stripped_hemlock_wood_vertical_slab", ModBlocks.STRIPPED_HEMLOCK_WOOD_SLAB);
    public static final DeferredBlock<Block> STRIPPED_IRONWOOD_WOOD_VERTICAL_SLAB = verticalSlab("stripped_ironwood_wood_vertical_slab", ModBlocks.STRIPPED_IRONWOOD_WOOD_SLAB);
    public static final DeferredBlock<Block> STRIPPED_JUNGLE_WOOD_VERTICAL_SLAB = verticalSlab("stripped_jungle_wood_vertical_slab", ModBlocks.STRIPPED_JUNGLE_WOOD_SLAB);
    public static final DeferredBlock<Block> STRIPPED_LEMON_WOOD_VERTICAL_SLAB = verticalSlab("stripped_lemon_wood_vertical_slab", ModBlocks.STRIPPED_LEMON_WOOD_SLAB);
    public static final DeferredBlock<Block> STRIPPED_LIME_WOOD_VERTICAL_SLAB = verticalSlab("stripped_lime_wood_vertical_slab", ModBlocks.STRIPPED_LIME_WOOD_SLAB);
    public static final DeferredBlock<Block> STRIPPED_LINDEN_WOOD_VERTICAL_SLAB = verticalSlab("stripped_linden_wood_vertical_slab", ModBlocks.STRIPPED_LINDEN_WOOD_SLAB);
    public static final DeferredBlock<Block> STRIPPED_MAHOGANY_WOOD_VERTICAL_SLAB = verticalSlab("stripped_mahogany_wood_vertical_slab", ModBlocks.STRIPPED_MAHOGANY_WOOD_SLAB);
    public static final DeferredBlock<Block> STRIPPED_MANGROVE_WOOD_VERTICAL_SLAB = verticalSlab("stripped_mangrove_wood_vertical_slab", ModBlocks.STRIPPED_MANGROVE_WOOD_SLAB);
    public static final DeferredBlock<Block> STRIPPED_MAPLE_WOOD_VERTICAL_SLAB = verticalSlab("stripped_maple_wood_vertical_slab", ModBlocks.STRIPPED_MAPLE_WOOD_SLAB);
    public static final DeferredBlock<Block> STRIPPED_MYRRH_WOOD_VERTICAL_SLAB = verticalSlab("stripped_myrrh_wood_vertical_slab", ModBlocks.STRIPPED_MYRRH_WOOD_SLAB);
    public static final DeferredBlock<Block> STRIPPED_NIGHTWOOD_WOOD_VERTICAL_SLAB = verticalSlab("stripped_nightwood_wood_vertical_slab", ModBlocks.STRIPPED_NIGHTWOOD_WOOD_SLAB);
    public static final DeferredBlock<Block> STRIPPED_NUTMEG_WOOD_VERTICAL_SLAB = verticalSlab("stripped_nutmeg_wood_vertical_slab", ModBlocks.STRIPPED_NUTMEG_WOOD_SLAB);
    public static final DeferredBlock<Block> STRIPPED_OAK_WOOD_VERTICAL_SLAB = verticalSlab("stripped_oak_wood_vertical_slab", ModBlocks.STRIPPED_OAK_WOOD_SLAB);
    public static final DeferredBlock<Block> STRIPPED_OLIVE_WOOD_VERTICAL_SLAB = verticalSlab("stripped_olive_wood_vertical_slab", ModBlocks.STRIPPED_OLIVE_WOOD_SLAB);
    public static final DeferredBlock<Block> STRIPPED_ORANGE_WOOD_VERTICAL_SLAB = verticalSlab("stripped_orange_wood_vertical_slab", ModBlocks.STRIPPED_ORANGE_WOOD_SLAB);
    public static final DeferredBlock<Block> STRIPPED_PALE_OAK_WOOD_VERTICAL_SLAB = verticalSlab("stripped_pale_oak_wood_vertical_slab", ModBlocks.STRIPPED_PALE_OAK_WOOD_SLAB);
    public static final DeferredBlock<Block> STRIPPED_PEACH_WOOD_VERTICAL_SLAB = verticalSlab("stripped_peach_wood_vertical_slab", ModBlocks.STRIPPED_PEACH_WOOD_SLAB);
    public static final DeferredBlock<Block> STRIPPED_PEAR_WOOD_VERTICAL_SLAB = verticalSlab("stripped_pear_wood_vertical_slab", ModBlocks.STRIPPED_PEAR_WOOD_SLAB);
    public static final DeferredBlock<Block> STRIPPED_PERSIMMON_WOOD_VERTICAL_SLAB = verticalSlab("stripped_persimmon_wood_vertical_slab", ModBlocks.STRIPPED_PERSIMMON_WOOD_SLAB);
    public static final DeferredBlock<Block> STRIPPED_PINE_WOOD_VERTICAL_SLAB = verticalSlab("stripped_pine_wood_vertical_slab", ModBlocks.STRIPPED_PINE_WOOD_SLAB);
    public static final DeferredBlock<Block> STRIPPED_PINK_IVORY_WOOD_VERTICAL_SLAB = verticalSlab("stripped_pink_ivory_wood_vertical_slab", ModBlocks.STRIPPED_PINK_IVORY_WOOD_SLAB);
    public static final DeferredBlock<Block> STRIPPED_PLUM_WOOD_VERTICAL_SLAB = verticalSlab("stripped_plum_wood_vertical_slab", ModBlocks.STRIPPED_PLUM_WOOD_SLAB);
    public static final DeferredBlock<Block> STRIPPED_POMEGRANATE_WOOD_VERTICAL_SLAB = verticalSlab("stripped_pomegranate_wood_vertical_slab", ModBlocks.STRIPPED_POMEGRANATE_WOOD_SLAB);
    public static final DeferredBlock<Block> STRIPPED_PRUNE_WOOD_VERTICAL_SLAB = verticalSlab("stripped_prune_wood_vertical_slab", ModBlocks.STRIPPED_PRUNE_WOOD_SLAB);
    public static final DeferredBlock<Block> STRIPPED_PURPLEHEART_WOOD_VERTICAL_SLAB = verticalSlab("stripped_purpleheart_wood_vertical_slab", ModBlocks.STRIPPED_PURPLEHEART_WOOD_SLAB);
    public static final DeferredBlock<Block> STRIPPED_RED_CHERRY_WOOD_VERTICAL_SLAB = verticalSlab("stripped_red_cherry_wood_vertical_slab", ModBlocks.STRIPPED_RED_CHERRY_WOOD_SLAB);
    public static final DeferredBlock<Block> STRIPPED_REDWOOD_WOOD_VERTICAL_SLAB = verticalSlab("stripped_redwood_wood_vertical_slab", ModBlocks.STRIPPED_REDWOOD_WOOD_SLAB);
    public static final DeferredBlock<Block> STRIPPED_SANDALWOOD_WOOD_VERTICAL_SLAB = verticalSlab("stripped_sandalwood_wood_vertical_slab", ModBlocks.STRIPPED_SANDALWOOD_WOOD_SLAB);
    public static final DeferredBlock<Block> STRIPPED_SANDBEGGAR_WOOD_VERTICAL_SLAB = verticalSlab("stripped_sandbeggar_wood_vertical_slab", ModBlocks.STRIPPED_SANDBEGGAR_WOOD_SLAB);
    public static final DeferredBlock<Block> STRIPPED_SENTINAL_WOOD_VERTICAL_SLAB = verticalSlab("stripped_sentinal_wood_vertical_slab", ModBlocks.STRIPPED_SENTINAL_WOOD_SLAB);
    public static final DeferredBlock<Block> STRIPPED_SOLDIER_PINE_WOOD_VERTICAL_SLAB = verticalSlab("stripped_soldier_pine_wood_vertical_slab", ModBlocks.STRIPPED_SOLDIER_PINE_WOOD_SLAB);
    public static final DeferredBlock<Block> STRIPPED_SPRUCE_WOOD_VERTICAL_SLAB = verticalSlab("stripped_spruce_wood_vertical_slab", ModBlocks.STRIPPED_SPRUCE_WOOD_SLAB);
    public static final DeferredBlock<Block> STRIPPED_TIGERWOOD_WOOD_VERTICAL_SLAB = verticalSlab("stripped_tigerwood_wood_vertical_slab", ModBlocks.STRIPPED_TIGERWOOD_WOOD_SLAB);
    public static final DeferredBlock<Block> STRIPPED_WEIRWOOD_WOOD_VERTICAL_SLAB = verticalSlab("stripped_weirwood_wood_vertical_slab", ModBlocks.STRIPPED_WEIRWOOD_WOOD_SLAB);
    public static final DeferredBlock<Block> STRIPPED_WHITE_CHERRY_WOOD_VERTICAL_SLAB = verticalSlab("stripped_white_cherry_wood_vertical_slab", ModBlocks.STRIPPED_WHITE_CHERRY_WOOD_SLAB);
    public static final DeferredBlock<Block> STRIPPED_WILLOW_WOOD_VERTICAL_SLAB = verticalSlab("stripped_willow_wood_vertical_slab", ModBlocks.STRIPPED_WILLOW_WOOD_SLAB);
    public static final DeferredBlock<Block> STRIPPED_WORMTREE_WOOD_VERTICAL_SLAB = verticalSlab("stripped_wormtree_wood_vertical_slab", ModBlocks.STRIPPED_WORMTREE_WOOD_SLAB);
    public static final DeferredBlock<Block> TIGERWOOD_ROOFING_VERTICAL_SLAB = verticalSlab("tigerwood_roofing_vertical_slab", ModBlocks.TIGERWOOD_ROOFING_SLAB);
    public static final DeferredBlock<Block> TIGERWOOD_VERTICAL_SLAB = verticalSlab("tigerwood_vertical_slab", ModBlocks.TIGERWOOD_SLAB);
    public static final DeferredBlock<Block> TIGERWOOD_WOOD_VERTICAL_SLAB = verticalSlab("tigerwood_wood_vertical_slab", ModBlocks.TIGERWOOD_WOOD_SLAB);
    public static final DeferredBlock<Block> WEIRWOOD_ROOFING_VERTICAL_SLAB = verticalSlab("weirwood_roofing_vertical_slab", ModBlocks.WEIRWOOD_ROOFING_SLAB);
    public static final DeferredBlock<Block> WEIRWOOD_VERTICAL_SLAB = verticalSlab("weirwood_vertical_slab", ModBlocks.WEIRWOOD_SLAB);
    public static final DeferredBlock<Block> WEIRWOOD_WOOD_VERTICAL_SLAB = verticalSlab("weirwood_wood_vertical_slab", ModBlocks.WEIRWOOD_WOOD_SLAB);
    public static final DeferredBlock<Block> WHITE_CHERRY_ROOFING_VERTICAL_SLAB = verticalSlab("white_cherry_roofing_vertical_slab", ModBlocks.WHITE_CHERRY_ROOFING_SLAB);
    public static final DeferredBlock<Block> WHITE_CHERRY_VERTICAL_SLAB = verticalSlab("white_cherry_vertical_slab", ModBlocks.WHITE_CHERRY_SLAB);
    public static final DeferredBlock<Block> WHITE_CHERRY_WOOD_VERTICAL_SLAB = verticalSlab("white_cherry_wood_vertical_slab", ModBlocks.WHITE_CHERRY_WOOD_SLAB);
    public static final DeferredBlock<Block> WHITE_WOOL_VERTICAL_SLAB = verticalSlab("white_wool_vertical_slab", ModBlocks.WHITE_WOOL_SLAB);
    public static final DeferredBlock<Block> WILLOW_ROOFING_VERTICAL_SLAB = verticalSlab("willow_roofing_vertical_slab", ModBlocks.WILLOW_ROOFING_SLAB);
    public static final DeferredBlock<Block> WILLOW_VERTICAL_SLAB = verticalSlab("willow_vertical_slab", ModBlocks.WILLOW_SLAB);
    public static final DeferredBlock<Block> WILLOW_WOOD_VERTICAL_SLAB = verticalSlab("willow_wood_vertical_slab", ModBlocks.WILLOW_WOOD_SLAB);
    public static final DeferredBlock<Block> WORMTREE_ROOFING_VERTICAL_SLAB = verticalSlab("wormtree_roofing_vertical_slab", ModBlocks.WORMTREE_ROOFING_SLAB);
    public static final DeferredBlock<Block> WORMTREE_VERTICAL_SLAB = verticalSlab("wormtree_vertical_slab", ModBlocks.WORMTREE_SLAB);
    public static final DeferredBlock<Block> WORMTREE_WOOD_VERTICAL_SLAB = verticalSlab("wormtree_wood_vertical_slab", ModBlocks.WORMTREE_WOOD_SLAB);
    public static final DeferredBlock<Block> YELLOW_WOOL_VERTICAL_SLAB = verticalSlab("yellow_wool_vertical_slab", ModBlocks.YELLOW_WOOL_SLAB);
