    ...
    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> GOT_BUILDING =
            REGISTRY.register("got_building", () -> CreativeModeTab.builder()
                    ...
                    .displayItems((params, output) -> {
                        ...
                        safeAccept(output, GotModItems.WEIRWOOD_SIGN.get());
                        safeAccept(output, GotModItems.WEIRWOOD_HANGING_SIGN.get());
                        safeAccept(output, GotModItems.WEIRWOOD_BOAT.get());
                        safeAccept(output, GotModItems.WEIRWOOD_CHEST_BOAT.get());
                        safeAccept(output, GotModItems.ASPEN_SIGN.get());
                        safeAccept(output, GotModItems.ASPEN_HANGING_SIGN.get());
                        safeAccept(output, GotModItems.ASPEN_BOAT.get());
                        safeAccept(output, GotModItems.ASPEN_CHEST_BOAT.get());
                        safeAccept(output, GotModItems.ALDER_SIGN.get());
                        safeAccept(output, GotModItems.ALDER_HANGING_SIGN.get());
                        safeAccept(output, GotModItems.ALDER_BOAT.get());
                        safeAccept(output, GotModItems.ALDER_CHEST_BOAT.get());
                        safeAccept(output, GotModItems.PINE_SIGN.get());
                        safeAccept(output, GotModItems.PINE_HANGING_SIGN.get());
                        safeAccept(output, GotModItems.PINE_BOAT.get());
                        safeAccept(output, GotModItems.PINE_CHEST_BOAT.get());
                        safeAccept(output, GotModItems.FIR_SIGN.get());
                        safeAccept(output, GotModItems.FIR_HANGING_SIGN.get());
                        safeAccept(output, GotModItems.FIR_BOAT.get());
                        safeAccept(output, GotModItems.FIR_CHEST_BOAT.get());
                        safeAccept(output, GotModItems.SENTINAL_SIGN.get());
                        safeAccept(output, GotModItems.SENTINAL_HANGING_SIGN.get());
                        safeAccept(output, GotModItems.SENTINAL_BOAT.get());
                        safeAccept(output, GotModItems.SENTINAL_CHEST_BOAT.get());
                        safeAccept(output, GotModItems.IRONWOOD_SIGN.get());
                        safeAccept(output, GotModItems.IRONWOOD_HANGING_SIGN.get());
                        safeAccept(output, GotModItems.IRONWOOD_BOAT.get());
                        safeAccept(output, GotModItems.IRONWOOD_CHEST_BOAT.get());
                        safeAccept(output, GotModItems.BEECH_SIGN.get());
                        safeAccept(output, GotModItems.BEECH_HANGING_SIGN.get());
                        safeAccept(output, GotModItems.BEECH_BOAT.get());
                        safeAccept(output, GotModItems.BEECH_CHEST_BOAT.get());
                        safeAccept(output, GotModItems.SOLDIER_PINE_SIGN.get());
                        safeAccept(output, GotModItems.SOLDIER_PINE_HANGING_SIGN.get());
                        safeAccept(output, GotModItems.SOLDIER_PINE_BOAT.get());
                        safeAccept(output, GotModItems.SOLDIER_PINE_CHEST_BOAT.get());
                        safeAccept(output, GotModItems.ASH_SIGN.get());
                        safeAccept(output, GotModItems.ASH_HANGING_SIGN.get());
                        safeAccept(output, GotModItems.ASH_BOAT.get());
                        safeAccept(output, GotModItems.ASH_CHEST_BOAT.get());
                        safeAccept(output, GotModItems.HAWTHORN_SIGN.get());
                        safeAccept(output, GotModItems.HAWTHORN_HANGING_SIGN.get());
                        safeAccept(output, GotModItems.HAWTHORN_BOAT.get());
                        safeAccept(output, GotModItems.HAWTHORN_CHEST_BOAT.get());
                        safeAccept(output, GotModItems.BLACKBARK_SIGN.get());
                        safeAccept(output, GotModItems.BLACKBARK_HANGING_SIGN.get());
                        safeAccept(output, GotModItems.BLACKBARK_BOAT.get());
                        safeAccept(output, GotModItems.BLACKBARK_CHEST_BOAT.get());
                        safeAccept(output, GotModItems.BLOODWOOD_SIGN.get());
                        safeAccept(output, GotModItems.BLOODWOOD_HANGING_SIGN.get());
                        safeAccept(output, GotModItems.BLOODWOOD_BOAT.get());
                        safeAccept(output, GotModItems.BLOODWOOD_CHEST_BOAT.get());
                        safeAccept(output, GotModItems.BLUE_MAHOE_SIGN.get());
                        safeAccept(output, GotModItems.BLUE_MAHOE_HANGING_SIGN.get());
                        safeAccept(output, GotModItems.BLUE_MAHOE_BOAT.get());
                        safeAccept(output, GotModItems.BLUE_MAHOE_CHEST_BOAT.get());
                        safeAccept(output, GotModItems.COTTONWOOD_SIGN.get());
                        safeAccept(output, GotModItems.COTTONWOOD_HANGING_SIGN.get());
                        safeAccept(output, GotModItems.COTTONWOOD_BOAT.get());
                        safeAccept(output, GotModItems.COTTONWOOD_CHEST_BOAT.get());
                        safeAccept(output, GotModItems.BLACK_COTTONWOOD_SIGN.get());
                        safeAccept(output, GotModItems.BLACK_COTTONWOOD_HANGING_SIGN.get());
                        safeAccept(output, GotModItems.BLACK_COTTONWOOD_BOAT.get());
                        safeAccept(output, GotModItems.BLACK_COTTONWOOD_CHEST_BOAT.get());
                        safeAccept(output, GotModItems.CINNAMON_SIGN.get());
                        safeAccept(output, GotModItems.CINNAMON_HANGING_SIGN.get());
                        safeAccept(output, GotModItems.CINNAMON_BOAT.get());
                        safeAccept(output, GotModItems.CINNAMON_CHEST_BOAT.get());
                        safeAccept(output, GotModItems.CLOVE_SIGN.get());
                        safeAccept(output, GotModItems.CLOVE_HANGING_SIGN.get());
                        safeAccept(output, GotModItems.CLOVE_BOAT.get());
                        safeAccept(output, GotModItems.CLOVE_CHEST_BOAT.get());
                        safeAccept(output, GotModItems.EBONY_SIGN.get());
                        safeAccept(output, GotModItems.EBONY_HANGING_SIGN.get());
                        safeAccept(output, GotModItems.EBONY_BOAT.get());
                        safeAccept(output, GotModItems.EBONY_CHEST_BOAT.get());
                        safeAccept(output, GotModItems.ELM_SIGN.get());
                        safeAccept(output, GotModItems.ELM_HANGING_SIGN.get());
                        safeAccept(output, GotModItems.ELM_BOAT.get());
                        safeAccept(output, GotModItems.ELM_CHEST_BOAT.get());
                        safeAccept(output, GotModItems.CEDAR_SIGN.get());
                        safeAccept(output, GotModItems.CEDAR_HANGING_SIGN.get());
                        safeAccept(output, GotModItems.CEDAR_BOAT.get());
                        safeAccept(output, GotModItems.CEDAR_CHEST_BOAT.get());
                        safeAccept(output, GotModItems.APPLE_SIGN.get());
                        safeAccept(output, GotModItems.APPLE_HANGING_SIGN.get());
                        safeAccept(output, GotModItems.APPLE_BOAT.get());
                        safeAccept(output, GotModItems.APPLE_CHEST_BOAT.get());
                        safeAccept(output, GotModItems.GOLDENHEART_SIGN.get());
                        safeAccept(output, GotModItems.GOLDENHEART_HANGING_SIGN.get());
                        safeAccept(output, GotModItems.GOLDENHEART_BOAT.get());
                        safeAccept(output, GotModItems.GOLDENHEART_CHEST_BOAT.get());
                        safeAccept(output, GotModItems.LINDEN_SIGN.get());
                        safeAccept(output, GotModItems.LINDEN_HANGING_SIGN.get());
                        safeAccept(output, GotModItems.LINDEN_BOAT.get());
                        safeAccept(output, GotModItems.LINDEN_CHEST_BOAT.get());
                        safeAccept(output, GotModItems.MAHOGANY_SIGN.get());
                        safeAccept(output, GotModItems.MAHOGANY_HANGING_SIGN.get());
                        safeAccept(output, GotModItems.MAHOGANY_BOAT.get());
                        safeAccept(output, GotModItems.MAHOGANY_CHEST_BOAT.get());
                        safeAccept(output, GotModItems.MAPLE_SIGN.get());
                        safeAccept(output, GotModItems.MAPLE_HANGING_SIGN.get());
                        safeAccept(output, GotModItems.MAPLE_BOAT.get());
                        safeAccept(output, GotModItems.MAPLE_CHEST_BOAT.get());
                        safeAccept(output, GotModItems.MYRRH_SIGN.get());
                        safeAccept(output, GotModItems.MYRRH_HANGING_SIGN.get());
                        safeAccept(output, GotModItems.MYRRH_BOAT.get());
                        safeAccept(output, GotModItems.MYRRH_CHEST_BOAT.get());
                        safeAccept(output, GotModItems.REDWOOD_SIGN.get());
                        safeAccept(output, GotModItems.REDWOOD_HANGING_SIGN.get());
                        safeAccept(output, GotModItems.REDWOOD_BOAT.get());
                        safeAccept(output, GotModItems.REDWOOD_CHEST_BOAT.get());
                        safeAccept(output, GotModItems.CHESTNUT_SIGN.get());
                        safeAccept(output, GotModItems.CHESTNUT_HANGING_SIGN.get());
                        safeAccept(output, GotModItems.CHESTNUT_BOAT.get());
                        safeAccept(output, GotModItems.CHESTNUT_CHEST_BOAT.get());
                        safeAccept(output, GotModItems.WILLOW_SIGN.get());
                        safeAccept(output, GotModItems.WILLOW_HANGING_SIGN.get());
                        safeAccept(output, GotModItems.WILLOW_BOAT.get());
                        safeAccept(output, GotModItems.WILLOW_CHEST_BOAT.get());
                        safeAccept(output, GotModItems.WORMTREE_SIGN.get());
                        safeAccept(output, GotModItems.WORMTREE_HANGING_SIGN.get());
                        ...
                        safeAccept(output, GotModBlocks.SMOOTH_GRANITE_ROCK.get());
                        ...
                        safeAccept(output, GotModBlocks.SMOOTH_GRANITE_ROCK_SLAB.get());
                        safeAccept(output, GotModBlocks.SMOOTH_GRANITE_ROCK_STAIRS.get());
                        safeAccept(output, GotModBlocks.SMOOTH_GRANITE_ROCK_WALL.get());
                        // ── Limestone ──────────────────────────────────────────────────────
                        safeAccept(output, GotModBlocks.LIMESTONE_ROCK.get());
