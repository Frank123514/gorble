    ...
    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> GOT_CARPENTRY =
            REGISTRY.register("got_carpentry", () -> CreativeModeTab.builder()
                    ...
                    .displayItems((params, output) -> {
                        ...
                        // ── Cherry ─────────────────────────────────────────────────────
                        safeAccept(output, GotModBlocks.CHERRY_LOG.get());
                        safeAccept(output, GotModBlocks.CHERRY_WOOD.get());
                        safeAccept(output, GotModBlocks.STRIPPED_CHERRY_LOG.get());
                        safeAccept(output, GotModBlocks.STRIPPED_CHERRY_WOOD.get());
                        safeAccept(output, GotModBlocks.CHERRY_PLANKS.get());
                        safeAccept(output, GotModBlocks.CHERRY_STAIRS.get());
                        safeAccept(output, GotModBlocks.CHERRY_SLAB.get());
                        safeAccept(output, GotModBlocks.CHERRY_FENCE.get());
                        safeAccept(output, GotModBlocks.CHERRY_FENCE_GATE.get());
                        safeAccept(output, GotModBlocks.CHERRY_PRESSURE_PLATE.get());
                        safeAccept(output, GotModBlocks.CHERRY_BUTTON.get());
                        safeAccept(output, GotModBlocks.CHERRY_DOOR.get());
                        safeAccept(output, GotModBlocks.CHERRY_TRAPDOOR.get());
                        safeAccept(output, GotModBlocks.CHERRY_BRANCH.get());
                        safeAccept(output, GotModBlocks.CHERRY_ROOFING.get());
                        safeAccept(output, GotModBlocks.CHERRY_ROOFING_SLAB.get());
                        safeAccept(output, GotModBlocks.CHERRY_ROOFING_STAIRS.get());
                        safeAccept(output, GotModBlocks.CHERRY_ROOFING_WALL.get());
                        safeAccept(output, Block.byItem(GotModItems.CHERRY_SIGN.get()));
                        safeAccept(output, Block.byItem(GotModItems.CHERRY_HANGING_SIGN.get()));
                        safeAccept(output, Block.byItem(GotModItems.CHERRY_BOAT.get()));
                        safeAccept(output, Block.byItem(GotModItems.CHERRY_CHEST_BOAT.get()));
    ...
    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> GOT_DECORATIVE =
            REGISTRY.register("got_decorative", () -> CreativeModeTab.builder()
                    ...
                    .displayItems((params, output) -> {
                        ...
                        safeAccept(output, GotModBlocks.CHERRY_LEAVES.get());
                        ...
                        safeAccept(output, GotModBlocks.CHERRY_SAPLING.get());
    ...
    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> GOT_FOOD =
            REGISTRY.register("got_food", () -> CreativeModeTab.builder()
                    ...
                    .displayItems((params, output) -> {
                        ...
                        output.accept(GotModItems.CHERRY.get());
