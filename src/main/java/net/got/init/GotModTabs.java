    ...
    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> GOT_ARMORY =
            REGISTRY.register("got_armory", () -> CreativeModeTab.builder()
                    ...
                    .displayItems((params, output) -> {
                        ...
                        output.accept(GotModItems.ROUND_POMMEL.get());
                        output.accept(GotModItems.DIAMOND_POMMEL.get());
                        output.accept(GotModItems.FACETED_POMMEL.get());
                        output.accept(GotModItems.HILT.get());
                        output.accept(GotModItems.LONG_HILT.get());
                        output.accept(GotModItems.STRAIGHT_CROSSGUARD.get());
                        output.accept(GotModItems.CURVED_CROSSGUARD.get());
                        ...
                        output.accept(GotModItems.IRON_SHORTSWORD_STRAIGHT_CROSSGUARD_ROUND_POMMEL.get());
                        output.accept(GotModItems.IRON_SHORTSWORD_STRAIGHT_CROSSGUARD_DIAMOND_POMMEL.get());
                        output.accept(GotModItems.IRON_SHORTSWORD_STRAIGHT_CROSSGUARD_FACETED_POMMEL.get());
                        output.accept(GotModItems.IRON_SHORTSWORD_CURVED_CROSSGUARD_ROUND_POMMEL.get());
                        output.accept(GotModItems.IRON_SHORTSWORD_CURVED_CROSSGUARD_DIAMOND_POMMEL.get());
                        output.accept(GotModItems.IRON_SHORTSWORD_CURVED_CROSSGUARD_FACETED_POMMEL.get());
                        output.accept(GotModItems.IRON_FALCHION_STRAIGHT_CROSSGUARD_ROUND_POMMEL.get());
                        output.accept(GotModItems.IRON_FALCHION_STRAIGHT_CROSSGUARD_DIAMOND_POMMEL.get());
                        output.accept(GotModItems.IRON_FALCHION_STRAIGHT_CROSSGUARD_FACETED_POMMEL.get());
                        output.accept(GotModItems.IRON_FALCHION_CURVED_CROSSGUARD_ROUND_POMMEL.get());
                        output.accept(GotModItems.IRON_FALCHION_CURVED_CROSSGUARD_DIAMOND_POMMEL.get());
                        output.accept(GotModItems.IRON_FALCHION_CURVED_CROSSGUARD_FACETED_POMMEL.get());
                        output.accept(GotModItems.IRON_LONGSWORD_STRAIGHT_CROSSGUARD_ROUND_POMMEL.get());
                        output.accept(GotModItems.IRON_LONGSWORD_STRAIGHT_CROSSGUARD_DIAMOND_POMMEL.get());
                        output.accept(GotModItems.IRON_LONGSWORD_STRAIGHT_CROSSGUARD_FACETED_POMMEL.get());
                        output.accept(GotModItems.IRON_LONGSWORD_CURVED_CROSSGUARD_ROUND_POMMEL.get());
                        output.accept(GotModItems.IRON_LONGSWORD_CURVED_CROSSGUARD_DIAMOND_POMMEL.get());
                        output.accept(GotModItems.IRON_LONGSWORD_CURVED_CROSSGUARD_FACETED_POMMEL.get());
                        output.accept(GotModItems.IRON_BASTARD_SWORD_STRAIGHT_CROSSGUARD_ROUND_POMMEL.get());
                        output.accept(GotModItems.IRON_BASTARD_SWORD_STRAIGHT_CROSSGUARD_DIAMOND_POMMEL.get());
                        output.accept(GotModItems.IRON_BASTARD_SWORD_STRAIGHT_CROSSGUARD_FACETED_POMMEL.get());
                        output.accept(GotModItems.IRON_BASTARD_SWORD_CURVED_CROSSGUARD_ROUND_POMMEL.get());
                        output.accept(GotModItems.IRON_BASTARD_SWORD_CURVED_CROSSGUARD_DIAMOND_POMMEL.get());
                        output.accept(GotModItems.IRON_BASTARD_SWORD_CURVED_CROSSGUARD_FACETED_POMMEL.get());
                        output.accept(GotModItems.IRON_GREATSWORD_STRAIGHT_CROSSGUARD_ROUND_POMMEL.get());
                        output.accept(GotModItems.IRON_GREATSWORD_STRAIGHT_CROSSGUARD_DIAMOND_POMMEL.get());
                        output.accept(GotModItems.IRON_GREATSWORD_STRAIGHT_CROSSGUARD_FACETED_POMMEL.get());
                        output.accept(GotModItems.IRON_GREATSWORD_CURVED_CROSSGUARD_ROUND_POMMEL.get());
                        output.accept(GotModItems.IRON_GREATSWORD_CURVED_CROSSGUARD_DIAMOND_POMMEL.get());
                        output.accept(GotModItems.IRON_GREATSWORD_CURVED_CROSSGUARD_FACETED_POMMEL.get());
                        output.accept(GotModItems.IRON_CLAYMORE_SLOPED_CROSSGUARD_ROUND_POMMEL.get());
                        output.accept(GotModItems.IRON_CLAYMORE_SLOPED_CROSSGUARD_DIAMOND_POMMEL.get());
                        output.accept(GotModItems.IRON_CLAYMORE_SLOPED_CROSSGUARD_FACETED_POMMEL.get());

                        // ── Assembled Swords — Bronze ─────────────────────────────────
                        output.accept(GotModItems.BRONZE_SHORTSWORD_STRAIGHT_CROSSGUARD_ROUND_POMMEL.get());
                        output.accept(GotModItems.BRONZE_SHORTSWORD_STRAIGHT_CROSSGUARD_DIAMOND_POMMEL.get());
                        output.accept(GotModItems.BRONZE_SHORTSWORD_STRAIGHT_CROSSGUARD_FACETED_POMMEL.get());
                        output.accept(GotModItems.BRONZE_SHORTSWORD_CURVED_CROSSGUARD_ROUND_POMMEL.get());
                        output.accept(GotModItems.BRONZE_SHORTSWORD_CURVED_CROSSGUARD_DIAMOND_POMMEL.get());
                        output.accept(GotModItems.BRONZE_SHORTSWORD_CURVED_CROSSGUARD_FACETED_POMMEL.get());
                        output.accept(GotModItems.BRONZE_FALCHION_STRAIGHT_CROSSGUARD_ROUND_POMMEL.get());
                        output.accept(GotModItems.BRONZE_FALCHION_STRAIGHT_CROSSGUARD_DIAMOND_POMMEL.get());
                        output.accept(GotModItems.BRONZE_FALCHION_STRAIGHT_CROSSGUARD_FACETED_POMMEL.get());
                        output.accept(GotModItems.BRONZE_FALCHION_CURVED_CROSSGUARD_ROUND_POMMEL.get());
                        output.accept(GotModItems.BRONZE_FALCHION_CURVED_CROSSGUARD_DIAMOND_POMMEL.get());
                        output.accept(GotModItems.BRONZE_FALCHION_CURVED_CROSSGUARD_FACETED_POMMEL.get());
                        output.accept(GotModItems.BRONZE_LONGSWORD_STRAIGHT_CROSSGUARD_ROUND_POMMEL.get());
                        output.accept(GotModItems.BRONZE_LONGSWORD_STRAIGHT_CROSSGUARD_DIAMOND_POMMEL.get());
                        output.accept(GotModItems.BRONZE_LONGSWORD_STRAIGHT_CROSSGUARD_FACETED_POMMEL.get());
                        output.accept(GotModItems.BRONZE_LONGSWORD_CURVED_CROSSGUARD_ROUND_POMMEL.get());
                        output.accept(GotModItems.BRONZE_LONGSWORD_CURVED_CROSSGUARD_DIAMOND_POMMEL.get());
                        output.accept(GotModItems.BRONZE_LONGSWORD_CURVED_CROSSGUARD_FACETED_POMMEL.get());
                        output.accept(GotModItems.BRONZE_BASTARD_SWORD_STRAIGHT_CROSSGUARD_ROUND_POMMEL.get());
                        output.accept(GotModItems.BRONZE_BASTARD_SWORD_STRAIGHT_CROSSGUARD_DIAMOND_POMMEL.get());
                        output.accept(GotModItems.BRONZE_BASTARD_SWORD_STRAIGHT_CROSSGUARD_FACETED_POMMEL.get());
                        output.accept(GotModItems.BRONZE_BASTARD_SWORD_CURVED_CROSSGUARD_ROUND_POMMEL.get());
                        output.accept(GotModItems.BRONZE_BASTARD_SWORD_CURVED_CROSSGUARD_DIAMOND_POMMEL.get());
                        output.accept(GotModItems.BRONZE_BASTARD_SWORD_CURVED_CROSSGUARD_FACETED_POMMEL.get());
                        output.accept(GotModItems.BRONZE_GREATSWORD_STRAIGHT_CROSSGUARD_ROUND_POMMEL.get());
                        output.accept(GotModItems.BRONZE_GREATSWORD_STRAIGHT_CROSSGUARD_DIAMOND_POMMEL.get());
                        output.accept(GotModItems.BRONZE_GREATSWORD_STRAIGHT_CROSSGUARD_FACETED_POMMEL.get());
                        output.accept(GotModItems.BRONZE_GREATSWORD_CURVED_CROSSGUARD_ROUND_POMMEL.get());
                        output.accept(GotModItems.BRONZE_GREATSWORD_CURVED_CROSSGUARD_DIAMOND_POMMEL.get());
                        output.accept(GotModItems.BRONZE_GREATSWORD_CURVED_CROSSGUARD_FACETED_POMMEL.get());
                        output.accept(GotModItems.BRONZE_CLAYMORE_SLOPED_CROSSGUARD_ROUND_POMMEL.get());
                        output.accept(GotModItems.BRONZE_CLAYMORE_SLOPED_CROSSGUARD_DIAMOND_POMMEL.get());
                        output.accept(GotModItems.BRONZE_CLAYMORE_SLOPED_CROSSGUARD_FACETED_POMMEL.get());

                        // ── Assembled Swords — Steel ──────────────────────────────────
                        output.accept(GotModItems.STEEL_SHORTSWORD_STRAIGHT_CROSSGUARD_ROUND_POMMEL.get());
                        output.accept(GotModItems.STEEL_SHORTSWORD_STRAIGHT_CROSSGUARD_DIAMOND_POMMEL.get());
                        output.accept(GotModItems.STEEL_SHORTSWORD_STRAIGHT_CROSSGUARD_FACETED_POMMEL.get());
                        output.accept(GotModItems.STEEL_SHORTSWORD_CURVED_CROSSGUARD_ROUND_POMMEL.get());
                        output.accept(GotModItems.STEEL_SHORTSWORD_CURVED_CROSSGUARD_DIAMOND_POMMEL.get());
                        output.accept(GotModItems.STEEL_SHORTSWORD_CURVED_CROSSGUARD_FACETED_POMMEL.get());
                        output.accept(GotModItems.STEEL_FALCHION_STRAIGHT_CROSSGUARD_ROUND_POMMEL.get());
                        output.accept(GotModItems.STEEL_FALCHION_STRAIGHT_CROSSGUARD_DIAMOND_POMMEL.get());
                        output.accept(GotModItems.STEEL_FALCHION_STRAIGHT_CROSSGUARD_FACETED_POMMEL.get());
                        output.accept(GotModItems.STEEL_FALCHION_CURVED_CROSSGUARD_ROUND_POMMEL.get());
                        output.accept(GotModItems.STEEL_FALCHION_CURVED_CROSSGUARD_DIAMOND_POMMEL.get());
                        output.accept(GotModItems.STEEL_FALCHION_CURVED_CROSSGUARD_FACETED_POMMEL.get());
                        output.accept(GotModItems.STEEL_LONGSWORD_STRAIGHT_CROSSGUARD_ROUND_POMMEL.get());
                        output.accept(GotModItems.STEEL_LONGSWORD_STRAIGHT_CROSSGUARD_DIAMOND_POMMEL.get());
                        output.accept(GotModItems.STEEL_LONGSWORD_STRAIGHT_CROSSGUARD_FACETED_POMMEL.get());
                        output.accept(GotModItems.STEEL_LONGSWORD_CURVED_CROSSGUARD_ROUND_POMMEL.get());
                        output.accept(GotModItems.STEEL_LONGSWORD_CURVED_CROSSGUARD_DIAMOND_POMMEL.get());
                        output.accept(GotModItems.STEEL_LONGSWORD_CURVED_CROSSGUARD_FACETED_POMMEL.get());
                        output.accept(GotModItems.STEEL_BASTARD_SWORD_STRAIGHT_CROSSGUARD_ROUND_POMMEL.get());
                        output.accept(GotModItems.STEEL_BASTARD_SWORD_STRAIGHT_CROSSGUARD_DIAMOND_POMMEL.get());
                        output.accept(GotModItems.STEEL_BASTARD_SWORD_STRAIGHT_CROSSGUARD_FACETED_POMMEL.get());
                        output.accept(GotModItems.STEEL_BASTARD_SWORD_CURVED_CROSSGUARD_ROUND_POMMEL.get());
                        output.accept(GotModItems.STEEL_BASTARD_SWORD_CURVED_CROSSGUARD_DIAMOND_POMMEL.get());
                        output.accept(GotModItems.STEEL_BASTARD_SWORD_CURVED_CROSSGUARD_FACETED_POMMEL.get());
                        output.accept(GotModItems.STEEL_GREATSWORD_STRAIGHT_CROSSGUARD_ROUND_POMMEL.get());
                        output.accept(GotModItems.STEEL_GREATSWORD_STRAIGHT_CROSSGUARD_DIAMOND_POMMEL.get());
                        output.accept(GotModItems.STEEL_GREATSWORD_STRAIGHT_CROSSGUARD_FACETED_POMMEL.get());
                        output.accept(GotModItems.STEEL_GREATSWORD_CURVED_CROSSGUARD_ROUND_POMMEL.get());
                        output.accept(GotModItems.STEEL_GREATSWORD_CURVED_CROSSGUARD_DIAMOND_POMMEL.get());
                        output.accept(GotModItems.STEEL_GREATSWORD_CURVED_CROSSGUARD_FACETED_POMMEL.get());
                        output.accept(GotModItems.STEEL_CLAYMORE_SLOPED_CROSSGUARD_ROUND_POMMEL.get());
                        output.accept(GotModItems.STEEL_CLAYMORE_SLOPED_CROSSGUARD_DIAMOND_POMMEL.get());
                        output.accept(GotModItems.STEEL_CLAYMORE_SLOPED_CROSSGUARD_FACETED_POMMEL.get());
