...
public static final WoodType NIGHTWOOD            = WoodType.register(new WoodType(GotMod.MODID + ":nightwood",  BlockSetType.OAK));
    ...
    public static final WoodType RED_CHERRY               = WoodType.register(new WoodType(GotMod.MODID + ":red_cherry",  BlockSetType.OAK));
    public static final WoodType WHITE_CHERRY               = WoodType.register(new WoodType(GotMod.MODID + ":white_cherry",  BlockSetType.OAK));
    public static final WoodType BLACK_CHERRY               = WoodType.register(new WoodType(GotMod.MODID + ":black_cherry",  BlockSetType.OAK));
