...
public class GotModBoatEntities {
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<GotBoat>>      RED_CHERRY_BOAT       = boat("red_cherry", () -> net.minecraft.core.registries.BuiltInRegistries.ITEM.getValue(ResourceLocation.fromNamespaceAndPath(GotMod.MODID, "red_cherry_boat")));
    public static final DeferredHolder<EntityType<?>, EntityType<GotChestBoat>> RED_CHERRY_CHEST_BOAT = chestBoat("red_cherry", () -> net.minecraft.core.registries.BuiltInRegistries.ITEM.getValue(ResourceLocation.fromNamespaceAndPath(GotMod.MODID, "red_cherry_chest_boat")));
    public static final DeferredHolder<EntityType<?>, EntityType<GotBoat>>      WHITE_CHERRY_BOAT       = boat("white_cherry", () -> net.minecraft.core.registries.BuiltInRegistries.ITEM.getValue(ResourceLocation.fromNamespaceAndPath(GotMod.MODID, "white_cherry_boat")));
    public static final DeferredHolder<EntityType<?>, EntityType<GotChestBoat>> WHITE_CHERRY_CHEST_BOAT = chestBoat("white_cherry", () -> net.minecraft.core.registries.BuiltInRegistries.ITEM.getValue(ResourceLocation.fromNamespaceAndPath(GotMod.MODID, "white_cherry_chest_boat")));
    public static final DeferredHolder<EntityType<?>, EntityType<GotBoat>>      BLACK_CHERRY_BOAT       = boat("black_cherry", () -> net.minecraft.core.registries.BuiltInRegistries.ITEM.getValue(ResourceLocation.fromNamespaceAndPath(GotMod.MODID, "black_cherry_boat")));
    public static final DeferredHolder<EntityType<?>, EntityType<GotChestBoat>> BLACK_CHERRY_CHEST_BOAT = chestBoat("black_cherry", () -> net.minecraft.core.registries.BuiltInRegistries.ITEM.getValue(ResourceLocation.fromNamespaceAndPath(GotMod.MODID, "black_cherry_chest_boat")));
