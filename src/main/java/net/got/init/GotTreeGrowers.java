...
public static final TreeGrower NIGHTWOOD            = simple("nightwood", GotConfiguredFeatures.NIGHTWOOD);
    ...
    public static final TreeGrower RED_CHERRY               = simple("red_cherry", GotConfiguredFeatures.RED_CHERRY);
    public static final TreeGrower WHITE_CHERRY               = simple("white_cherry", GotConfiguredFeatures.WHITE_CHERRY);
    public static final TreeGrower BLACK_CHERRY               = simple("black_cherry", GotConfiguredFeatures.BLACK_CHERRY);
