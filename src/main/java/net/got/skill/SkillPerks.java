...
public final class SkillPerks {
    ...
    private static final Map<Skill, List<SkillPerk>> BY_SKILL = new LinkedHashMap<>();
    private static final Map<String, SkillPerk> BY_ID = new LinkedHashMap<>();

    private static void def(Skill skill, int tier, String id, String name, String description,
    ...
    static {
        ...
        def(Skill.COOKING, 1, "cooking_efficient_cook", "Efficient Cook",
                "You waste less over the fire. 10% chance of an extra dish when cooking finishes.",
                15, PerkEffectType.BONUS_DROP_CHANCE, 0.10);
        def(Skill.COOKING, 2, "cooking_seasoned_chef", "Seasoned Chef",
                "A practiced hand with the spit and pot. 15% chance of an extra dish.",
                40, PerkEffectType.BONUS_DROP_CHANCE, 0.15);
        def(Skill.COOKING, 3, "cooking_master_chef", "Master Chef",
                "Renowned even in a lord's kitchens. +25% Cooking XP gained.",
                75, PerkEffectType.XP_GAIN_MULT, 0.25);
    }

    public static List<SkillPerk> forSkill(Skill skill) {
