...
/**
 * Pine trunk with regular dead-branch stubs to mimic old-growth conifers.
 */
public class GotPineTrunkPlacer extends TrunkPlacer {

    public static final MapCodec<GotPineTrunkPlacer> CODEC = RecordCodecBuilder.mapCodec(instance ->
            trunkPlacerParts(instance).apply(instance, GotPineTrunkPlacer::new));

    public GotPineTrunkPlacer(int baseHeight, int heightRandA, int heightRandB) {
        super(baseHeight, heightRandA, heightRandB);
    }

    @Override
    protected TrunkPlacerType<?> type() {
        return GotTreePlacers.GOT_PINE_TRUNK_PLACER.get();
    }
