package net.got.entity.npc.levy.martell;
...
/** Tier-2 Levy conscript of House Martell. */
public class MartellLevyEntity extends LevyEntity {
    ...
    public static final ResourceLocation[] MALE_TEXTURES = {
        ResourceLocation.fromNamespaceAndPath("got", "textures/entity/npc/levy/martell_levy/male_1.png")
    };
    ...
    @Override protected GotNameGenerator  getNameGenerator()  { return GotNpcNames.MARTELL_LEVY; }
