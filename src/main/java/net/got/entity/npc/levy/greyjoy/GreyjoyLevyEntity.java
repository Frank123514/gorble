package net.got.entity.npc.levy.greyjoy;
...
/** Tier-2 Levy conscript of House Greyjoy. */
public class GreyjoyLevyEntity extends LevyEntity {

    private static final GotSpawnEquipment WEAPONS = GotSpawnEquipment.of(Items.IRON_AXE, Items.STONE_AXE);

    public static final ResourceLocation[] MALE_TEXTURES = {
        ResourceLocation.fromNamespaceAndPath("got", "textures/entity/npc/levy/greyjoy_levy/male_1.png")
    };
    public static final ResourceLocation[] FEMALE_TEXTURES = MALE_TEXTURES;

    public GreyjoyLevyEntity(EntityType<? extends GreyjoyLevyEntity> type, Level level) {
        super(type, level);
    }

    @Override protected GotGenderProvider getGenderProvider() { return GotGenderProvider.MALE; }
    @Override protected GotNameGenerator  getNameGenerator()  { return GotNpcNames.GREYJOY_LEVY; }
