...
public class RiverlanderEntity extends SmallfolkEntity {
    ...
    public static final ResourceLocation[] MALE_TEXTURES   = textures("riverlander", false, 2);
    /** Female texture variants. */
    public static final ResourceLocation[] FEMALE_TEXTURES = textures("riverlander", true,  2);
