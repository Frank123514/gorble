...
/** Tier-1 civilian NPC — WestermanEntity. */
public class WestermanEntity extends SmallfolkEntity {
    ...
    /** Male texture variants — westerman/generated/male_01.png ... male_12.png */
    public static final ResourceLocation[] MALE_TEXTURES   = textures("westerman", false, MALE_VARIANT_COUNT);
    /** Female texture variants — westerman/generated/female_01.png ... female_12.png */
    public static final ResourceLocation[] FEMALE_TEXTURES = textures("westerman", true,  FEMALE_VARIANT_COUNT);
    ...
    public WestermanEntity(EntityType<? extends WestermanEntity> type, Level level) {
        super(type, level);
    }
    ...
    @Override
    protected GotNameGenerator getNameGenerator() { return GotNpcNames.WESTERMAN; }
