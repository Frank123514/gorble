 ...
 * generated from brown_bear.bbmodel via Blockbench 5.1.4 (Minecraft 1.17+, Mojang mappings).
 *
 * <p>Animations are driven by {@link GotBrownBearAnimations} via
 * {@link #applyAnimation}, called each frame from {@link GotBrownBearRenderer}.
 */
public class GotBrownBearModel extends EntityModel<GotBrownBearRenderState> {
