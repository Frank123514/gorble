...
public final class GotGiantAnimations {
    ...
    // ── MOUNT — heave up onto the mammoth's back (1.5 s, one-shot) ───────────
    public static final AnimationDefinition MOUNT =
            AnimationDefinition.Builder.withLength(1.5F)
                    ...
                    // head X = Blockbench value + 20 neck offset
                    .addAnimation("head", new AnimationChannel(AnimationChannel.Targets.ROTATION,
                            new Keyframe(0.0F, KeyframeAnimations.degreeVec(20.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
    ...
    // ── RIDE_IDLE — seated on mammoth, stationary (2.0 s, looping) ───────────
    ...
    // ── RIDE_MOVING — bouncing on the mammoth mid-stride (1.0 s, looping) ────
