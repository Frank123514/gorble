...
public final class SnowMeltHandler {
    ...
    /**
     * Returns the biome temperature adjusted for the current season,
     * mirroring BiomeMixin's temperature adjustment logic.
     */
    private static float getSeasonalBiomeTemp(ServerLevel level, GotSeason season,
        ...
        if (biome.getBaseTemperature() > 0.8f) return base; // hot biomes unaffected
