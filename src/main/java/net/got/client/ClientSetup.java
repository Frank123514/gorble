...
import net.got.event.entity.client.brownbear.GotBrownBearModel;
import net.got.event.entity.client.brownbear.GotBrownBearRenderer;
import net.got.event.entity.client.giant.GotGiantModel;
import net.got.event.entity.client.giant.GotGiantRenderer;
import net.got.event.entity.client.model.GotModelLayers;
import net.got.event.entity.client.npc.smallfolk.GotSmallfolkModel;
import net.got.event.entity.client.stag.GotStagModel;
import net.got.event.entity.client.heron.GotHeronModel;
import net.got.event.entity.client.heron.GotHeronRenderer;
import net.got.event.entity.client.direwolf.GotDirewolfModel;
import net.got.event.entity.client.direwolf.GotDirewolfRenderer;
import net.got.event.entity.client.crow.GotCrowModel;
import net.got.event.entity.client.crow.GotCrowRenderer;
import net.got.event.entity.client.mammoth.GotMammothModel;
import net.got.event.entity.client.mammoth.GotMammothRenderer;
...
import net.got.event.entity.client.stag.GotStagRenderer;
import net.got.init.*;
...
public final class ClientSetup {
    ...
    public static void clientSetup(FMLClientSetupEvent event) {
        event.enqueueWork(() -> {
            ...
            // ── Doors ────────────────────────────────────────────────────
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(GotModBlocks.WEIRWOOD_DOOR.get(),           ChunkSectionLayer.CUTOUT);
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(GotModBlocks.ASPEN_DOOR.get(),              ChunkSectionLayer.CUTOUT);
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(GotModBlocks.NIGHTWOOD_DOOR.get(),     ChunkSectionLayer.CUTOUT);
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(GotModBlocks.NIGHTWOOD_TRAPDOOR.get(), ChunkSectionLayer.CUTOUT);
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(GotModBlocks.PURPLEHEART_DOOR.get(),     ChunkSectionLayer.CUTOUT);
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(GotModBlocks.PURPLEHEART_TRAPDOOR.get(), ChunkSectionLayer.CUTOUT);
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(GotModBlocks.TIGERWOOD_DOOR.get(),     ChunkSectionLayer.CUTOUT);
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(GotModBlocks.TIGERWOOD_TRAPDOOR.get(), ChunkSectionLayer.CUTOUT);
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(GotModBlocks.SANDALWOOD_DOOR.get(),     ChunkSectionLayer.CUTOUT);
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(GotModBlocks.SANDALWOOD_TRAPDOOR.get(), ChunkSectionLayer.CUTOUT);
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(GotModBlocks.SANDBEGGAR_DOOR.get(),     ChunkSectionLayer.CUTOUT);
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(GotModBlocks.SANDBEGGAR_TRAPDOOR.get(), ChunkSectionLayer.CUTOUT);
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(GotModBlocks.APRICOT_DOOR.get(),     ChunkSectionLayer.CUTOUT);
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(GotModBlocks.APRICOT_TRAPDOOR.get(), ChunkSectionLayer.CUTOUT);
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(GotModBlocks.BLACKTHORN_DOOR.get(),     ChunkSectionLayer.CUTOUT);
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(GotModBlocks.BLACKTHORN_TRAPDOOR.get(), ChunkSectionLayer.CUTOUT);
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(GotModBlocks.RED_CHERRY_DOOR.get(),     ChunkSectionLayer.CUTOUT);
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(GotModBlocks.RED_CHERRY_TRAPDOOR.get(), ChunkSectionLayer.CUTOUT);
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(GotModBlocks.CRABAPPLE_DOOR.get(),     ChunkSectionLayer.CUTOUT);
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(GotModBlocks.CRABAPPLE_TRAPDOOR.get(), ChunkSectionLayer.CUTOUT);
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(GotModBlocks.DATE_PALM_DOOR.get(),     ChunkSectionLayer.CUTOUT);
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(GotModBlocks.DATE_PALM_TRAPDOOR.get(), ChunkSectionLayer.CUTOUT);
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(GotModBlocks.FIG_DOOR.get(),     ChunkSectionLayer.CUTOUT);
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(GotModBlocks.FIG_TRAPDOOR.get(), ChunkSectionLayer.CUTOUT);
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(GotModBlocks.LEMON_DOOR.get(),     ChunkSectionLayer.CUTOUT);
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(GotModBlocks.LEMON_TRAPDOOR.get(), ChunkSectionLayer.CUTOUT);
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(GotModBlocks.LIME_DOOR.get(),     ChunkSectionLayer.CUTOUT);
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(GotModBlocks.LIME_TRAPDOOR.get(), ChunkSectionLayer.CUTOUT);
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(GotModBlocks.OLIVE_DOOR.get(),     ChunkSectionLayer.CUTOUT);
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(GotModBlocks.OLIVE_TRAPDOOR.get(), ChunkSectionLayer.CUTOUT);
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(GotModBlocks.ORANGE_DOOR.get(),     ChunkSectionLayer.CUTOUT);
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(GotModBlocks.ORANGE_TRAPDOOR.get(), ChunkSectionLayer.CUTOUT);
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(GotModBlocks.PEACH_DOOR.get(),     ChunkSectionLayer.CUTOUT);
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(GotModBlocks.PEACH_TRAPDOOR.get(), ChunkSectionLayer.CUTOUT);
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(GotModBlocks.PEAR_DOOR.get(),     ChunkSectionLayer.CUTOUT);
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(GotModBlocks.PEAR_TRAPDOOR.get(), ChunkSectionLayer.CUTOUT);
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(GotModBlocks.PERSIMMON_DOOR.get(),     ChunkSectionLayer.CUTOUT);
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(GotModBlocks.PERSIMMON_TRAPDOOR.get(), ChunkSectionLayer.CUTOUT);
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(GotModBlocks.PINK_IVORY_DOOR.get(),     ChunkSectionLayer.CUTOUT);
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(GotModBlocks.PINK_IVORY_TRAPDOOR.get(), ChunkSectionLayer.CUTOUT);
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(GotModBlocks.PLUM_DOOR.get(),     ChunkSectionLayer.CUTOUT);
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(GotModBlocks.PLUM_TRAPDOOR.get(), ChunkSectionLayer.CUTOUT);
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(GotModBlocks.POMEGRANATE_DOOR.get(),     ChunkSectionLayer.CUTOUT);
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(GotModBlocks.POMEGRANATE_TRAPDOOR.get(), ChunkSectionLayer.CUTOUT);
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(GotModBlocks.PRUNE_DOOR.get(),     ChunkSectionLayer.CUTOUT);
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(GotModBlocks.PRUNE_TRAPDOOR.get(), ChunkSectionLayer.CUTOUT);
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(GotModBlocks.ALMOND_DOOR.get(),     ChunkSectionLayer.CUTOUT);
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(GotModBlocks.ALMOND_TRAPDOOR.get(), ChunkSectionLayer.CUTOUT);
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(GotModBlocks.NUTMEG_DOOR.get(),     ChunkSectionLayer.CUTOUT);
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(GotModBlocks.NUTMEG_TRAPDOOR.get(), ChunkSectionLayer.CUTOUT);
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(GotModBlocks.HEMLOCK_DOOR.get(),     ChunkSectionLayer.CUTOUT);
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(GotModBlocks.HEMLOCK_TRAPDOOR.get(), ChunkSectionLayer.CUTOUT);

            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(GotModBlocks.ALDER_DOOR.get(),              ChunkSectionLayer.CUTOUT);
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(GotModBlocks.PINE_DOOR.get(),               ChunkSectionLayer.CUTOUT);
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(GotModBlocks.FIR_DOOR.get(),                ChunkSectionLayer.CUTOUT);
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(GotModBlocks.SENTINAL_DOOR.get(),           ChunkSectionLayer.CUTOUT);
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(GotModBlocks.IRONWOOD_DOOR.get(),           ChunkSectionLayer.CUTOUT);
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(GotModBlocks.BEECH_DOOR.get(),              ChunkSectionLayer.CUTOUT);
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(GotModBlocks.SOLDIER_PINE_DOOR.get(),       ChunkSectionLayer.CUTOUT);
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(GotModBlocks.ASH_DOOR.get(),                ChunkSectionLayer.CUTOUT);
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(GotModBlocks.HAWTHORN_DOOR.get(),           ChunkSectionLayer.CUTOUT);
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(GotModBlocks.BLACKBARK_DOOR.get(),          ChunkSectionLayer.CUTOUT);
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(GotModBlocks.BLOODWOOD_DOOR.get(),          ChunkSectionLayer.CUTOUT);
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(GotModBlocks.BLUE_MAHOE_DOOR.get(),         ChunkSectionLayer.CUTOUT);
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(GotModBlocks.COTTONWOOD_DOOR.get(),         ChunkSectionLayer.CUTOUT);
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(GotModBlocks.BLACK_COTTONWOOD_DOOR.get(),   ChunkSectionLayer.CUTOUT);
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(GotModBlocks.CINNAMON_DOOR.get(),           ChunkSectionLayer.CUTOUT);
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(GotModBlocks.CLOVE_DOOR.get(),              ChunkSectionLayer.CUTOUT);
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(GotModBlocks.EBONY_DOOR.get(),              ChunkSectionLayer.CUTOUT);
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(GotModBlocks.ELM_DOOR.get(),                ChunkSectionLayer.CUTOUT);
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(GotModBlocks.CEDAR_DOOR.get(),              ChunkSectionLayer.CUTOUT);
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(GotModBlocks.APPLE_DOOR.get(),              ChunkSectionLayer.CUTOUT);
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(GotModBlocks.GOLDENHEART_DOOR.get(),        ChunkSectionLayer.CUTOUT);
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(GotModBlocks.LINDEN_DOOR.get(),             ChunkSectionLayer.CUTOUT);
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(GotModBlocks.MAHOGANY_DOOR.get(),           ChunkSectionLayer.CUTOUT);
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(GotModBlocks.MAPLE_DOOR.get(),              ChunkSectionLayer.CUTOUT);
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(GotModBlocks.MYRRH_DOOR.get(),              ChunkSectionLayer.CUTOUT);
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(GotModBlocks.REDWOOD_DOOR.get(),            ChunkSectionLayer.CUTOUT);
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(GotModBlocks.CHESTNUT_DOOR.get(),           ChunkSectionLayer.CUTOUT);
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(GotModBlocks.WILLOW_DOOR.get(),             ChunkSectionLayer.CUTOUT);
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(GotModBlocks.WORMTREE_DOOR.get(),           ChunkSectionLayer.CUTOUT);
            // ── Trapdoors ────────────────────────────────────────────────
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(GotModBlocks.WEIRWOOD_TRAPDOOR.get(),           ChunkSectionLayer.CUTOUT);
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(GotModBlocks.ASPEN_TRAPDOOR.get(),              ChunkSectionLayer.CUTOUT);
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(GotModBlocks.ALDER_TRAPDOOR.get(),              ChunkSectionLayer.CUTOUT);
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(GotModBlocks.PINE_TRAPDOOR.get(),               ChunkSectionLayer.CUTOUT);
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(GotModBlocks.FIR_TRAPDOOR.get(),                ChunkSectionLayer.CUTOUT);
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(GotModBlocks.SENTINAL_TRAPDOOR.get(),           ChunkSectionLayer.CUTOUT);
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(GotModBlocks.IRONWOOD_TRAPDOOR.get(),           ChunkSectionLayer.CUTOUT);
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(GotModBlocks.BEECH_TRAPDOOR.get(),              ChunkSectionLayer.CUTOUT);
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(GotModBlocks.SOLDIER_PINE_TRAPDOOR.get(),       ChunkSectionLayer.CUTOUT);
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(GotModBlocks.ASH_TRAPDOOR.get(),                ChunkSectionLayer.CUTOUT);
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(GotModBlocks.HAWTHORN_TRAPDOOR.get(),           ChunkSectionLayer.CUTOUT);
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(GotModBlocks.BLACKBARK_TRAPDOOR.get(),          ChunkSectionLayer.CUTOUT);
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(GotModBlocks.BLOODWOOD_TRAPDOOR.get(),          ChunkSectionLayer.CUTOUT);
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(GotModBlocks.BLUE_MAHOE_TRAPDOOR.get(),         ChunkSectionLayer.CUTOUT);
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(GotModBlocks.COTTONWOOD_TRAPDOOR.get(),         ChunkSectionLayer.CUTOUT);
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(GotModBlocks.BLACK_COTTONWOOD_TRAPDOOR.get(),   ChunkSectionLayer.CUTOUT);
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(GotModBlocks.CINNAMON_TRAPDOOR.get(),           ChunkSectionLayer.CUTOUT);
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(GotModBlocks.CLOVE_TRAPDOOR.get(),              ChunkSectionLayer.CUTOUT);
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(GotModBlocks.EBONY_TRAPDOOR.get(),              ChunkSectionLayer.CUTOUT);
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(GotModBlocks.ELM_TRAPDOOR.get(),                ChunkSectionLayer.CUTOUT);
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(GotModBlocks.CEDAR_TRAPDOOR.get(),              ChunkSectionLayer.CUTOUT);
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(GotModBlocks.APPLE_TRAPDOOR.get(),              ChunkSectionLayer.CUTOUT);
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(GotModBlocks.GOLDENHEART_TRAPDOOR.get(),        ChunkSectionLayer.CUTOUT);
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(GotModBlocks.LINDEN_TRAPDOOR.get(),             ChunkSectionLayer.CUTOUT);
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(GotModBlocks.MAHOGANY_TRAPDOOR.get(),           ChunkSectionLayer.CUTOUT);
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(GotModBlocks.MAPLE_TRAPDOOR.get(),              ChunkSectionLayer.CUTOUT);
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(GotModBlocks.MYRRH_TRAPDOOR.get(),              ChunkSectionLayer.CUTOUT);
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(GotModBlocks.REDWOOD_TRAPDOOR.get(),            ChunkSectionLayer.CUTOUT);
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(GotModBlocks.CHESTNUT_TRAPDOOR.get(),           ChunkSectionLayer.CUTOUT);
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(GotModBlocks.WILLOW_TRAPDOOR.get(),             ChunkSectionLayer.CUTOUT);
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(GotModBlocks.WORMTREE_TRAPDOOR.get(),           ChunkSectionLayer.CUTOUT);
        });
    }
