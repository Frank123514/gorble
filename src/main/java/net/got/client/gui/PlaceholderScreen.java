...
import net.got.client.gui.widget.PlaceholderWidget;
...
public final class PlaceholderScreen extends Screen {
    ...
    public PlaceholderScreen(MenuTab tab) {
    ...
    private void rebuildLayout() {
        ...
        resetBtnVisible = tab == MenuTab.CULTURE;
        if (resetBtnVisible) {
        ...
        addRenderableWidget(new PlaceholderWidget(
    ...
    private String cultureBodyText() {
        ...
        FactionData faction = ClientFactionCache.getFaction();
