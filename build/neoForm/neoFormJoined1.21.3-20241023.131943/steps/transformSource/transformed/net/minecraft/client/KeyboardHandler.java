            ...
            if (screen != null) {
                try {
                    if (action != 1 && action != 2) {
                        if (action == 0 && (
                            net.neoforged.neoforge.client.ClientHooks.onScreenKeyReleasedPre(screen, key, scanCode, modifiers) ||
                            screen.keyReleased(key, scanCode, modifiers) ||
                            net.neoforged.neoforge.client.ClientHooks.onScreenKeyReleasedPost(screen, key, scanCode, modifiers))
                        ) {
                            return;
                        }
                    } else {
                        ...
                        if (
                            net.neoforged.neoforge.client.ClientHooks.onScreenKeyPressedPre(screen, key, scanCode, modifiers) ||
                            screen.keyPressed(key, scanCode, modifiers) ||
                            net.neoforged.neoforge.client.ClientHooks.onScreenKeyPressedPost(screen, key, scanCode, modifiers)
                        ) {
                            return;
                        }
                    }
            ...
            if (screen != null && this.minecraft.getOverlay() == null) {
                try {
                    if (Character.isBmpCodePoint(codePoint)) {
                        if (net.neoforged.neoforge.client.ClientHooks.onScreenCharTypedPre(screen, (char)codePoint, modifiers)) return;
                        if (screen.charTyped((char)codePoint, modifiers)) return;
                        net.neoforged.neoforge.client.ClientHooks.onScreenCharTypedPost(screen, (char)codePoint, modifiers);
                    } else if (Character.isValidCodePoint(codePoint)) {
                        if (!net.neoforged.neoforge.client.ClientHooks.onScreenCharTypedPre(screen, Character.highSurrogate(codePoint), modifiers)) {
                            if (!screen.charTyped(Character.highSurrogate(codePoint), modifiers)) {
                                net.neoforged.neoforge.client.ClientHooks.onScreenCharTypedPost(screen, Character.highSurrogate(codePoint), modifiers);
                            }
                        }
                        if (!net.neoforged.neoforge.client.ClientHooks.onScreenCharTypedPre(screen, Character.lowSurrogate(codePoint), modifiers)) {
                            if (!screen.charTyped(Character.lowSurrogate(codePoint), modifiers)) {
                                net.neoforged.neoforge.client.ClientHooks.onScreenCharTypedPost(screen, Character.lowSurrogate(codePoint), modifiers);
                            }
                        }
                    }
                } catch (Throwable throwable) {
