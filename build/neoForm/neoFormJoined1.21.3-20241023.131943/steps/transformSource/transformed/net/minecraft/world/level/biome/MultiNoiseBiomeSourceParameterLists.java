...
public class MultiNoiseBiomeSourceParameterLists {
    ...
    public static void winterDrop(BootstrapContext<MultiNoiseBiomeSourceParameterList> context) {
        HolderGetter<Biome> holdergetter = context.lookup(Registries.BIOME);
        context.register(OVERWORLD, new MultiNoiseBiomeSourceParameterList(MultiNoiseBiomeSourceParameterList.Preset.OVERWORLD_WINTER_DROP, holdergetter));
    }
