...
public class BlockElement {
    ...
    public BlockElement(Vector3f from, Vector3f to, Map<Direction, BlockElementFace> faces) {
    ...
    public BlockElement(Vector3f from, Vector3f to, Map<Direction, BlockElementFace> faces, @Nullable BlockElementRotation rotation, boolean shade, int lightEmission, net.neoforged.neoforge.client.model.ExtraFaceData faceData) {
        this.from = from;
        this.to = to;
        this.faces = faces;
