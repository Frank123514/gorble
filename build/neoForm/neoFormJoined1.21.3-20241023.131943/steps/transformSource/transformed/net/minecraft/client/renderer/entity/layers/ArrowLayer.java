...
public class ArrowLayer<M extends PlayerModel> extends StuckInBodyLayer<M> {
    public ArrowLayer(LivingEntityRenderer<?, PlayerRenderState, M> renderer, EntityRendererProvider.Context context) {
        super(
            renderer,
    ...
    @Override
    protected int numStuck(PlayerRenderState renderState) {
