...
public class WinterDropBlockTagsProvider extends IntrinsicHolderTagsProvider<Block> {
    public WinterDropBlockTagsProvider(
        PackOutput output, CompletableFuture<HolderLookup.Provider> lookupProvider, CompletableFuture<TagsProvider.TagLookup<Block>> parentProvider
    ) {
        super(output, Registries.BLOCK, lookupProvider, parentProvider, p_379357_ -> p_379357_.builtInRegistryHolder().key());
    }
