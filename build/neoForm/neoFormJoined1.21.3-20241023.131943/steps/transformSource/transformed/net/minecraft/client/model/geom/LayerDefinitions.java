...
public class LayerDefinitions {
    ...
    public static Map<ModelLayerLocation, LayerDefinition> createRoots() {
        ...
        LayerDefinition layerdefinition16 = LayerDefinition.create(OcelotModel.createBodyMesh(new CubeDeformation(0.01F)), 64, 32)
            .apply(CatModel.CAT_TRANSFORMER);
        ...
        WoodType.values().forEach(p_359128_ -> {
            builder.put(ModelLayers.createStandingSignModelName(p_359128_), layerdefinition53);
