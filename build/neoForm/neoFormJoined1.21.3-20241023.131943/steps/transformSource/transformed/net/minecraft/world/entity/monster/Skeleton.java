...
public class Skeleton extends AbstractSkeleton {
    ...
    protected void doFreezeConversion() {
        ...
        this.convertTo(EntityType.STRAY, ConversionParams.single(this, true, true), p_381508_ -> {
            net.neoforged.neoforge.event.EventHooks.onLivingConvert(this, p_381508_);
            if (!this.isSilent()) {
