...
public record AdvancementRewards(int experience, List<ResourceKey<LootTable>> loot, List<ResourceKey<Recipe<?>>> recipes, Optional<CacheableFunction> function) {
    public static final Codec<AdvancementRewards> CODEC = RecordCodecBuilder.create(
        p_378756_ -> p_378756_.group(
                ...
                .apply(p_378756_, AdvancementRewards::new)
    );
    ...
    public void grant(ServerPlayer player) {
        ...
        this.function
            ...
            .ifPresent(
                p_375403_ -> minecraftserver.getFunctions()
                        .execute((CommandFunction<CommandSourceStack>)p_375403_, player.createCommandSourceStack().withSuppressedOutput().withPermission(2))
            );
    }
