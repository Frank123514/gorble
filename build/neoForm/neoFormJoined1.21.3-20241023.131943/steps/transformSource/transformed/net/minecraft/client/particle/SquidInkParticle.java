...
public class SquidInkParticle extends SimpleAnimatedParticle {
    protected SquidInkParticle(
        ...
        this.quadSize = 0.5F;
        this.setAlpha(1.0F);
        this.setColor((float)ARGB.red(packedColor), (float)ARGB.green(packedColor), (float)ARGB.blue(packedColor));
    ...
    public static class GlowInkProvider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(
            ...
            return new SquidInkParticle(
                level, x, y, z, xSpeed, ySpeed, zSpeed, ARGB.color(255, 204, 31, 102), this.sprites
            );
        }
    }
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(
            ...
            return new SquidInkParticle(
                level, x, y, z, xSpeed, ySpeed, zSpeed, ARGB.color(255, 255, 255, 255), this.sprites
            );
        }
    }
}
