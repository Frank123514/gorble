...
public class BreezeModel extends EntityModel<BreezeRenderState> {
    ...
    public void setupAnim(BreezeRenderState renderState) {
        super.setupAnim(renderState);
        this.animate(renderState.idle, BreezeAnimation.IDLE, renderState.ageInTicks);
        this.animate(renderState.shoot, BreezeAnimation.SHOOT, renderState.ageInTicks);
        this.animate(renderState.slide, BreezeAnimation.SLIDE, renderState.ageInTicks);
        this.animate(renderState.slideBack, BreezeAnimation.SLIDE_BACK, renderState.ageInTicks);
        this.animate(renderState.inhale, BreezeAnimation.INHALE, renderState.ageInTicks);
        this.animate(renderState.longJump, BreezeAnimation.JUMP, renderState.ageInTicks);
    }
