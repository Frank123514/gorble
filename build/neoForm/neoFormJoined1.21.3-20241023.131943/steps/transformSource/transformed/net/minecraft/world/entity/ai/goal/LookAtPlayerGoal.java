...
public class LookAtPlayerGoal extends Goal {
    ...
    public LookAtPlayerGoal(Mob mob, Class<? extends LivingEntity> lookAtType, float lookDistance, float probability, boolean onlyHorizontal) {
        ...
        if (lookAtType == Player.class) {
            ...
            this.lookAtContext = TargetingConditions.forNonCombat().range((double)lookDistance).selector((p_375729_, p_375730_) -> predicate.test(p_375729_));
        } else {
            ...
            if (this.lookAtType == Player.class) {
                ...
                this.lookAt = serverlevel.getNearestEntity(
                    this.mob
                        .level()
                        .getEntitiesOfClass(
                            this.lookAtType, this.mob.getBoundingBox().inflate((double)this.lookDistance, 3.0, (double)this.lookDistance), p_148124_ -> true
                        ),
                    this.lookAtContext,
                    this.mob,
                    this.mob.getX(),
