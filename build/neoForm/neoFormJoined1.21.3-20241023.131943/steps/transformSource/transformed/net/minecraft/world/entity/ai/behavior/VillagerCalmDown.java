    ...
    public static BehaviorControl<LivingEntity> create() {
        return BehaviorBuilder.create(
            p_258884_ -> p_258884_.group(
                    ...
                    .apply(
                        p_258884_,
                        (p_258886_, p_258887_, p_258888_) -> (p_379141_, p_379142_, p_379143_) -> {
                                boolean flag = p_258884_.tryGet(p_258886_).isPresent()
                                    || p_258884_.tryGet(p_258888_).isPresent()
                                    || p_258884_.<LivingEntity>tryGet(p_258887_).filter(p_325748_ -> p_325748_.distanceToSqr(p_379142_) <= 36.0).isPresent();
                                if (!flag) {
                                    p_258886_.erase();
                                    p_258887_.erase();
                                    p_379142_.getBrain().updateActivityFromSchedule(p_379141_.getDayTime(), p_379141_.getGameTime());
                                }
