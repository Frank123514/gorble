...
public class Dolphin extends AgeableWaterCreature {
    ...
    public static final Predicate<ItemEntity> ALLOWED_ITEMS = p_375799_ -> !p_375799_.hasPickUpDelay() && p_375799_.isAlive() && p_375799_.isInWater();
    ...
    public SpawnGroupData finalizeSpawn(
        ...
        this.setXRot(0.0F);
        SpawnGroupData spawngroupdata = Objects.requireNonNullElseGet(spawnGroupData, () -> new AgeableMob.AgeableMobGroupData(0.1F));
    ...
    class PlayWithItemsGoal extends Goal {
        ...
        private void drop(ItemStack stack) {
            if (!stack.isEmpty()) {
                ...
                ItemEntity itementity = new ItemEntity(Dolphin.this.level(), Dolphin.this.getX(), d0, Dolphin.this.getZ(), stack);
