...
public class ServerFunctionLibrary implements PreparableReloadListener {
    ...
    private final TagLoader<CommandFunction<CommandSourceStack>> tagsLoader = new TagLoader<>(
        (p_378960_, p_378961_) -> this.getFunction(p_378960_), Registries.tagsDirPath(TYPE_KEY)
    );
        ...
        return completablefuture.thenCombine(completablefuture1, Pair::of)
            ...
            .thenAcceptAsync(
                p_179944_ -> {
                    ...
                    map.forEach((p_179941_, p_179942_) -> p_179942_.handle((p_306152_, p_179955_) -> {
                            if (p_179955_ != null) {
                                LOGGER.error("Failed to load function {}", p_179941_, p_179955_);
                            } else {
                                builder.put(p_179941_, p_306152_);
                            }
