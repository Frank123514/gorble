...
public class TracyZoneFiller implements ProfilerFiller {
    ...
    public void push(String name) {
        ...
        com.mojang.jtracy.Zone zone = TracyClient.beginZone(name, s, s1, i);
    ...
    public void incrementCounter(String counterName, int increment) {
        this.plots.computeIfAbsent(counterName, p_372885_ -> new TracyZoneFiller.PlotAndValue(this.name + " " + counterName)).add(increment);
    }
