...
public class BakedQuad {
    ...
    public BakedQuad(int[] verticies, int tintIndex, Direction direction, TextureAtlasSprite sprite, boolean shade, int lightEmission) {
        this(verticies, tintIndex, direction, sprite, shade, lightEmission, true);
    }

    public BakedQuad(int[] verticies, int tintIndex, Direction direction, TextureAtlasSprite sprite, boolean shade, int lightEmission, boolean hasAmbientOcclusion) {
