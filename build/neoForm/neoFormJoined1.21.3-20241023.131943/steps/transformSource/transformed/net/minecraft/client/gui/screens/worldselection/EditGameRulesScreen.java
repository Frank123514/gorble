...
public class EditGameRulesScreen extends Screen {
    ...
    public class BooleanRuleEntry extends EditGameRulesScreen.GameRuleEntry {
        ...
        public BooleanRuleEntry(Component label, List<FormattedCharSequence> tooltip, String description, GameRules.BooleanValue value) {
            super(tooltip, label);
    ...
    interface EntryFactory<T extends GameRules.Value<T>> {
        EditGameRulesScreen.RuleEntry create(Component label, List<FormattedCharSequence> tooltip, String description, T value);
    }
    ...
    public class IntegerRuleEntry extends EditGameRulesScreen.GameRuleEntry {
        ...
        public IntegerRuleEntry(Component label, List<FormattedCharSequence> tooltip, String description, GameRules.IntegerValue value) {
            super(tooltip, label);
