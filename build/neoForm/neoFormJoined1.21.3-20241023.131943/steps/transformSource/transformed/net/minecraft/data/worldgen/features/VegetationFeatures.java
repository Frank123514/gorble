...
public class VegetationFeatures {
    ...
    public static void bootstrap(BootstrapContext<ConfiguredFeature<?, ?>> context) {
        ...
        Holder<PlacedFeature> holder6 = holdergetter1.getOrThrow(TreePlacements.PALE_OAK_CHECKED);
        Holder<PlacedFeature> holder7 = holdergetter1.getOrThrow(TreePlacements.PALE_OAK_CREAKING_CHECKED);
        Holder<PlacedFeature> holder8 = holdergetter1.getOrThrow(TreePlacements.BIRCH_CHECKED);
        Holder<PlacedFeature> holder9 = holdergetter1.getOrThrow(TreePlacements.FANCY_OAK_CHECKED);
        Holder<PlacedFeature> holder10 = holdergetter1.getOrThrow(TreePlacements.BIRCH_BEES_002);
        Holder<PlacedFeature> holder11 = holdergetter1.getOrThrow(TreePlacements.FANCY_OAK_BEES_002);
        Holder<PlacedFeature> holder12 = holdergetter1.getOrThrow(TreePlacements.FANCY_OAK_BEES);
        Holder<PlacedFeature> holder13 = holdergetter1.getOrThrow(TreePlacements.PINE_CHECKED);
        Holder<PlacedFeature> holder14 = holdergetter1.getOrThrow(TreePlacements.SPRUCE_CHECKED);
        Holder<PlacedFeature> holder15 = holdergetter1.getOrThrow(TreePlacements.PINE_ON_SNOW);
        Holder<PlacedFeature> holder16 = holdergetter1.getOrThrow(TreePlacements.ACACIA_CHECKED);
        Holder<PlacedFeature> holder17 = holdergetter1.getOrThrow(TreePlacements.SUPER_BIRCH_BEES_0002);
        Holder<PlacedFeature> holder18 = holdergetter1.getOrThrow(TreePlacements.BIRCH_BEES_0002_PLACED);
        Holder<PlacedFeature> holder19 = holdergetter1.getOrThrow(TreePlacements.FANCY_OAK_BEES_0002);
        Holder<PlacedFeature> holder20 = holdergetter1.getOrThrow(TreePlacements.JUNGLE_BUSH);
        Holder<PlacedFeature> holder21 = holdergetter1.getOrThrow(TreePlacements.MEGA_SPRUCE_CHECKED);
        Holder<PlacedFeature> holder22 = holdergetter1.getOrThrow(TreePlacements.MEGA_PINE_CHECKED);
        Holder<PlacedFeature> holder23 = holdergetter1.getOrThrow(TreePlacements.MEGA_JUNGLE_TREE_CHECKED);
        Holder<PlacedFeature> holder24 = holdergetter1.getOrThrow(TreePlacements.TALL_MANGROVE_CHECKED);
        Holder<PlacedFeature> holder25 = holdergetter1.getOrThrow(TreePlacements.OAK_CHECKED);
        Holder<PlacedFeature> holder26 = holdergetter1.getOrThrow(TreePlacements.OAK_BEES_002);
        Holder<PlacedFeature> holder27 = holdergetter1.getOrThrow(TreePlacements.SUPER_BIRCH_BEES);
        Holder<PlacedFeature> holder28 = holdergetter1.getOrThrow(TreePlacements.SPRUCE_ON_SNOW);
        Holder<PlacedFeature> holder29 = holdergetter1.getOrThrow(TreePlacements.OAK_BEES_0002);
        Holder<PlacedFeature> holder30 = holdergetter1.getOrThrow(TreePlacements.JUNGLE_TREE_CHECKED);
        Holder<PlacedFeature> holder31 = holdergetter1.getOrThrow(TreePlacements.MANGROVE_CHECKED);
        ...
        FeatureUtils.register(
            ...
            new RandomFeatureConfiguration(
                List.of(
                    ...
                    new WeightedPlacedFeature(holder8, 0.2F),
                    new WeightedPlacedFeature(holder9, 0.1F)
                ),
                holder25
            )
        );
        FeatureUtils.register(
            ...
            Feature.RANDOM_SELECTOR,
            new RandomFeatureConfiguration(List.of(new WeightedPlacedFeature(holder7, 0.2F), new WeightedPlacedFeature(holder6, 0.8F)), holder6)
        );
        FeatureUtils.register(
            context,
        ...
        FeatureUtils.register(
            ...
            TREES_FLOWER_FOREST,
            Feature.RANDOM_SELECTOR,
            new RandomFeatureConfiguration(List.of(new WeightedPlacedFeature(holder10, 0.2F), new WeightedPlacedFeature(holder11, 0.1F)), holder26)
        );
        FeatureUtils.register(
            context, MEADOW_TREES, Feature.RANDOM_SELECTOR, new RandomFeatureConfiguration(List.of(new WeightedPlacedFeature(holder12, 0.5F)), holder27)
        );
        FeatureUtils.register(
            context,
            TREES_TAIGA,
            Feature.RANDOM_SELECTOR,
            new RandomFeatureConfiguration(List.of(new WeightedPlacedFeature(holder13, 0.33333334F)), holder14)
        );
        FeatureUtils.register(
            context,
            TREES_GROVE,
            Feature.RANDOM_SELECTOR,
            new RandomFeatureConfiguration(List.of(new WeightedPlacedFeature(holder15, 0.33333334F)), holder28)
        );
        FeatureUtils.register(
            context, TREES_SAVANNA, Feature.RANDOM_SELECTOR, new RandomFeatureConfiguration(List.of(new WeightedPlacedFeature(holder16, 0.8F)), holder25)
        );
        FeatureUtils.register(
            context, BIRCH_TALL, Feature.RANDOM_SELECTOR, new RandomFeatureConfiguration(List.of(new WeightedPlacedFeature(holder17, 0.5F)), holder18)
        );
        FeatureUtils.register(
            context,
            TREES_WINDSWEPT_HILLS,
            Feature.RANDOM_SELECTOR,
            new RandomFeatureConfiguration(List.of(new WeightedPlacedFeature(holder14, 0.666F), new WeightedPlacedFeature(holder9, 0.1F)), holder25)
        );
        FeatureUtils.register(
            context, TREES_WATER, Feature.RANDOM_SELECTOR, new RandomFeatureConfiguration(List.of(new WeightedPlacedFeature(holder9, 0.1F)), holder25)
        );
        FeatureUtils.register(
            context,
            TREES_BIRCH_AND_OAK,
            Feature.RANDOM_SELECTOR,
            new RandomFeatureConfiguration(List.of(new WeightedPlacedFeature(holder18, 0.2F), new WeightedPlacedFeature(holder19, 0.1F)), holder29)
        );
        FeatureUtils.register(
            context,
            TREES_PLAINS,
        ...
        FeatureUtils.register(
            ...
            TREES_SPARSE_JUNGLE,
            Feature.RANDOM_SELECTOR,
            new RandomFeatureConfiguration(List.of(new WeightedPlacedFeature(holder9, 0.1F), new WeightedPlacedFeature(holder20, 0.5F)), holder30)
        );
        FeatureUtils.register(
            context,
            ...
            Feature.RANDOM_SELECTOR,
            new RandomFeatureConfiguration(
                List.of(new WeightedPlacedFeature(holder21, 0.33333334F), new WeightedPlacedFeature(holder13, 0.33333334F)), holder14
            )
        );
        FeatureUtils.register(
            context,
            ...
            new RandomFeatureConfiguration(
                List.of(
                    ...
                    new WeightedPlacedFeature(holder13, 0.33333334F)
                ),
                holder14
            )
        );
        FeatureUtils.register(
            ...
            Feature.RANDOM_SELECTOR,
            new RandomFeatureConfiguration(
                List.of(new WeightedPlacedFeature(holder9, 0.1F), new WeightedPlacedFeature(holder20, 0.5F), new WeightedPlacedFeature(holder23, 0.33333334F)),
                holder30
            )
        );
        FeatureUtils.register(
            ...
            Feature.RANDOM_SELECTOR,
            new RandomFeatureConfiguration(
                List.of(new WeightedPlacedFeature(holder9, 0.05F), new WeightedPlacedFeature(holder20, 0.15F), new WeightedPlacedFeature(holder23, 0.7F)),
        ...
        FeatureUtils.register(
            ...
            new RandomBooleanFeatureConfiguration(PlacementUtils.inlinePlaced(holder1), PlacementUtils.inlinePlaced(holder))
        );
        FeatureUtils.register(
            context,
            MANGROVE_VEGETATION,
