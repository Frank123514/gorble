                            ...
                            Commands.argument("targets", EntityArgument.players())
                                .then(
                                    Commands.argument("recipe", ResourceKeyArgument.key(Registries.RECIPE))
                                        .executes(
                                            p_379014_ -> giveRecipes(
                                                    p_379014_.getSource(),
                                                    EntityArgument.getPlayers(p_379014_, "targets"),
                                                    Collections.singleton(ResourceKeyArgument.getRecipe(p_379014_, "recipe"))
                                                )
                                        )
                                )
                                .then(
                        ...
                        .then(
                            Commands.argument("targets", EntityArgument.players())
                                .then(
                                    Commands.argument("recipe", ResourceKeyArgument.key(Registries.RECIPE))
                                        .executes(
                                            p_379015_ -> takeRecipes(
                                                    p_379015_.getSource(),
                                                    EntityArgument.getPlayers(p_379015_, "targets"),
                                                    Collections.singleton(ResourceKeyArgument.getRecipe(p_379015_, "recipe"))
                                                )
                                        )
                                )
                                .then(
