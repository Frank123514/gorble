...
public class TrimMaterials {
    ...
    public static void bootstrap(BootstrapContext<TrimMaterial> context) {
        ...
        register(context, IRON, Items.IRON_INGOT, Style.EMPTY.withColor(15527148), 0.2F, Map.of(EquipmentModels.IRON, "iron_darker"));
        register(context, NETHERITE, Items.NETHERITE_INGOT, Style.EMPTY.withColor(6445145), 0.3F, Map.of(EquipmentModels.NETHERITE, "netherite_darker"));
        ...
        register(context, GOLD, Items.GOLD_INGOT, Style.EMPTY.withColor(14594349), 0.6F, Map.of(EquipmentModels.GOLD, "gold_darker"));
        register(context, EMERALD, Items.EMERALD, Style.EMPTY.withColor(1155126), 0.7F);
        register(context, DIAMOND, Items.DIAMOND, Style.EMPTY.withColor(7269586), 0.8F, Map.of(EquipmentModels.DIAMOND, "diamond_darker"));
    ...
    public static Optional<Holder.Reference<TrimMaterial>> getFromIngredient(HolderLookup.Provider registries, ItemStack ingredient) {
        return registries.lookupOrThrow(Registries.TRIM_MATERIAL).listElements().filter(p_371615_ -> ingredient.is(p_371615_.value().ingredient())).findFirst();
    }

    private static void register(
        BootstrapContext<TrimMaterial> context, ResourceKey<TrimMaterial> key, Item ingredient, Style style, float itemModelIndex
    ) {
        register(context, key, ingredient, style, itemModelIndex, Map.of());
    }
    ...
    private static void register(
        ...
        Map<ResourceLocation, String> overrideArmorMaterials
    ) {
