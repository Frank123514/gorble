...
public class PartDefinition {
    ...
    public PartDefinition addOrReplaceChild(String name, PartDefinition chuld) {
        PartDefinition partdefinition = this.children.put(name, chuld);
    ...
    public PartDefinition clearChild(String name) {
        return this.addOrReplaceChild(name, CubeListBuilder.create(), PartPose.ZERO);
    }
