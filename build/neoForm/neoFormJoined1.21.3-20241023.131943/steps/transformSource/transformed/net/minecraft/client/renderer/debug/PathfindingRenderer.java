            ...
            for (int i = 0; i < path.getNodeCount(); i++) {
                ...
                if (distanceToCamera(node.asBlockPos(), x, y, z) <= 80.0F) {
                    ...
                    DebugRenderer.renderFilledBox(
                        ...
                        bufferSource,
                        new AABB(
                                (double)((float)node.x + 0.5F - nodeSize),
                                (double)((float)node.y + 0.01F * (float)i),
                                (double)((float)node.z + 0.5F - nodeSize),
                                (double)((float)node.x + 0.5F + nodeSize),
            ...
            for (Node node1 : path$debugdata.closedSet()) {
                if (distanceToCamera(node1.asBlockPos(), x, y, z) <= 80.0F) {
                    DebugRenderer.renderFilledBox(
                        ...
                        bufferSource,
                        new AABB(
                                (double)((float)node1.x + 0.5F - nodeSize / 2.0F),
                                (double)((float)node1.y + 0.01F),
                                (double)((float)node1.z + 0.5F - nodeSize / 2.0F),
                                (double)((float)node1.x + 0.5F + nodeSize / 2.0F),
                                (double)node1.y + 0.1,
                                (double)((float)node1.z + 0.5F + nodeSize / 2.0F)
                            )
            ...
            for (Node node3 : path$debugdata.openSet()) {
                if (distanceToCamera(node3.asBlockPos(), x, y, z) <= 80.0F) {
                    DebugRenderer.renderFilledBox(
                        ...
                        bufferSource,
                        new AABB(
                                (double)((float)node3.x + 0.5F - nodeSize / 2.0F),
                                (double)((float)node3.y + 0.01F),
                                (double)((float)node3.z + 0.5F - nodeSize / 2.0F),
                                (double)((float)node3.x + 0.5F + nodeSize / 2.0F),
                                (double)node3.y + 0.1,
                                (double)((float)node3.z + 0.5F + nodeSize / 2.0F)
                            )
