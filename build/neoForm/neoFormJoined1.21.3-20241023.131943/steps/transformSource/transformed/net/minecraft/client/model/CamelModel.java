...
public class CamelModel extends EntityModel<CamelRenderState> {
    ...
    public void setupAnim(CamelRenderState renderState) {
        ...
        this.toggleInvisibleParts(renderState);
        this.animateWalk(CamelAnimation.CAMEL_WALK, renderState.walkAnimationPos, renderState.walkAnimationSpeed, 2.0F, 2.5F);
        this.animate(renderState.sitAnimationState, CamelAnimation.CAMEL_SIT, renderState.ageInTicks, 1.0F);
        this.animate(renderState.sitPoseAnimationState, CamelAnimation.CAMEL_SIT_POSE, renderState.ageInTicks, 1.0F);
        this.animate(renderState.sitUpAnimationState, CamelAnimation.CAMEL_STANDUP, renderState.ageInTicks, 1.0F);
        this.animate(renderState.idleAnimationState, CamelAnimation.CAMEL_IDLE, renderState.ageInTicks, 1.0F);
        this.animate(renderState.dashAnimationState, CamelAnimation.CAMEL_DASH, renderState.ageInTicks, 1.0F);
    }
    ...
    private void toggleInvisibleParts(CamelRenderState renderState) {
        boolean flag = renderState.isSaddled;
        boolean flag1 = renderState.isRidden;
